pfDB["quests"]["enUS-turtle"] = {
  ...
  [820] = {
    ["D"] = "Truly a spirit of strength resides in your body, willing to help an old man brew his potions.The generosity found in our new home and the strength of relying on our allies is what sets us apart from others, $c.I need one more thing to begin brewing a batch of my potion, eight shimmerweed.You can find the herbs northwest of Razor Hill in Thunder Ridge, and be careful, $N.",
  ...
  [3578] = {
    ["D"] = "Ah, I\'ve been expecting my Rah\'pawene, Samantha Swifthoof and she\'s yet to come! I\'m confused...Can you help me and find her? Last time we spoke she was so much excited to see the new places and travel at her leisure from a port to some distant forests and northern regions of the Eastern Kingdoms, alas, the only port I know nearby is the Ratchet.I\'m most certain Samantha braved to the ferry and swam to the Booty Bay.Where could she travel to from there I do not know. Perhaps you could find her for me? Just to be sure she\'s fine...",
    ["O"] = "Find Samantha Swifthoof.",
    ["T"] = "Swift as a Swifthoof",
  },
  [3579] = {
    ["D"] = "Yes, I\'ve travelled this far on my own hooves and yes I\'m very tired, alas, my wanderlust is too strong to be ignored, I just can not stop and be idle even for a minute knowing that so many roads are to be discovered and forests traversed and plains to be run over... oh, the world is so vast, I could travel all my life!However, as you can see, I\'m falling down from all the hoofwork I\'ve endured to the moment.Oh, if only I could have our famous Compressing Bandage to aid my muscles to feel well again!",
  ...
  [39000] = {
    ["D"] = "Come on up, folks, and behold, Vizlow\'s magical—ahem... MIST machine!<Vizlow sizes you up and down.>Ah, a potential customer! You must have come from across the world to see the wonders that my machines do.No? Oh well, it doesn\'t matter. Then it must be fate! Or whatever deity you believe in has brought you to me. Listen, this machine can do wonders, kid. It can expand your physical and mental capabilities!And all you need to do is insert gold in it to make it work! So, what do you say? Pay ten gold to activate it. Of course, I will need 340, for—ahem... materials, yes materials!",
  ...
  [40014] = {
    ["D"] = "The trolls were once known far and wide as the greatest hunters on Azeroth and some of those legends have persisted until today. There is time to hunt for sport and time to prepare, and as much as I would love to put you to the challenge there\'s the problem of the Witherbark.Paying homage to Shadra in their attack, they fell upon us with poisons almost like the days of old. This time we will be prepared. Head into the heart of the Arathi Highlands and hunt Giant Plains Creepers for their venom sacs.Once you have enough for several anti-venoms, return to me and we can see if there are more preparations to be made.",
    ["O"] = "Slay Giant Plains Creeper for 5 Greater Venom Sacs.",
    ["T"] = "Titiki\'s Hunt",
  },
  [40015] = {
    ["D"] = "You\'ve done well so far, but the biggest of the plains creepers stands before you, $c. The Witherbark trolls have been harvesting venom from the spider after putting it to sleep with mojo in her food!Heketh is a fearsome foe that many trolls have fallen to, so keep your wits about you! You can find the great spider just west of Go\'Shek Farm.Find her and put an end to the Witherbark\'s source of powerful venom!",
  ...
  [40017] = {
    ["D"] = "Things might be quiet right now, but the war between us and the Witherbark is not over. While they recuperate from the initial attacks, we must prepare for their eventual descent down the mountain.Yin\'do has given me orders to make as much armor as I can for the upcoming battle, but my supplies are limited. Go down south from the mountains and gather the hides of Arathi Raptors to be used in the creation of especially sturdy armor.There is no creature in the region with stronger hide than the raptors. You must be swift.",
    ["O"] = "Collect 10 Arathi Raptor Hides from Raptor\'s in Arathi.",
    ["T"] = "Preparing for War",
  },
  [40018] = {
    ["D"] = "The Witherbark are a brutal enemy, one that attacked in the dead of night and had no mercy for my people. Those of us here were lucky to escape, and now it seems as if they are just biding their time for the next attack.We must not let it be so. As outnumbered and unprepared as we are, we need to reduce their ranks. Head into the Ruins of Zul\'Rasaz and kill as many of the Witherbark as you can manage. Show those traitors that the spirits remain on our side and that we remain the true masters of these heights.",
    ["O"] = "Kill 14 Witherbark Raiders, 8 Witherbark Soothsayers, and 5 Witherbark Rogues.",
    ["T"] = "War on the Witherbark",
  },
  [40019] = {
    ["D"] = "When we fled from our once-hidden city we left everything that we did not need, even the charms we use in many of our magic rituals and in showing respect to the spirits.I fear we have upset the spirits by abandoning our charms in Zul\'Rasaz and when next the Witherbark attack, our voodoo will abandon us!There is no hope to stand against the Witherbark without the aid of the spirits, $c. Go to the Ruins of Zul\'Rasaz, quickly, and retrieve our lost charms before it is too late.",
    ["O"] = "Collect 5 Wildtusk Charms from the Ruins of Zul\'Rasaz.",
    ["T"] = "The Wildtusk Charms",
  },
  [40020] = {
    ["D"] = "As we fled the chaos of Zul\'Rasaz, many of my people had to leave behind cherished belongings and other items that had personal value. I am no different. I am ashamed to say that I abandoned an amulet that has been passed down in my family for generations, since the time of the last great empire.It plagues my mind, $c. The spirits will never answer my call again should I not make up for this great shame. You must retrieve it for me! The ruins of Zul\'Rasaz can be accessed by the trail outside of town to the northwest. My home is near the top of the ruined city.I would make the journey, but I cannot risk my life for such a selfish reason. You will be rewarded for your help, I assure you.",
    ["O"] = "Find Yin\'dos necklace in the Ruins of Zul\'Rasaz.",
    ["T"] = "The Ancestral Amulet",
  },
  [40021] = {
    ["D"] = "After the empire was broken, my people fled into the mountains where we flourished for generations, maintaining a positive relationship with the local elementals and nurturing their growth.We did not know that one of our own had fallen to the corruption of the Witherbark\'s lust for power. Traitors to the memory of the empire, they fell upon Zul\'Rasaz and slaughtered my people in their beds.Speaker Gan\'to, someone I once called a friend, is responsible for this tragedy. You will go to the ruins of Zul\'Rasaz and you will kill him for the sake of my people. Bring justice to those who did not get to fight that day, $c.",
    ["O"] = "Bring the head of Speaker Gan\'to to Chief Yin\'do.",
    ["T"] = "The Speaker\'s Betrayal",
  },
  [40022] = {
    ["D"] = "Now that the traitor has been brought to justice, we can focus upon the leader of this warband, Kin\'toza. Possessed with dark fury, the warband leader now lays claim to the ruins of our city while preparing to descend the mountain on his return to Witherbark Village.You must stop their plunder and break their morale! Bring the head of Kin\'toza to me and it will serve as a symbol for my people to rally behind. With their leadership in shambles, we would truly stand a chance at reclaiming Zul\'Rasaz.",
  ...
  [40034] = {
    ["D"] = "What business do you have here at the Rethress Sanctum? You are lucky our strength is not what it used to be. We are on trying times. If anyone wishes to visit with the Tide Mistress, then they first must speak to me. We Rethress come from the very depths of this world in places your kind have never seen, nor will ever see.... As much as I distrust you, interloper, we require aid from any that can offer it. Speak with Tide Mistress Rashal. You have my blessing in order to see her.",
    ["O"] = "Speak with Tide Mistress Rashal.",
    ["T"] = "A Meeting With Royalty",
  },
  [40035] = {
    ["D"] = "Before we left for the great depths, the Rethress spent some time within Stranglethorn. We butted heads with other Naga there, but otherwise kept low and to ourselves. Tide Mistress Rashal had something of a personal mission far in the east, and we made the island of Jaguero into a temporary base.It wasn\'t long before we returned to the great depths in order to begin our mission here. In our haste, we left behind a small trunk that contains spoils of great importance to us for our future. Go there and gather our spoils!",
    ["O"] = "Obtain the Rethress Spoils for Hashaz.",
    ["T"] = "Spoils Left Behind",
  },
  [40036] = {
    ["D"] = "The Myrmidons of Rethress swore a sacred oath upon the stones of the Temple Rethress beneath the deep waves. Their word was their bond, but they broke the word of their sharp tongues and the oath they promised to keep. We were tasked with protecting Tide Mistress Rashal and carrying out her whims and deeds for the greater depths of all Naga.When the Spitelash was created, and the division began, all of the Myrmidons changed sides. They betrayed those loyal to the Rethress on orders from Naszharr and slew many of my most trusted brothers upon The Shattered Strand.I want them dead, interloper. I want their corpses to be feasted on by the depths. From their bodies, take their Myrmidon Signet\'s—a ring given to them upon swearing their oath.",
    ["O"] = "Gather 20 Myrmidon Signets from Spitelash Myrmidon on the Shattered Strand.",
    ["T"] = "A Broken Oath",
  },
  [40037] = {
    ["D"] = "I was sent to Azshara from the great depths of the world to claim ownership over these lands. I am royalty—royalty of the naga—and with my army, I could have been as strong as Queen Azshara!Yet, here I am, ruling over a small band of my loyal followers with no sway or power in the world. I was betrayed by the naga that followed me, and you will help me get revenge. The Storm Bay Murlocs were that of my family\'s servants. Their betrayal is most foul to me. The creatures think they are above the will of Tide Mistress Rashal?You can find these spineless followers all along the coastline of Azshara. Perhaps showing strength may help to get them back in line.",
    ["O"] = "Kill 10 Storm Bay Warriors and 10 Storm Bay Oracles for Tide Mistress Rashal.",
    ["T"] = "The Storm Bay Mutiny",
  },
  [40038] = {
    ["D"] = "The leader of the Storm Bay is a murloc with a brain the size of a small oyster. Mmrmglul is his name. He should be punished, and brutally, for rallying the Storm Bay Murlocs into an open revolt.You\'ll find that slimy eel to the north through the pathways and along the coastline on the Southridge Beach. Bring his head to me as a showing to the rest of his lackeys that Tide Mistress Rashal commands the Storm Bay Murlocs.",
    ["O"] = "Slay Mmrmglul and bring his head to Tide Mistress Rashal.",
    ["T"] = "Keeping Command",
  },
  [40039] = {
    ["D"] = "The Rethress Tide Scepter holds power for me within the great depths of the world, and especially within Nazjatar. It is the birthright of the Rethress, and it gives us dominion over many others. I had suspected they would try to steal it when the Spitelash was formed to get this dominion.You may wonder why I am telling you this. It would never concern a land-creature like yourself. Well, I buried the Scepter in a secretive location so that they could never claim power legitimately. Now that the Rethress Sanctum is founded, and we are not in immediate danger, I would like it returned to me.There is a place called the Tower of Eldara, held by some Highborne Keeper. It is located at the very far northeastern tip of the peninsula. To the west of it, along the coast, are four rocks. Buried around those rocks is the Rethress Tide Scepter. Get it and bring it to me, interloper, to help me reclaim my birthright.",
  ...
  [40041] = {
    ["D"] = "If you\'re the real deal, then you gotta do a real task. That makes sense, yeah? I\'ve been dying to get my hands on a Mistwing Horn for some time! Those creatures are quite powerful and supercharged with all sorts of natural energy. I\'ve had my suspicions for some time, now, that a Mistwing Horn could be useful beyond its practical purposes, and I\'d like to put it to the test. That\'s where you come in.The Mistwing can be found to the northwest, just beyond Lake Mennar. Be careful, though. There is all manner of big and powerful things up there! Azshara sure is a dangerous place.",
    ["O"] = "Obtain a Mistwing Horn for Gigno Flaxwhisker to prove your loyalties.",
    ["T"] = "Flaxwhisker Loyalty",
  },
  [40042] = {
    ["D"] = "A Dalaran wizard stopped by a few weeks ago, believe it or not! I\'ve never met a wizard from Dalaran, and his magic was impeccable. I mean it! He offered us some help with a few projects but asked for some supplies in return. I haven\'t had the means to get them to him yet, given all of the danger between me and the camp he is at up north of here.Do me a favor, would you? Run my delivery to Magus Bromley. You can find him to the northwest of Lake Mennar. He has a tent overlooking the Ruins of Eldarath, just on the ridges there!",
    ["O"] = "Deliver Gigno\'s Shipment to Magus Bromley in Azshara.",
    ["T"] = "Delivery for Bromley",
  },
  [40043] = {
    ["D"] = "Before you return to Flaxwhisker Post, I would ask you to deliver a letter for me. It is about a robot that the Flaxwhisker post has been operating in the region for some time. I helped with its creation in detecting magic within Azshara, and I spotted it on a trip to the Rethress Sanctum a few weeks back. It was hopelessly mired in some state of disrepair, broken and mindless.Gigno would want to know at the least what happened to it. Deliver this letter to him, $N, and thank you again for the supplies.",
    ["O"] = "Deliver the Letter for Gigno to Gigno Flaxwhisker.",
    ["T"] = "The Missing Robot",
  },
  [40044] = {
    ["D"] = "If the Analyzor 53G is still out there, then this is great news! We spent so long on its Analyzation Chip that it would be almost impossible to recreate. We had the magic of Bromley the first time, and without it, I could not replicate it entirely.The Rethress Sanctum is located just east of here along the coast. Naga inhabit it who are not the friendliest to us. I don\'t want to risk any of my crew to get the Analyzation Chip! You will find it located just beneath the exhaust port of the inhibitor chamber on the main chassis at the posterior side, easy.",
    ["O"] = "Retrieve the Analyzation Chip from Analyzor 53G near the Rethress Sanctum.",
    ["T"] = "The Analyzation Chip",
  },
  [40045] = {
    ["D"] = "Now that we have the Analyzation Chip, I can focus on other matters! I\'d like for you to speak with Lorie Gearwatch. She has been in charge of flights from Flaxwhisker Front! Our main flying machine hasn\'t been seen in weeks, and I want to know who took the blasted thing.You\'ll find her outside, she should have the Log Book, or at the least know where it is!",
    ["O"] = "Speak with Lorie Gearwatch about the Flight Logbook.",
    ["T"] = "Lorie\'s Logbook",
  },
  [40046] = {
    ["D"] = "Dinkle Togpipe—he was out at the landing pad to the far east on a small island.We used that landing pad as a refueling area and resting spot for pilots. We used to have them dispersed across the ocean near the end of a Flight-Machine\'s fuel usage. It was previously possible to get from Gnomeregan to Kalimdor with ease, but I feel that the landing pads are in a state of disrepair. We haven\'t heard much in a long time from back home.If you want the Flight Logbook, go and get it from Dinkle Togpipe stationed out there.",
  ...
  [40047] = {
    ["D"] = "Flaxwhisker Front was started by Gnomeregan to advance Gnomish Engineering abroad with the use of Azshara\'s magical potency to try and make breakthroughs! We were given a Tinkerspark Transponder designed to harness magical energy in our contraptions, though this device was lost long ago to the naga. We have been waiting to get another one for months.With the loss of my crew members and no supplies from Gnomeregan, I have but no choice to find out what is going on there. Why is everything so delayed?Find Tinkmaster Overspark. He should be in Gnomeregan unless some horrific disaster ruined the city! He is usually in the Engineering sector on the top floor. Bring this report to him with haste!",
    ["O"] = "Find, and bring Gigno\'s Report to Tinkmaster Overspark.",
    ["T"] = "Report for Gnomeregan!",
  },
  [40048] = {
    ["D"] = "I\'m honestly shocked I heard back from Flaxwhisker Front. I had assumed that they already knew what happened in Gnomeregan! The collapse of Gnomeregan destroyed almost all of our logistics heading that way, and it is impossible to help them out.I want you to send Gigno this letter. I\'ve included some coins in there to fund the journey back for the gnomes in Azshara. Make sure he gets this; it holds all the information he will need to get him up to date on what happened!",
    ["O"] = "Bring Tinkmaster Overspark\'s Response to Gigno Flaxwhisker.",
    ["T"] = "Report from Gnomeregan!",
  },
  [40051] = {
    ["D"] = "Little one, the promised land is far away, and there is much to do. If you wish to go there, you must retrieve clues dotted across the landscape and follow my instructions. Do this with patience and caution. We must act as if all is normal.The first clue will be placed within a farm containing elements of the Hallow\'s End Festival.",
  ...
  [40067] = {
    ["D"] = "Thanks for getting it all. Now I can get to work. Where is my...<Fendo looks around.>Huh, I don\'t have my spanner on me. Could you look inside? If anything, it should be on the second floor inside of my toolbox. Once I have it, I\'ll get started.",
  ...
  [40087] = {
    ...
    ["O"] = "Slay 6 Tirisclaw Ravagers and 6 Tirislcaw Shadowcasters at Crumblepoint Tower before returning to Volgrin.",
  ...
  [40100] = {
    ["D"] = "There you are, $N! I know it took quite a while, but we finally have new information on the missing plates of Uldum.Well, when I say that we “have” something, I mean we found someone who might be able to get it for us. She is a smuggler named Vess, at least I think that\'s what she calls herself these days. Anyways, I have arranged for you to meet her at the Booty Bay inn.Once you get there, make sure to get on her good side, as I doubt we will get another chance like this.",
  ...
  [40105] = {
    ["D"] = "I\'ve never begged in my life, $R, but I\'ll start now. Please! Avenge us and show those bastards what happens when you make an enemy of the Alliance! They—<coughs>—went north of here.For Khaz Mo...",
  ...
  [40109] = {
    ["D"] = "Four years ago, my own people betrayed me for refusing to do the very same thing that doomed us in the first place—drinking the blood of the demon Mannaroth. If not for my companion Korvir and Truthseeker, my body would have rotted away in the forests of Ashenvale.<Logrash caresses the scars on his chest with a painful expression.>The spirits whisper of demon scum called Naxiar hiding around the eastern lakes of Ashenvale. If you wish to have my aid, I need you to kill him and retrieve my wolf totem.",
    ["O"] = "Kill Naxiar in the Eastern Ashenvale and bring back the wolf totem to Logrash in the Barrens.",
    ["T"] = "Scarms of the Past",
  },
  [40110] = {
    ["D"] = "This totem will help me enter a deeper state of trance and allow me to commune with the spirits of old. With their help, we might be able to locate your missing plates.<Logrash begins his ritual, and his eyes turn pale.>Bah, I forgot how taxing this ritual is. The plates you seek are immensely powerful, $N. Show this message to the Truthseeker, and he will understand where to send you next. But be warned, it appears that we are not the only ones looking for the plates. Someone—or something—dark is on the trail as well.",
    ["O"] = "Logrash wants you to travel to Thunder Bluff and bring the Inscribed Boar Pelt to Sage Truth Seeker.",
    ["T"] = "Unseen Enemy",
  },
  [40111] = {
    ["D"] = "The path ahead is clear now, friend. With both locations revealed, it is time to act. I will gather a war party of Horde\'s finest warriors to secure one of the plates at the Swamp of Sorrows while you make your way to the northern mountains of Un\'goro Crater and recover the other plate.<Sage rubs his chin.>But the grave news Logrash spoke of still troubles my mind. Be careful, friend, and may the Earthmother watch over you.",
  ...
  [40114] = {
    ["D"] = "The time has come. It is as the Earthmother told me. We have no idea what we might find in Uldum, and if dangerous factions seek to enter. Then all the more reason for us to take extreme precautions.I urge you to avoid the mistake I have made with the war party. Before you go, find trustworthy allies who would accompany you to the gates. There is no telling what awaits you and I there. I will be working on putting our friends to rest. It is the least I can do to atone for my mistake. Go now, and may the winds be ever at your back.",
    ["O"] = "Head to the Valley of the Watcher in Tanaris and activate the Pedestal in front of the gate by using the Plates of Uldum.",
    ["T"] = "Uldum Awaits",
  },
  [40115] = {
  ...
  [40137] = {
    ["D"] = "Just the person that I need. Listen. A few months ago, a pack of wolves inhabited the cave just north of here. At first, we thought it was just a small number of them, so we didn\'t pay those beasts much attention, being busy with war and all. But they have become aggressive of late, and they even got bold enough to attack residents of Glenshire.So, how about this, you go and cull their numbers. In the meantime, I will try to gather some coins from the residents for you, deal?",
  ...
  [40140] = {
    ["D"] = "With the bulk of the undead gone, it is time to face the one responsible for taking our new troops from us. Go to the Corinth Farm once again and kill the necromancer responsible for this.And be careful. Suppose the necromancer is capable of summoning a small army of undead. In that case, he is certainly not someone who should be underestimated.",
    ["O"] = "Kill the necromancer at Corinth Farm.",
    ["T"] = "Cleaning The Farm",
  },
  [40141] = {
    ["D"] = "I come from a large family, one that once occupied the boroughs of Kul Tiras. We weren\'t exactly a rich family, but we were not poor either! I traveled out with two of my brothers when the third war started up in Lordaeron, hoping to earn some fortune and glory. I helped the navy , my brother Karl started work in Menethil Harbor, while Samual went to Southshore to assist the war effort.Ever since I set sail years ago, I have had no communication with them, and would like to reach out if you could deliver a letter to the both of them. They must have thought I perished after so long without a word or peep and I want to ease their minds.",
    ["O"] = "Deliver the letters from Arnold Boran to his two brothers.",
    ["T"] = "The Boran Family",
  },
  [40142] = {
    ["D"] = "From our time at sea, it is us sailors who come up with the fine dining aboard ship. The same meals can get repetitive when you have them over and over again, so it is time to improvise and innovate.I came up with this recipe some time ago when we spent a few days on Tel\'Abim. All we had were sand crawlers and bananas. Fry it up together and add a pinch of salt, then you have quite a meal! Sadly, we don\'t got bananas, but I do know that Chef Jenkel has some salt. Get the salt from him, and gather some legs from any sort of sand crawler around these islands, then I can finally have a change of meal.",
    ["O"] = "Collect 6 Juicy Crawler Legs and a Pinch of Salt for \'Slim\' in Caelan\'s Rest.",
    ["T"] = "Sailors Innovation",
  },
  [40143] = {
    ["D"] = "The Southsea Pirates are a direct threat to our survival on this island. Their operations here are much larger than we had first anticipated when we set out. They still have many powerful vessels, and whilst they haven\'t attempted to sail them in front of our town, the possibility is still real.Kul Tiras has always been at war with piracy. Those that threaten the merchants are a direct threat to our kingdom. I need you to claim the sashes of the Southsea Freebooters, a pirate gang that operates in a vast area. You can find them across both large islands and along the sandbar named after them to the southwest of here, off the coast of Lapidis.As proof of your deeds, bring me twenty of the sashes that they wear. Your efforts will not only help us, but all who travel the vast sea.",
    ["O"] = "Gather 20 Southsea Sashes from Southsea Pirates for Colonel Hardinus in Caelan\'s Rest.",
    ["T"] = "Smashing the Southsea!",
  },
  [40144] = {
    ["D"] = "With each sash collected, the Southsea are weakened, but not destroyed. Their strength comes from the captains of each ship and crew. A man with great charisma and promises of wealth, fortune, and adventure can easily rile up a group with no future ahead of them.It is these individuals that we will need to target—the captains of the Southsea Freebooters. You shall find them to the southwest along a dangerous strip of sand called The Southsea Sandbar. Be cautious, it is the basecamp of the pirates on both Gilijim, and Lapidis.You shall find the captains upon the boats there. Enter each and kill the leaders.",
  ...
  [40152] = {
    ["D"] = "Our fleet was accompanied by a squadron of high elf vessels. They traveled to the islands with us for a somewhat secretive mission. I had many friends within their crew whom I met from Kul Tiras. The high elves are a good people, but their leader, Faelon was a rather shady character—one who traded illegal goods and dealt with unsavory individuals.It is sad to say that many of those people I once called good friends are now haunting the shores of Faelon\'s Folly on the island of Gillijim. They were slain by the Deeptide Naga, though one of the items Faelon coveted in hopes to trade now has left them restless.Go there and free the souls of the dead. You will find them on the western coast of Gillijim\'s Island south of Lapidis.",
  ...
  [40155] = {
    ["D"] = "The Gor\'dosh Ogres are a fearsome foe. They battled us almost constantly when we made landfall, but we drove them back. It is only a matter of time before they are ready to strike again.Now that they are allied with Lapidis, they have become even bolder upon the island and must be stopped at any and all costs. They have established quite a formidable force to the northwest in an area known as Gor\'dosh Heights. Travel there and kill them to end the bloodshed.",
  ...
  [40164] = {
    ["D"] = "Arch Hydromancer Lapidis held incredibly skills in Hydromancy, and was much stronger then many even upon Boralus. Many had their opinions on how the man was able to achieve such power, though I always gave him the benefit of the doubt. I believe he has had some assistance from either a magical artifact, or an outside force, though I cannot prove my suspicions.Regardless, if there is a way in the tower, I would believe it to be this key. <Hydromancer Flakereef produces a small Shimmering Brass Key>.This key was given to me by Lapidis before we had arrived, he entrusted it within my care, I was to be one of his pupils, but after he created the large tower, and began to close himself off from the rest I instead returned here. This key fits the lock to the tower, but cannot open it, and perhaps requires some magical attuning to grant access.We must look to those with a greater knowledge of the Arcana, Archmage Ansirem Runeweaver of Dalaran may perhaps help, seek him out.",
    ["O"] = "Bring the Shimmering Brass Key to Archmage Ansirem Runeweaver in Dalaran.",
    ["T"] = "The Tower of Lapidis II",
  },
  [40165] = {
    ["D"] = "Lapidis was always an interesting, if strange man, at the time we hadn\'t considered his refusal to our curiosity as something potentially bad. But hearing of what he has done upon Lapidis Isle has certainly shifted my opinion.<Ansirem Runeweaver studies the Shimmering Brass Key>. It would appear that this key still has lingering of magic upon it. It is possible to reconstruct the enchantment, but may take considerable power and regeants to do so. If the key is to work upon the lock as suggested, it will need to be both attuned, and enchanted to the magic that once powered it.It is within my power to enchant this key with the same magic that once powered it. The coast of Feralas is covered in water elementals. Bring me a Pure Aqua Orb from one of them, it should be sufficient and powerful enough to mimic the magic of the key.",
  ...
  [40168] = {
    ["D"] = "I hadn\'t imagined Lapidis could harness such power, even into such a small object such as this key. Perhaps there is another that could be of assistance. The fleet had a Magus with us when we first began to establish Caelan\'s Rest. Shortly after he departed in search of a latent , powerful magic that eminated from the island.When he returned he spoke of a great hermit that was beyond his own power, and that of others he seen in his lifetime. He ventured out once more to learn from this figure, and to study out in the island. If there is something that can be done, perhaps Magus Valgon can help us get the answer. You should be able to find him somewhere on this island, I would imagine he has a camp somewhere.",
    ["O"] = "Find Magus Valgon on Lapidis isle, and inquire about the Enchanted Brass Key.",
    ["T"] = "The Tower of Lapidis VI",
  },
  [40169] = {
    ["D"] = "<After studying the Enchanted Brass Key it would appear that Magus Valgon is stumped>.I do not think I can assist with this friend, the complexities of the magic may take many weeks to begin to crack, and I think you do not have such time to wait.I do know one who knows a great deal of magic, hidden away from the world. There is a hermit that remains somewhat hidden upon the island of Kazon, nestled in between both Gillijim and Lapidis Isle.Go there, and find Insom\'ni, he is a powerful troll, much more powerful then any I have met.If there is any who could attune this key, it would be him.",
    ["O"] = "Travel to Kazon Island and speak with the troll hermit Insom\'ni.",
    ["T"] = "The Tower of Lapidis VII",
  },
  [40170] = {
    ["D"] = "<It would only take a single glance at the key with inquisitive eyes for the troll to crack a small smirk>.I can do this, though I must wonder why I would help you, especially for free, and at no cost.If you want me to work the magic of this key, and attune it for you, I will need a favor from you. There is a satyr of whom I knew a long time ago, one who still walks this world today. Let us say that me and him are not on the best of standing and I want you to bring me one of his gnarled horns from his battered corpse.Travel to Felwood, to the Ruins of Constellas, you will find Pethax Blackhorn there, it is his horn I desire.",
    ["O"] = "Obtain Pethax\'s Horn for Insom\'ni on Kazon Island.",
    ["T"] = "The Tower of Lapidis VIII",
  },
  [40171] = {
    ["D"] = "Now, I will do what I can to restore the attunement to this key. It shouldn\'t be that difficult, the magi who left the magic did a poor job with leaving magical traces upon it.Step back, I will do as you asked, it shouldn\'t take long. When I am done, you may return to the one who sent you.",
  ...
  [40185] = {
    ["D"] = "The cap\'n of this fool ye\'re about to scuttle used to have a magical compass, or so they claim. It seems the compass would find whatever ye desire when ye\'d open it up, which sounds like a madman gab.Enter the lodgin\' of the cap\'n \'n see if ye can find this compass. I hear he keeps it locked in a chest. Some say the chest be black spotted, but that\'s definitely some squiffy excuse.",
    ["O"] = "Find the Magical Compass.",
    ["T"] = "Magical Compass",
  },
  [40186] = {
    ["D"] = "Last thing ye\'re gonna do fer me with these fools be to set fire to thar ship. Fun, ain\'t it?Aye, I wants ye to light this torch on fire while ye\'re close to the cannons, \'n set fire to the blast powder. Make sure t\' get out o\' thar as quickly as possible!",
  ...
  [40194] = {
    ["D"] = "My people have a long and rich history upon this island, we once came from Stranglethorn, as part of the Gurubashi. But we looked for a new destiny when the wars stared, it was here that we called home. This island has been a place of refuge for our kind, and we have lived here in harmony with nature around us.As of recently, my people have begun to betray their heritage, and their past. They use a foreign magic from our brothers the Hazzuri, one that is of an evil source, and tainted to the core. Instead of practicing the ways of the voodoo, they now are lost within the ways of shadow, mon.My people are not what they used to be, and attack any who dare go close, their very essence be tainted. I ask of you to do me a favor friend, you need to go to Zul\'Razar, it is located to the northwest on the isle. Kill the trolls there, gather me their Tainted Mojo, perhaps I may find a source of how to help them.",
    ["O"] = "Gather 15 Tainted Mojo from trolls in Zul\'Razar for Jubo in Maul\'ogg Refuge.",
    ["T"] = "Razzari Madness",
  },
  [40195] = {
    ["D"] = " With the Hazzuri\'s dark words they were able to convince the weak minds of the Razzari to take up their magic. Even now their speaker gives them speeches to warp their minds and change their ideals.I have discovered from the Mojo you have sent me of a dark taint that lingers within it, it would appear that the power my people have become to accept is that of a great power, and a much greater evil. The Hazzuri know not what they peddle, nor what they preach, and will only bring the end of their kind, and my own.If there is to be a future for the Razzari, this must all come to an end, and the only end I can see, is by the death of those that accepted this darkness. They are nothing more then traitors for a promise of power.Go deep into Zul\'Razar, strike hard at Speaker Ujuwa for spreading his lies, and Chief Imaz\'ul for accepting them. Bring me their skulls as proof of your deeds, let this chaos come to an end.",
    ["O"] = "Collect the skulls of Speaker Ujuwa and Chief Imaz\'ul for Jubo in Maul\'ogg Refuge.",
    ["T"] = "The Razzari Leaders",
  },
  [40196] = {
    ["D"] = "It has been long since our people have seen the sands of Kalimdor. We left our tribe for the promise of riches, and now, the man who led us here betrayed us for his own prosper. Those riches that we fought and worked so hard to gain were taken, and we were left to rot.It is a centaur named Lykourgos who had insturmented such a betrayal with the Southseas Pirates. I had my suspicions of him, but I hadn\'t suspected his honor was so cheap. Everyone within this camp wants revenge, but we have no means to kill him. I hate to speak anything good of such a snake, but he is if anything, a ruthless murderer with a great skill in arms.He is known as \'The Reaver\' for his brutality, and you should not take him lightly. Find him, kill him, for all of us here, and for his betrayal. I know not where he is, but he is still a pirate through and through, if anything, he should around fellow Southsea Freebooters.",
  ...
  [40199] = {
    ["D"] = "The Maul\'ogg be in a great war, a war for our very survival! We be pushed back to this refuge as if we are not stronger anymore. This not be the truth, and honestly we will fight back until we are destroyed.We once controlled most of this island, and only when the Razzari defeated us, and the wildlife posed a big threat did we come back here! Maul\'ogg destined to rule all of Gillijim, and it shall be rightfully ours.We must retake land if we are to hold more power, and The Tangled Wood lies between us and them. Kill the animals there, those panthers that stalk, kill those creepers that lurk within the vines, it should be just north of here, go!",
    ["O"] = "Slay 10 Lurking Jungle Creepers and 10 Junglepaw Panthers for Lord Cruk\'Zogg in Maul\'ogg Refuge.",
    ["T"] = "The Maul\'ogg War",
  },
  [40200] = {
    ["D"] = "When we battled with the Razzari we were able to deal quite a lot of damage to Zul\'Razar, and even occupied part of the city. Until a large lot of Creepers came in, led by a massive beast named Tanglemoss, who drove us out.Tanglemoss is a lurking, horrific beast that patrols the ruins of Zul\'Razar and has slain many ogres. We have always thought of him in stories, and rumors as a beast that lingered within the shadows and made those that traveled alone dissapear. I think I speak for many of us when I say that I prefer the story of Tanglemoss to be just that, a story.Travel to the Ruins of Zul\'Razar to the west, and slay Tanglemoss, bring its foul heart to me.",
  ...
  [40210] = {
    ["D"] = "I did not always call this place home, infact I come from far away lands, and have only recently settled here. I have many tales to tell and should you wish to truly serve me, you will need to listen to my tale and understand why I do what I do.So , mortal, are you ready for what is presented before you, will you step into the abyss?",
    ["O"] = "Listen to the tale of Insom\'ni.",
    ["T"] = "The Hermit",
  },
  [40211] = {
    ["D"] = "Felwood.A place I recall with a bitter hatred that makes my face cowl in disgust. It is within this place I had first decided to travel upon leaving my kin. My reasons for being in such a place was for the betterment of Azeroth, and I only found deceit, malice, and corruption.<Insom\'ni would snort inward, his face warped with a bitter, deep anger>.We will start here, travel to the twisted forest, and hunt the foul beings known as the \'satyr\' , more specifically, the Jadefire. I will need from them 5 Jadefire Felhorn , as well as 5 Purple Lotus that can be gathered by any skilled herbalist upon this world.",
    ["O"] = "Gather 5 Jadefire Felhorns, and 5 Purple Lotus for Insom\'ni on Kazon Island.",
    ["T"] = "Jadefire Revenge",
  },
  [40212] = {
    ["D"] = "My channeling will take some time to uncover the source of what lurks beneath the surface. In the mean time, I would ask of you a favor that means more then these very islands. An old friend of mine, who goes by the name Itharius is currently located within the Swamp of Sorrows. He was originally sent with Eranikus in tasks regarding the sunken temple, and watching over its masters destruction.Upon my exile, I gave Itharius my necklace, one that holds much of my power, and essence. It is from this very necklace that I will need the energy needed to defeat the evil upon these islands.I told him a time would come where I would reclaim my birthright, and he may be aprehensive, but he will do as I asked him long ago. Find Itharius, and reclaim my necklace from those swamps.",
    ["O"] = "Speak with Itharius to recover Insom\'ni\'s necklace.",
    ["T"] = "An Old Friend",
  },
  [40213] = {
    ["D"] = "This necklace has made me regain much of my former strength. If you were paying attention during your trip then you would have uncovered my true identity. Now you know truely who I am, and we will work toward my final goal.I was able to channel my energies and locate the source of corruption. While we could very well confront, and summon it to us with the powers of my necklace, I would first take revenge upon those that tossed aside their worship of me.Zul\'Hazu was once a place I called home, it was there the trolls called me a deity. They practiced my magics, and would follow me to the ends of the world.Travel to Zul\'Hazu in the north-west, slay the leaders Darkmaster Haza\'gi, Champion Raggazi, and Chieftain Woh\'zo. The people should suffer as well, get from them 10 Hazzuri Charms, they will be nice decorations.",
    ["O"] = "Slay the Hazzuri Leaders, and gather 10 Hazzuri Charms for Insom\'ni on Kazon Island.",
    ["T"] = "The Hermit\'s Wrath",
  },
  [40214] = {
    ["D"] = "With the Hazzuri slain, my heart burns with glee, retribution is such a fine wine, and one I would eagerly drink down again. It is time for the final task, we must drag free the shadow that has rooted itself upon the islands, and destroy it.When this is done I can began to rebuild my throne on these islands. The time is at hand, follow me to the center of the island, and await my summoning to be complete. When it is, you must do battle with this evil as I keep it bound to the island, only when it is weak enough, will I be able to join you. I suggest you bring friends, or others that may assist you, this should not be taken lightly, do not fail me.",
  ...
  [40221] = {
    ["D"] = "Tales of your victories against the scourge raise the spirits of the downtrodden and give hope for a better tomorrow.But for all your efforts, our enemies yet shamble in the dark and cast a pall over the land. The long night is yet to be over.We mustn\'t relent!By the Light, we must keep on, and bring salvation to those the Scourge would seek to harm. Prove that your mettle remains as sharp as steel.Bring me an Argent Dawn Valor Token, and in exchange, I will grant you a boon to aid in your battles against the undead.",
  ...
  [40234] = {
    ["D"] = "Omarion left behind plenty of work and research on various topics, one of which I have taken quite an interest within! Runeblades, Rune Armor, such fascinating things, imbued and powered directly by Dreadlords. I heard that Baron Rivendare fellow had one, but I am seeking the knowledge of imbuing a freshly created blade, and tempering it with great power! If we could unlock such secrets then certainly it would be a new frontier of all sorts of magical crafting!If you can figure out a way to create your own Untempered Runeblade I would be more then willing to share my knowledge!",
    ["O"] = "Craft an Untempered Runeblade, and return to Craftsman Wilhelm.",
    ["T"] = "A New Rune-Frontier",
  },
  [40235] = {
    ["D"] = "I Wilhelm, am a dwarf of my word, and I will keep my word to unveil this new frontier ahead of us. The first place we should begin to look is Corin\'s Crossing, it is a place over-run by the scourge, and not somewhere I would travel!A book named \'The Secrets of Darkforging\' may be the first step to uncovering what we seek, it is held by a Jacob Malwright. He was a rather famed smith in his days amongst the living and now walks among the dead. No doubt he still has it on him, or keeps it close by, kill him, bring me the book, let us begin to learn their tricks!",
  ...
  [40236] = {
    ["D"] = "<Craftsman Wilhelm would take his time reading through the book, intrigue marks his features, and interest sparks his eyes>.This book holds a lot of information, most of it doesn\'t seem to even relate to what we are doing, I mean, why would we even want Dark Binding Shackles in the first place?!There are a few sections that may relate though, one of which is tainted, and twisted by a dark magic, making it unintelligable and frankly, unnerving. The other section seems to be written by a Dreadlord named Lorthiras, who could be of some use.I would first like to uncover the dark magic, and I believe I know someone who may be of help! Strahad Farsan used to be a friend of mine - we\'re not on the best terms, but he is quite deeply involved with shadowy magic, and demons both.He is located in Ratchet, go and find him there, bring him the book.",
    ["O"] = "Travel to Ratchet and speak with Strahad Farsan.",
    ["T"] = "The Secrets of Darkforging",
  },
  [40237] = {
    ["D"] = "What you are dealing with here is quite interesting, this book seems to mention quite a lot of patterns all pertaining to Darkforging, of which you will gain very little use. The armor, and weapons the undead use are quite deeply entwined with the very magic that keeps their minions standing.If you desire my help, then I would also desire yours, I can uncover what this text reads, and point you and Wilhelm in the correct direction, but this would require a favor.Travel to Scholomance, and venture deep within. Inside I am looking for an old book that was archived there some time ago, titled \'Fire Beckoning and Command\'.Bring me this book, and I shall do as you have asked.",
  ...
  [40242] = {
    ["D"] = "Howdy, and welcome to Flaxwhisker Front newcomer! I am Genzil Spannerlight, in charge of starting new projects and archiving the success and failure of old ones.I have a new idea that may potentially work, a charged shell to act as either a shield, or barrier to be both protective, and resistant to magic! Of course, we will need some shells first, and we don\'t have a bunch of metal to waste, but there are turtles around!Go out, and gather me 3 Pristine Lurker Shells!",
  ...
  [40262] = {
    ["D"] = "You have learned how to tame a beast using your own skills, you must also know how to train it. Before we move with that, I want you to know this. Some beasts do not accept the undead as their masters, either because you seem a delicious snack or since their natural mechanism advises them not to.Luckily with the aid of the Cult of Forgotten Shadow, we hunters were taught a small incantation that would soothe the mind of the beast, and it would merely alter the thought that you\'d be alive.Only use this incantation on pets that will not accept an undead master! Now, as I\'ve mentioned before, on your countless adventures that are to follow, you will gain skills and you must train your pet to do so as well. I am not able to teach you how to do that, but I know who can.Travel to the Undercity, in the War Quarter speak to Diane Willowfield. It has been my utmost pleasure to teach you. Go now and show the living that the Forsaken are no mere walking corpses.",
  ...
  [40264] = {
    ["D"] = "Hello, and welcome to Maul\'ogg Refuge, we are a battered people, stuck in a constant fight for dominance. I am Haz\'gorg, and I am the head of the seers.Long have I seen the desruction of my people, fortold in long fever dreams and visions within the dark hours of twilight. I fear that the constant state of warfare we are engulfed will do nothing but bring our end.I ask of you to speak with Lord Cruk\'Zogg on my behalf, tell him that I believe this foolhardy aggresion will bring nothing but suffering.",
    ["O"] = "Convince Lord Cruk\'Zogg to end his foolhardly aggresion on behalf of Haz\'gorg the Great Seer.",
    ["T"] = "The Maul\'ogg Crisis I",
  },
  [40265] = {
    ["D"] = "If there is to be a chance for my people then I must conjure a great vision, to do as such will require materials from across the island. I ask of you to gather me the following items. 10 Basilisk Eyes from the Basilisks, 6 Crawler Pincers from the Crawlers, and 3 Deepsnap Tails from the crocolisks.Once you have gotten these materials for me, I can begin to see what must be done.",
  ...
  [40266] = {
    ["D"] = "I have seen, a great many things, a great darkness that has enveloped not just this island, but all around us. My people did the bidding of a greater power, and followed it into the darkness willingly. We were nothing more then pawns until our demise.I did, however, see more then just misery, I saw the Seer of the Gor\'dosh ogres, a once old friend of mine. Perhaps it is he that can offer some wisdom, or suggestion on how to continue, maybe it is he, who has the answers.Seer Bol\'ukk resides within the Gor\'dosh Heights amongst the rest of his tribe, you should find him on Lapidis Isle far to the north, the Gor\'dosh Heights rest at its north western side.",
  ...
  [40267] = {
    ["D"] = "So much thinking, and so many dead ends, I do not think that I possess the abilities, or magics strong enough to bring Lord Cruk\'zoggs mind to a state of ease.. Or in such a way that the rest of the tribe wouldn\'t notice.I do, however know of a powerful being that potentially could be of assistance to me. There is a troll of mystique located on Kazon Island to the north, nestled between Gillijim and Lapidis. He is one of considerable power of which I met long ago, and spoke of in fever dreams of the night.His powers were once strong enough to do battle with a great sea beast and destroy it with ease. If there is any that could make such a spell, it would be him.",
    ["O"] = "Find Insom\'ni on Kazon Island.",
    ["T"] = "The Maul\'ogg Crisis IV",
  },
  [40268] = {
    ["D"] = "<The troll would listen to the story with interest, a small grin would mark from ear to ear with interest>. I could certainly do this, though I ask why to you, why would I? My magic is that of great power, and something I would not freely give to you.If you desire my help then I would desire a favor. There is a satyr that I met quite some time ago, one who walks without care even to this day. He is a vile, trecherous snake of a creature who needs to be dealt with in a manner less then savory.Let us just say, his actions have wronged me greatly.Travel to Felwood, to the Ruins of Constellas, you will find Pethax Blackhorn there, it is his horn I desire from his battered corpse.",
    ["O"] = "Obtain Pethax\'s Horn for Insom\'ni on Kazon Island.",
    ["T"] = "The Maul\'ogg Crisis V",
  },
  [40269] = {
    ["D"] = "To create a spell of such magnitude will require a few items, the first of which shall be relatively easy to obtain. I require a Gorilla Ligment from Un\'goro Crater, its essence of power will be used to conduct the sheer strength of the spell and channel its abilities onto Lord Cruk\'Zogg.You can find Un\'goro Crater deep within Kalimdor, it is a place of danger, so I would watch your step mortal. Return to me with a Gorilla Ligment from the apes there.",
    ["O"] = "Obtain a Gorilla Ligment from Un\'goro Crater and return to Insom\'ni on Kazon Island.",
    ["T"] = "The Maul\'ogg Crisis VI",
  },
  [40270] = {
    ["D"] = "I have had many encounters within the Temple of Atal\'Hakkar, long ages spent gazing upon its walls. It is a place of darkness and foul energies that have corrupted its once defenders. The Prophet Jammal\'an speaks his foul, misbegotten words into the decaying remains of his people that call this place home. I desire you to venture into the catacombs of this place, to find the Prophet and gather from him the Atal\'ai Rod. It should be kept close to where this troll channels his magic.The Atal\'ai Rod holds power in the magic of control, and should assist us in subjugating Lord Cruk\'zogg.",
  ...
  [40271] = {
    ["D"] = "With the elements recovered, and the Atal\'ai Rod in posession, I can now begin to manifest my energies into the creation of an elixir. This elixir will bring the mind of Lord Cruk\'Zogg into the hands of Haz\'gorg to do as he pleases.This will require some concentration on my part, so I do ask you mortal, to keep your mouth quiet while I work.",
    ["O"] = "Wait for Insom\'ni to finish his magic, then return to Haz\'gorg the Great Seer.",
    ["T"] = "The Maul\'ogg Crisis VIII",
  },
  [40272] = {
    ["D"] = "It would appear the time has come, you have done extremely well in everything I have asked, but now I must ask you to do what is required for the good of my people. Long have we suffered, not at the hands of our enemies, but at the hands of our leadership.If there is to be a future for the Maul\'ogg then it must be a future of reasoning, we cannot secure ourselves a place within the Horde if we are constantly engaged in self destructive warfare.Bring the Elixir of Insom\'ni to Lord Cruk\'zogg, inform him that it is a potion of great power that I created for him. When all is done, return to me.",
  ...
  [40273] = {
    ["D"] = "<A gust of wind opens the enclosed journal>.Seeking stars down the ocean deep,Lost grins down by the portTears drowned in tobacco smokeFalse hopes in cheers.I\'m cold, tired and I wish to sleepDeep and easy to walk through, the emptyWhere should I begin so I can continue?I try to accept who I amWho I am and what I wish to beIn my hopeless need of love, I bear one single regret.<As you go through the pages the poetry seems to get darker and darker>.of slumberDarkness depthI was seeking apathy,Drowning in miseryBeginning and endStuck in the middleNo purposeNo goalDark skiesShy moonCold nightWarm bed.<Turning to the last page you don\'t know what to make of it>.WHYwhy why whyWhy me, what did I do wrong?<The page is scribbled with the word why, on top of all the repetition it\'s written once again all over the page. At the end of the journal a name and a message is relayed>.",
    ["O"] = "Find the owner of the journal in Stormwind.",
    ["T"] = "In Search of the Owner",
  },
  [40274] = {
    ["D"] = "The Southfury River wasn\'t always so bad, not when we first settled here. The floods and rough waters made for a test of will against the natural forces of our new home, but something has changed recently that caused a massive increase in crocolisks!All I want to do is fish all day, but now I have to fight off beasts and spend more time with a weapon in hand than enjoying my fishing spot.Before you ask, I\'ve done enough fighting for one lifetime from the siege of Durnholde to the battle of Mt. Hyjal. I just want to relax and contribute this way. Go out and secure my fishing spot and I\'ll give you one of my handcrafted fishing rods.",
    ["O"] = "Slay 8 Dreadmaw Crocolisks for Grubgar at Southfury River in Durotar.",
    ["T"] = "A Bad Day to Fish!",
  },
  [40275] = {
    ["D"] = "It is good to meet a fellow explorer upon these lands, one who enjoys the same glory of finding the unknown and uncovering secrets. We share a bond in exploration and adventure and I feel obligated to warm you of a danger off the coast, one that perhaps you may assist with.The Deeptide Naga are a menacing force, who came here for an unknown motive and currently hold an island off the coast of Gillijim to the south west. It is there that they have a sanctum they call home, and use it as a base of operations to strike out and attack people like you and me. I was lucky to escape the hands of these slithering marauders and live to tell the tale, but others are not so lucky.I ask you to travel to the Deep Tide Sanctum, and slay the Naga there, so that one day the horde may establish control on these islands, and so that we may continue our exploration unharmed. Bring me the bracelets they wear as proof.",
    ["O"] = "Gather 10 Deeptide Bracelets from Deeptide Naga for Explorer Fangosh in Maul\'ogg Refuge.",
    ["T"] = "Deeptide Sanctum",
  },
  [40276] = {
    ["D"] = "You did well, you have the tenacity and strength of the most well rounded explorers. If we truly want the Deeptide gone, and to free these islands of their presence we must become more bold. Their leadership are nestled within the Deeptide Sanctum, and need to be rooted out.Return to the sanctum, and bring retribution upon Princess Shasza, and Tidelord Hakash, they need to be slain for their crimes and hostility. Trust me, there is no reasoning, or diplomacy that can be done, finish this, and perhaps the Naga will disperse.",
  ...
  [40281] = {
    ...
    ["O"] = "Find Melenas\'s belongings in the Shadowfang Keep Library and return them to Pierce Shackleton in Undercity.",
    ["T"] = "Into The Jaws",
  },
  [40282] = {
  ...
  [40287] = {
    ["D"] = "Our Blades, they do not break easily. It was cut into two pieces on purpose.From all of the possible forces in Azshara, only the Naga have the technology to do so. Maybe, just maybe, they still have the second partIf it is anywhere, it must be located on the Shattered Strand, no doubt kept as some trophy, or prized possesion.  Locate it, and bring back the edge of the sword to me!",
  ...
  [40298] = {
    ["D"] = "The wyvern are native to Kalimdor and can be found throughout much of our land. They have proven to be loyal companions to our wind riders. I remember the days when we first ensured the help of these beautiful creatures.In truth, they have been a gift from the Earthmother, strengthening the bond between the orcs and my people; it\'s not an exaggeration to say that without them we wouldn\'t be where we are today.Bristlefur, here, is already tame. She won\'t attack you, rest assured.The truth is the poor girl seems to be a bit bored ever since I forgot to bring her favorite toy with us to Durotar. If you have the time, young $c, please find her a new toy and something to snack on. In return, I\'m sure she would be happy to take you to the skies for a short while.",
    ["O"] = "Bring 5 Chunks of Boar Meat, 3 Mutton Chops and 1 Bone Chew Toy to Bristlefur in Razor Hill.",
    ["T"] = "Red Skies of Durotar",
  },
  [40299] = {
    ["D"] = "Old stories depict that these shoulders were once worn by Uther Lightbringer himself, shining brighter than the rising dawn. Even if it was lost in time we can remake them, in the right conditions. If you desire to smite your enemies with righteous justice and glorious zeal, then you must find these ingredients: * The pristine hide of the Beast.* Crusader orbs.* Arcanite Bars.* Medallion of Faith.BEHOLD!",
  ...
  [40303] = {
    ["D"] = "The Tower of Lapidis will not be an easy task to conquer, even with this key, this is only the entryway into the gates of hell. You must steel yourself for what is to come, Lapidis has been able to ally himself with the most unlikely friends for a reason. He is a powerful man, and extremely skilled in magic, not to mention surrounded by minions of his own conjuring.If you are to conquer The Tower of Lapidis you will need a band of fellow adventurers. Plan for the mission ahead and slay Arch Hydromancer Lapidis for all of his lies, his deceit, and his crimes against Kul Tiras. If you succeed, bring his head to Colonel Hardinus, he would be the most eager to reward such heroic actions.",
    ["O"] = "Venture into The Tower of Lapidis, and slay Arch Hydromancer Lapidis, and return his head to Colonel Hardinus in Caelan\'s Rest.",
  ...
  [40321] = {
    ["D"] = "You have been incredibly helpful, and for that I am grateful. This land I have found myself on seems to be full of dangers, those that I am not ready to encounter just yet. I have done some repairs upon the canoe, and should be ready to set off soon, back to where I am from.The Northeast Passage is quite trecherous, many jagged icebergs are out there which makes sailing quite difficult! I know a way through though, if you\'d like to come with me, I need to be stopping at Kaneq\'nuun, and I wouldn\'t mind showing you.When you\'re ready to go, let me know.",
    ["O"] = "Speak with Inunquaq and travel through the Northeast Passage to Kaneq\'nuun.",
    ["T"] = "The Northeast Passage",
  },
  [40322] = {
    ["D"] = "Kaneq\'nuun is a large rock floating out at sea, some of my people live here. It is a required stop both on the way south, and on the way north. If you wish to truly be welcomed, you must speak with the village elder, for they have much knowledge!They can be found just up the road, their name is Panukuki.",
    ["O"] = "Speak with Panukuki in Kaneq\'nuun.",
    ["T"] = "The Kaneq\'nuun Elder",
  },
  [40323] = {
    ["D"] = "Inunquaq has always been intrigued by the southlands, such a mysterious place, with many different peoples. In my long life, I have always wondered what lay beneath the shawl of wind and snow, perhaps you can tell me stories some time.If you wish to truly be welcomed, you must make an offering to Kaneq\'nuun. Many of our strong hunters have headed north to Tarq\'un to search for larger beasts, and as a consequence, we have been rationing our food.All along the coast are Ice Crawlers, they can be quite nasty if angered. Bring me 6 Ice Crawler Claws, they will go well with the food we have.",
    ["O"] = "Gather 6 Ice Crawler Claws for Panukuki in Kaneq\'nuun at Icepoint Rock.",
    ["T"] = "An Offering for Kaneq\'nuun",
  },
  [40324] = {
    ["D"] = "When my people first came to this island, we met a being named Tarqsiku. He was made of pure ice, and assisted us in our times of great need. Tarqsiku has long since fallen into a dark place, rumbling deep beneath the the ground, and sending the Whiteclaw into frenzy.An evil has clouded his judgement, and his mind, already he has attacked our kind. Tarqsiku was a legend to my ancestors, but to me, Tarqsiku is a threat, and one that has me wondering what to do.I ask of you to venture deep into the earth, to find Tarqsiku, and to free him for his torment.",
    ["O"] = "Find Tarqsiku deep beneath Kaneq\'nuun and slay him for Panukuki.",
    ["T"] = "The Legend of Tarqsiku",
  },
  [40325] = {
    ["D"] = "With our hunters gone away to gather food for the long winter, we have seen a growing amount of Whiteclaw Bears beginning to stalk the outside of their cave. Something has begun to stir them from hibernation, and we have seen them around.We have lived in harmony with the Whiteclaw for some time, but now we must act to reduce their numbers. To the north is a deep cave the burrows into the mountain, go there, and gather 5 Whiteclaw Pelts.",
  ...
  [40335] = {
    ["D"] = "Ahoy Cap\'n! Saw ye have fun last night with the bard lassy in our vessel, fine piece ain\'t she?By all means, I mean the boat, of course, non of my business of yer personal affairs. Speaking of which Cap\'n, have ye decided the name of the vessel yet? It\'s bad luck to have an unnamed ship at sea, so think about it!Anyway, onto more pressing matters. Admiral Garfield told me to supply our settlement with generals goods but we don\'t have the leisurely of just buying them so we\'ll just loot it.Aye, loot it. The Southsea seadogs have settled on a sandbar close to that damned Giljim Isle.Fortune of the waves be with ya.",
    ["O"] = "Loot 10 General Good Crates from the Southsea Sandbar and return to Belgrush Daggerfist.",
    ["T"] = "Another Day of Labor",
  },
  [40336] = {
    ["D"] = "Cap\'n, back for more songs?Or is it sugar only today.<Jeesie stares deep into your eyes>.Oh what is this poor bard to do, no jewelry to match her beauty, surely the Cap\'n would love to change that, aye?I hear there\'s a group of nagas north of one of our compounds, Vil\'do says they carry elven jewelry that would best suit this gal, don\'t you think so?I will make sure to make it worth your while.",
    ["O"] = "Bring a Highborne Necklace to Jeesie Silver-Tongue.",
    ["T"] = "Charming a Charmer",
  },
  [40337] = {
    ["D"] = "We are running low on rum Cap\'n! I need to test something, while I can brew beer in many ways I have yet to try to make some fine heavy rum.Luckily for us, we\'re on Jaguero Island, and as you could notice there are several gorillas here, where there\'s a gorilla there\'s also bananas. With the sugar the fruit holds I might be able to brew us some rum.A bunch of them would be great.",
  ...
  [40343] = {
    ["D"] = "Can you feel it, your destiny is calling you young one, the spirits themselves whisper your name. You have been called upon by Beram Skychaser in Thunder Bluff to go on a ritual of our kind.You can find him in the Spirit Rise at the northeastern edge of the bluffs, go there, and find him.",
    ["O"] = "Travel to Thunder Bluff and speak with Beram Skychaser.",
    ["T"] = "Spiritual Guidance",
  },
  [40344] = {
    ["D"] = "Long as it been that we tauren shaman have upheld our ancient traditions. Spiritwalking is apart of our culture and around longer then you could even imagine young one. It is how we connect with those of the after life in the arms of the Earthmother.If you wish to begin on this path, then special regeants will be required for you to first make your connection with the spirit world.To the southwest is a land called Feralas, at Camp Mojache you will find Sage Palerunner, speak with him, and tell him I was the one who sent you.",
    ["O"] = "Travel to Camp Mojache and speak with Sage Palerunner.",
    ["T"] = "The Way of Spiritwalking I",
  },
  [40345] = {
    ["D"] = "The path of the spiritwalker is one of devotion to the ancestors, to keep in communication with the spirits of old. We are to respect them, and pay our tributes when we can, through this we are able to hone a power of the supernatural world.From the ravenous Centaur, to the vile Quilboar, even they practice elements of shamanism linking to their ancestry. It is almost entwined with Kalimdor itself, in a way.To get you aquainted with the powers of the spirit world we will need you to gather an age-old leaf that grows in the area. Believe it or not there was a time when it was common place amongst Stonetalon and the oasis of the Barrens, but no longer.Out in the forests of Feralas grows a potent plant called Spiritleaf. It is quite rare but can be seen glittering in the air, and is needed for ones spiritual awakening.",
    ["O"] = "Find and collect a Spiritleaf for Sage Palerunner in Camp Mojache.",
    ["T"] = "The Way of Spiritwalking II",
  },
  [40346] = {
    ["D"] = "Now that you have collected the Spiritleaf we can begin the ceremony, I have prepared everything that was needed while you were searching.I will begin to communicate with the spirits in order to send you on your spirit quest. As I channel my energy upon the leaf, it will flow throw your body, and you will gain its magical properties. Inhale deeply, and let it flow through your form uninhibited.When you are ready to begin, I will channel my magic into the Spiritleaf.",
    ["O"] = "Wait for Sage Palerunner to finish the ceremony.",
    ["T"] = "The Way of Spiritwalking III",
  },
  [40347] = {
    ["D"] = "It is time to make the journey to meet with your ancestors, they know you more than you may know yourself but do not fear them. They look out for us all in the end, and they desire to see if you are truly ready to take up this mantle.At the Spirit Rise in Thunder Bluff, they will be there, speak with the Ancestor of Wisdom, they will bring you through your next step.And lastly, goodluck $N, may the winds be at your back.",
    ["O"] = "Travel to Thunder Bluff, and speak with the Ancestor of Wisdom.",
    ["T"] = "The Way of Spiritwalking IV",
  },
  [40348] = {
    ["D"] = "We have been watching you for a long time, from the plains of Mulgore we gazed down upon your vigor and tenacity. You have improved much since those days long ago, and now, here you are, before me.If you truly wish to be a Spiritwalker and learn our ways, then you must learn a lesson from the each of us. We can help guide you in the right direction, all you need to do is listen.Speak with all three of us, and when you have heard our words, return to me.",
    ["O"] = "Speak with the three Ancestors at Spirit Rise.",
    ["T"] = "The Way of Spiritwalking V",
  },
  [40349] = {
    ["D"] = "Ahh, yes, it would appear that you have gained much power, and word of your name has travelled to my ear. Perhaps it is time for your next step, troll, to learn the ways of our kind. We trolls have had a unique way with nature for a long time, one that these orc or tauren cannot understand.It be the way of the witch doctor, and to learn, you must speak with one of our kind. Seek out Bom\'bay at the Sen\'jin Village, he\'ll teach you good.",
    ["O"] = "Travel to Sen\'jin Village and speak with Bom\'bay.",
    ["T"] = "The Way Of The Witch Doctor I",
  },
  [40350] = {
    ["D"] = "You wish to learn da ways of the Witch Doctor huh? We troll shamans be masters of the voodoo, and perhaps you can learn my ways. First, I need you to get your hands on some Skullsplitter Mojo for me. I will be usin\' it in ma ritual to bestow power upon ye. That, and well, let\'s say I don\'t exactly like them Skullsplitters.They can be found deep in the jungles of Stranglethorn, by ruins in the eastern parts of the region. Go there, and get me 20 of them, that should do, just nicely.",
  ...
  [40352] = {
    ["D"] = "With this serum you may speak with the spirit of the toad, he is a patient, and incredibly wise one. We trolls have been hexin\' our enemies for quite some time, and it is about time for you to pay respects.N\'ribbi is the one you seek, and he can be found deep in the Dustwallow Marsh. In the north west of Dustwallow is a place called \'Bluefen\' you can find him at the very edge.Go there, and speak with him, bring this serum, and offer it to N\'ribbi as tribute.",
    ["O"] = "Travel to Dustwallow Marsh and find N\'ribbi, and offer him Bom\'bay\'s Serum.",
    ["T"] = "The Way Of The Witch Doctor IV",
  },
  [40353] = {
    ["D"] = "The power of the witch doctor is derived from the spirits of azeroth, the loa. It is us who look after the smaller of our kind, and channel our energies into those who follow us. If you so wish to prove yourself to N\'ribbi, you must show me your courage and ability with magic.Long has it been that a massive crocolisk named Clampjaw has terrorized the toads of Dustwallow. I do not have the power to challenge him directly, but perhaps with your powers, you can.I want you to find Clampjaw in the Quagmire, and slay him for all of my kin. Do this, and I will bless you with my power young one.",
    ["O"] = "Slay the mighty crocolisk Clampjaw for N\'ribbi in Dustwallow Marsh.",
    ["T"] = "The Way Of The Witch Doctor V",
  },
  [40354] = {
    ["D"] = "Seems like the pirate life suits ye, ye scoundrel. Ah, I remember of me own adventures, to be young again. Anyway, since the ship\'s all yours and all, thought it\'d be the time for you to name it, savvy?I bet ye already got a name in mind, whenever ye feel ready.",
    ["O"] = "Decide the name of the ship.",
    ["T"] = "Naming the Vessel",
  },
  [40355] = {
    ["D"] = "The Admiral tells me Fleet Master Firallon picked a Dragonmaw nobody from the Wetlands to train and eventually lead one of our vessels because of his orcish battle experience. Long has it been since I was this insulted! Earn my favor, will you $r?This \"Ironpatch\" is right next to Firallon on one of the three ships at the Wild Shore. Challenge him to battle and bring me his head!Blood and thunder, victory or death.",
    ["O"] = "Bring Ironpatch\'s Head back to Sark Blacktooth.",
    ["T"] = "Sark\'s Grudge",
  },
  [40356] = {
    ["D"] = "\'ello there boss mon! Time for Vil\'do to send ya out for dat booty! What, were ya just thinkin\' that ya\'d be only drinkin\' rum for da rest of ya days? No boss mon, ya must be huntin\' treasure so ya can afford da money lust and whatever else ya got. Vil\'do wouldn\'t guess and he shouldn\'t either.Da loa say Vil\'do would one day die talkin\' since he be talkin\' so much, but Vil\'do don’t listen to them and neither should ya mon.One of da boys from da Bloodsail Compound said dey be seein\' some weirdo night elf fightin\' nagas, said somethin’ about him wavin\' his hand in da air and magic goin\' \"woosh\".No idea where he be goin\' but Vil\'do sees opportunity here and Vil\'do thinks dis will lead boss mon to booty.",
    ["O"] = "Find the Night Elf close to Bloodsail Compound.",
    ["T"] = "Elf in the Jungle",
  },
  [40357] = {
    ["D"] = "While making a note to yourself about the thought you just had you try to put one and two together and see if there\'s something useful in these notes. Lady Luck seems to be smiling to your wicked self once more.A map and drawings of statues can be somewhat seen in the journal, as far as you can tell this journey will take you to Feralas to hunt for one of the most glorious things you\'d ever see: Gold.Feralas is a long way, you decide to return to your crew.",
    ["O"] = "Return to Vil\'do.",
    ["T"] = "Lift the Anchor!",
  },
  [40358] = {
    ["D"] = "Get ready boss mon, da trip be a long one! Vil\'do will make sure to be makin\' some room for the treasure ya be comin\' back with. Remember what ya got from ya notes, ya be lookin’ for golden elves! Well ya know statues of golden elves but who cares.Ya do dis and dis be da best haul da Bloodsail got in a long time. Make us proud eh, boss mon?",
    ["O"] = "Find the Golden Elf.",
    ["T"] = "Golden Elves of Feralas",
  },
  [40359] = {
    ["D"] = "All right bub, I don\'t know who you are but I\'ve been eyeing these statues forever! I\'m not gonna let some no good $r come in and steal MY loot, all right? But since neither of us can move them it\'s gonna be a real problem, and yea I\'m saying them, there\'s like four more around these blasted ruins.Say what bub, let\'s call a truce, you get me some parts and I will make them easier to carry, then we split them up, I get three you get two since you know I\'ll be the one that comes up with the solution here!Anyway, you gotta get me these mats and I will build some boring gnomish thing that will shrunk them to size, got it? Luckily I still got some mojo.",
    ["O"] = "Gather the materials and return to Ruins of Isildien.",
    ["T"] = "Mechaflame\'s Bargain",
  },
  [40360] = {
    ["D"] = "It\'s done! Quite boring little thing but you know gnomes, blah, I hate gnomes. No refinement when it comes to these things, just look at this thing, the perfect way to steal stuff, and not to mention increase your own profit!This thing was only supposed to shrink the statues, but guess what, it can now enlarge them too! Anyway let\'s be done with it yeah, no reason to wait any longer.",
  ...
  [40362] = {
    ["D"] = "On a cold and rainy night you decide to once more look at the notes as they remind you of your own first haul. As you reminisce about the past you also remember the wish you\'ve had to find a historian or someone knowledgeable enough to aid in the future.As thoughts drift through your mind you reach the end of Sovatir\'s journal and you find a rune accompanied by some words that felt very natural for you to say at this exact moment. As you mumble the incantation your head feels rather dizzy as you can now depict a ghostly figure that looks like the former owner of this journal.",
  ...
  [40370] = {
    ["D"] = "Hello! You look strong! I need the help of someone strong. I am Krilana. Mama Eliza is taking care of me because my real mom died. She told me that my mother was the only survivor that managed to get to Caelan\'s Rest. In one of her stories, mama mentioned a necklace that my papa gave to my real mom but that it was lost in the wreckage.Expect for mama\'s story I have nothing to remember my parents. Could, could you please look for it? I heard that it was pretty and that it looked like the sun! I wanted to go and look for it myself, but mama won\'t let me, she says that there are ghosts there.",
    ["O"] = "Search the crates in high elven wrecks by the northwestern coast of Gilijim Isle for the Tattered Necklace. Put the mournful apparition to rest.",
    ["T"] = "Krilana\'s Magnificent Quest",
  },
  [40371] = {
    ["D"] = "Greetings, $N. While others see our people as only refugees and survivors of a once-great nation, we must show the rest of the Alliance that the Quel\'dorei are here to stay.With Alah\'thalas prospering and our people slowly mobilizing into a formidable force, this is a perfect time for us to officially join the Alliance.Our magisters have prepared a missives that needs to be delivered directly to the leaders of the Alliance, and I think that the honor of delivering such an important message should be yours.",
    ["O"] = "Seek audience with all four Alliance leaders and represent Alah\'thalas interests.",
    ["T"] = "A Diplomatic Mission",
  },
  [40372] = {
    ["D"] = "Our magisters have prepared a missive that needs to be delivered directly to the Highlord Bolvar Fordragon, and I think that the honor of delivering such an important message should be yours.Once you receive Stormwind\'s response, return to me with the news.",
    ["O"] = "Deliver a Sealed Missive to Highlord Bolvar Fordragon.",
    ["T"] = "Appealing to the Alliance: Humans",
  },
  [40373] = {
    ["D"] = "This one needs to be delivered to King Magni Bronzebeard himself, and I do not doubt that having you be the one to do it will only improve the outcome.Once you receive Ironforge\'s response, return to me with the news.",
    ["O"] = "Deliver a Sealed Missive to the King Magni Bronzebeard.",
    ["T"] = "Appealing to the Alliance: Dwarves",
  },
  [40374] = {
    ["D"] = "We haven\'t had the pleasure of working too closely with the Gnomes, but they are an invaluable ally and a valued member of the Alliance. That is why I need you to deliver this message to the High Tinker Mekkatorque.Once you complete this task, make sure to report back to me with the news.",
    ["O"] = "Deliver a Sealed Missive to the High Tinker Mekkatorque.",
    ["T"] = "Appealing to the Alliance: Gnomes",
  },
  [40375] = {
    ["D"] = "Lastly, we prepared a unique message just for High Priestess Tyrande Whisperwind. While we expect a negative response, I hope that Tyrande alone can at least see that only by working together can we craft a better future for both our nations.Good luck, and please return with her reply as soon as you receive it.",
    ["O"] = "Deliver a Sealed Missive to the High Priestess Tyrande Whisperwind.",
  ...
  [40377] = {
    ["D"] = "With the pleasantries out of the way, it is time I let you in on our next move. I knew from the start that gaining the support of the Kaldorei would be hard, given our shared history.But we must show them that we are not the enemy.That is why I have sent a detachment of my best rangers to assist them, and they were successful in uncovering that a powerful Satyr is plotting to invade Ashenvale from Felwood.They had discovered that the Satyr and his minions gathered around an intriguing artifact of fel power- Corrupted Felstone, which is located near the border of Felwood, north of Raynewood\'s Retreat. If the Satyr is given free reign… who know what could happen.We must stop him. Once you are close to the Felstone, destroy it. The Satyr will definitely try to prevent its destruction and attack you. Our rangers will then come out of hiding and help you. Make sure to take proof of your victory to the Ashylah Starcaller in Darnassus.She is an ally to our cause.",
    ["O"] = "Interact with the Corrupted Felstone to provoke Satyrs near the border of Felwood. Defeat the Satyr threat and take the Satyr horns to Ashylah Starcaller in Darnassus.",
    ["T"] = "Breaking the Felstar",
  },
  [40378] = {
    ["D"] = "There it is done. I have prepared a writ for the High Priestess, explaining how instrumental you and the Quel\'Dorei were in slaying our ancient enemy Dra\'lox Felster. His deeds were unforgivable, which is why your actions may prove just enough to sway the High Priestess.",
    ["O"] = "Present the Sealed Writ to Tyrande Whisperwind in Darnassus.",
    ["T"] = "Thalassian Ascension",
  },
  [40379] = {
    ["D"] = "Here is the endorsement you have been waiting for, take it to Highlord Bolvar Fordragon in Stormwind. I only pray to the goddess that this was not a mistake.",
    ["O"] = "Present the Darnassian Endorsement to Highlord Bolvar Fordragon in Stormwind.",
    ["T"] = "Darnassian Endorsement",
  },
  [40380] = {
    ["D"] = "With Quel\'Dorei ascension in the Alliance, I do not doubt that it is only a matter of time before we rise to our former glory. But as my people celebrate, I must keep track of the problems that remain.For years my people relied on the magic of the great fount called Sunwell. Its destruction made us realize how dependent we became on its magic.Without it, we were vulnerable to succumbing to magic addiction. Miraculously the rangers who were hunting Dra\'lox with you stumbled upon a mystical pool of water whose effects mimic Sunwell, if only a little.If this is true, this could be our salvation. I need you to travel to Darnassus and ask Ashylah Starcaller if those waters can be procured for the Quel\'Dorei.",
    ["O"] = "Travel to Darnassus and speak to Ashylah Starcaller.",
    ["T"] = "The Magical Ailment",
  },
  [40381] = {
    ["D"] = "A Moonwell is something we sentinels protect with our lives. I sympathize with the Quel\'dorei\'s plight, but I would never betray my people by turning over the sacred waters to them. But, perhaps there is another way.If the Quel\'Dorei are truly willing to repent for their past deeds and are able to prove it, then there might be a chance to plead for a small well to be built in Alah\'talas. After all, they agreed once before to do the same for the Stormwind. Travel to the Feathermoon Stronghold in Feralas and look for Vestia Moonspear.She alone may be the only priestess sympathetic enough to your cause to listen to you. Give her this missive and pay close attention to what she has to say.",
    ["O"] = "Travel to Feralas and deliver the missive to Vestia Moonspear.",
    ["T"] = "A Quest for the Moonwell",
  },
  [40382] = {
    ["D"] = "Splendid! I will go ahead and quietly prepare everything that is required for the ritual. There is no doubt that the ogres will react aggressively to our attempt to cleanse the Moonwell.So I will wait in the shadows until you arrive. The ritual will require my full attention, so I will need you to protect me while I do it.",
    ["O"] = "Protect Vestia Moonspear while she\'s cleansing waters of corrupted Moonwell outside Dire Maul.",
    ["T"] = "Sacred Waters of Eldre\'thalas",
  },
  [40383] = {
    ["D"] = "Take this. I have convinced a few of my fellow priestesses to vouch for you and your Quel\'Dorei friends, but know that creating a new Moonwell and immediately giving it up won\'t be easy, even with our assurances. Let\'s hope that the High Priestess sees this request as a chance to mend old wounds.",
    ["O"] = "Deliver Vestia\'s Missive to Tyrande Whisperwind in Darnassus.",
    ["T"] = "Vestia\'s Missive",
  },
  [40384] = {
    ["D"] = "Again I find myself at the crossroad of helping someone who has betrayed my people. I trusted Illidan when I freed him to help us battle the Burning Legion, and he ended up saving my life, so I will do the same for Quel\'Dorei and approve this Moonwell. I only hope that this does not end up differently.",
  ...
  [40386] = {
    ["D"] = "This is a disaster! No matter how many we slay, they keep coming!Our Rangers will secure the ship and provide ranged support, but we need your help before they overrun us!",
    ["O"] = "Defend Shalandis Isle.",
    ["T"] = "[CANCELLED] Scourge!",
  },
  [40387] = {
    ["D"] = "It is done... With the initial attack repelled, we can properly set up the defenses. With the Rangers, the Magisters, the Druids, and Moon Priestesses, we\'re more than capable of holding this isle until the fleet arrives.Once the Rangers and Magisters have disembarked, we will return to Alah\'thalas. I take it you can send word to Speaker Windrunner?",
  ...
  [40396] = {
    ["D"] = "This is Cookie\'s cookbook, it\'s how I taught him to understand our tongue and how to make a somewhat decent meal.I tell you, I am not sure if it’s because he\'s a Murloc or not but he barely has a taste for flavor.I am getting off the sails here.The night the ship sank, Cookie fled, leaving all of us to perish. I almost forgot!I guess my mind gets foggy nowadays, not that I still have a working brain or a consciousness, mind you.That motherless Murloc must pay for this bloody mutiny. Bring me proof of his death and I will reward you handsomelyPerhaps I will even be able to move on...",
    ["O"] = "End Cookie.",
    ["T"] = "Captain Grayson\'s Revenge",
  },
  [40397] = {
    ["D"] = "This forest used to be bristling with life, it was my home once, now nothing more than a twisted abomination, a ruin of what beauty once laid here. Those we once called brothers have played a big hand in this land\'s corruption.The Satyr can be found all across Felwood now, lurking amongst the ruins, thinking of ways to further spread their corruption. I hate them, with every part of my being. I have killed many, and you will assist me in the slaughter.Bring me 60 horns of the beasts, once you have retrieved them, I will know you are capable of what is to come.",
    ["O"] = "Slay Satyr and collect 60 horns to fuel the bloodlust of Niremius Darkwind within Felwood.",
    ["T"] = "By Any Means Necessary I",
  },
  [40398] = {
    ["D"] = "You have proved yourself a potential ally, and allies do not come often in this place. If you truly wish to earn my favor, then there is something you can do.There is an elusive satyr that has escaped justice for far too long.He goes by the name Pustax, some warped mockery no doubt of his previous name. He is responsible for much destruction, and death in these parts, and has personally slain family of my own.I need his head, he has lived for far too long. He is known to lurk between Shatter Scar Vale, and Irontree Woods, start there. Now, bring me what I desire.",
    ["O"] = "Hunt down the Satyr Pustax, and return his head to Niremius Darkwind in Felwood.",
    ["T"] = "By Any Means Necessary II",
  },
  [40399] = {
    ["D"] = "If we truly wish to recover Felwood from the state it lies in now, then more must always be done. I have been fighting the corruption near endlessly and with seemingly no progress.I desire an artifact that was stolen from me many months ago. I came within contact with an orc name Ulathek who kept his intentions hidden from me. As much as he utilized shadow powers, he seemed well versed, and willing to assist myself.He stole from me a gemstone, one of great power, I want it back to utilize its powers for the greater good of this region. This orc now lingers amongst the cultists, and demons of Jaedenar within Shadowhold, the Barrowden they have corrupted.Kill him, and find the Gemstone of Salthax in that accursed place.",
  ...
  [40400] = {
    ["D"] = "You have done me a great service in gathering this artifact from amongst those demonic worshippers. It will be better served in my hands, rather then to serve evil.I may have used you for my own good, but I am not a traitor, and I will make it worth your while now that you have achieved what I desired. I will forge for you a Glaive in my namesake, one that can slay all manner of the Burning Legion. But, I will not depart with such a weapon so easily, I require one last exchange.Deep within the Sunken Temple are the guardians of the Green Dragonflight, corrupted, and twisted from their long slumber in the Emerald Dream. One of their defenders, Hazzas is one I knew long ago, he is a powerful being, and should not be tormented any longer.Bring me his heart, and free him from torment, only then will you earn your reward.",
  ...
  [40401] = {
    ["D"] = "All that remains is my mark upon the blade to give it the power required for the purpose it was intended. Give me time to concentrate, and channel my energy, only then will the blade be ready.",
    ["O"] = "Wait for Niremius Darkwind to finish crafting the Glaive.",
    ["T"] = "By Any Means Necessary V",
  },
  [40402] = {
    ["D"] = "You, $r. Tharg sad. Tharg angry!Tharg lost his hitting stick. Hitting stick special, hitting stick made by friend.Tharg\'s friend angry with Tharg, Tharg angry with Tharg. Give friend gift, friend not angry! Bring claws, Bloodfen claws only! Me give reward.",
    ["O"] = "Collect 5 Bloodfen Claw\'s for Tharg in Dustwallow Marsh.",
    ["T"] = "Need Claws",
  },
  [40403] = {
    ["D"] = "Tharg made gift.Tharg wants new friend to give gift to old friend. Tharg really sorry he lost favourite hitting stick, it was gift from old friend.Old friend name Bourok, he left with the little greens, in little green village. Go south, you find Bourok, give this, say Tharg sorry.",
    ["O"] = "Bring Tharg\'s Gift to Bourok in Mudsprocket.",
    ["T"] = "Tharg\'s Gift to Friend",
  },
  [40404] = {
    ["D"] = "Me bit happy now, Tharg gave beautiful gift! I send Tharg some big lizard meat, he loves big lizard meat.Me wishes me had another funny hitting stick for Tharg but me have to ask goblin friend. Me send it later, but no tell! Big surprise!<Bourok raises his arm in the air.>Give sack to Tharg, Tharg happy! Goodbye Tharg and me new friend.",
    ["O"] = "Bring the Big Sack of Big Lizard Meat to Tharg in Dustwallow Marsh.",
    ["T"] = "Return to Tharg",
  },
  [40405] = {
    ["D"] = "Marsh ugly, stinky!Me best chef in Kalimdor, but me only cook ugly and smelly things! Me so hungry, me could eat you.<Ogg\'mar laughs>Joke, joke. But me has idea. Me make ugly spider in good food, give you some too. Hunt for Ogg\'mar, hunt spider, bring white spider meat. Crack them good, hunt them good! Me cook them good, we eat them good together!",
    ["O"] = "Collect 10 White Spider Meat from spiders for Ogg\'mar in Dustwallow Marsh.",
    ["T"] = "Spider Meat Good",
  },
  [40406] = {
    ["D"] = "Hello mon!Another beautiful day in the marsh, right? Some of the ogres here dislike it, but Balai sees great potential in the marsh.Many plants and creatures to harvest from for potions and poisons. No better place Balai says.Do you wish to do Balai a favour? Balai pay nicely. You will need to venture into the marsh and find Withervine Mire Beasts, kill them, bring me the core and you get paid.The Mire Beast core can be a strong poison if altered properly, the Warchief said not to touch the humans of Theramore but if they come too far, Balai will know how to deal with them!",
    ["O"] = "Collect 5 Withervine Mire Beast Core\'s for Balai Lok\'wein in Brackenwall Village.",
    ["T"] = "Balai\'s Experiment",
  },
  [40407] = {
    ["D"] = "It has been years since the invasion of the Burning Legion during the Third War, and while they have been defeated, they still hold much sway upon Azeroth. Demonic magic is extremely potent, and it is something I have been tasked with studying.In the region of Desolace within an area known as Mannoroc Coven there is quite a sizeable demonic presence. It is there that I ask of you to acquire a Mannoroc Demonic Sigil, finding one may be rare, but if we are to have a chance to defeat the Burning Legion, then we must know all that we can.Slay them, and bring me one of their sigils for study.",
    ["O"] = "Acquire a Mannoroc Demonic Sigil for Magus Hallister at Theramore Isle in Dustwallow Marsh.",
    ["T"] = "Mannoroc Demonic Sigil",
  },
  [40408] = {
    ["D"] = "Say, since you stopped by how about we have ourselves a nice meal, it\'s been a bit since I\'ve been able to enjoy my special recipe! I damn near hunted all the Darkfang in the area, so you\'ll have to venture further out into the swamp to go and get me some of their juicy legs!Five should do, the Darkfang spiders are practically everywhere in the swamp, but especially so around the Quagmire down in the south west.Oh, and make sure they\'re extra juicy, I won\'t take no dang-nabbit unjuicy spider legs now, yahear?",
    ["O"] = "Gather 5 Extra Juicy Darkfang Legs for \"Swamp Eye\" Jarl at Swamplight Manor in Dustwallow Marsh.",
    ["T"] = "Juicy Darkfang Legs!",
  },
  [40409] = {
    ["D"] = "I\'ve lived at this lighthouse for a long time now, and if there is anything that has bothered me most it\'s those damned Mirefin. They often venture deep out within the ocean and upon the shorelines to the north, but as of recently they have come down here if only to drive me mad and steal my things!The Theramore Guard cannot have someone staying here full time, especially with us being seperated by a boat ride.I ask of you to rid me of their annoyance, and for good. I feel like its only a matter of time before they do something more serious. You can find them all along the coast up to the north and on small little islands. Bring me twenty of their claws and thin out their numbers so they think twice before coming so far south.",
    ["O"] = "Collect 20 Mirefin Claws for Old Bryan at the Theramore Lighthouse.",
    ["T"] = "The Mirefin Nuisance",
  },
  [40410] = {
    ["D"] = "It was about a week ago now when the damned Mirefin raided my Lighthouse and got off with all manner of supply I had been building up. A few weeks of food rations and some tools, but most importantly oil for the Lighthouse!The Lighthouse in Theramore runs from oil collected in other parts of the world, and of which we only get a shipment in at the start of every month, without it, the Lighthouse will die out. I do not need to tell you how vital this Lighthouse is especially for a port city like Theramore.I ask of you to gather it back from the Mirefin Murlocs, no doubt they have it stashed among their hovels up to the north west, make sure to check the isles there, they practically infest them.",
    ["O"] = "Gather the Lighthouse Oil Barrel for Old Bryan at the Theramore Lighthouse.",
    ["T"] = "Stolen Oil",
  },
  [40411] = {
    ["D"] = "Oh, how it is to be docked and not sailing the vast, and boring sea for months on end. All this time to myself and some dry land to stand upon, I just wish I had one thing.I have a contact out in Steamwheedle Port that has been my hookup for a while now, and if you wouldn\'t mind picking up a special \'package\' for me, it would be much appreciated!At the port there is a goblin named Jabbey, he can almost get you anything you need, that is if you have the coin for his \'premium wares\' he calls it. Head out there, and pick up a package for \'Groy\' he\'ll know what I\'m looking for.",
  ...
  [40413] = {
    ["D"] = "Hey there, I\'m in need of assistance if you don\'t mind giving some. I have a delivery I need run to the Theramore Lighthouse to Old Bryan that resides there. His food delivery has run a little late and I need it to get to him as soon as possible.You can find the Theramore Lighthouse just off the coast to the north east, the bright shining light should be enough to guide you.",
    ["O"] = "Bring Bryan\'s Food Delivery to Old Bryan at the Theramore Lighthouse in Dustwallow Marsh.",
    ["T"] = "Old Bryan\'s Food Delivery",
  },
  [40414] = {
    ["D"] = "The local murlocs are becoming more, and more of a threat as time continues, they are no longer confined to just the depths or the shore, and are often seen traveling inland, or harassing locals.They are led by a large, foul beast named Marglum Blood-eye, a hulking abomination of a murloc that patrols the coastline to the north-east shoreline.Find him, and bring his head to me, and I will make sure you are rewarded.",
    ["O"] = "Find Marglum Blood-eye along coast north west of Theramore and bring his head to Sergeant Terresa on Theramore Isle.",
    ["T"] = "Marglum Blood-eye",
  },
  [40415] = {
    ["D"] = "Hey there, you look tough enough to handle yourself, and Theramore is in need of some assistance. My last runner was ambushed on the roadway, and suffered a rather grevious wound. If we want to keep our defence of the roadway through Dustwallow then we need to remain steadfast.As such, I haven\'t received the weekly reports from both Sentry Point, and North Point.I want you to report to Captain Wallace Cross at Sentry Point Tower, and Captain Harker at North Point Tower, and bring their reports back to me.",
  ...
  [40416] = {
    ["D"] = "I once came from the city of Stormwind, and traveled to Kul Tiras, that was before the fleet ventured here, to Theramore. Ever since me and my brother have been seperated and while I have heard good things about him, and his business I haven\'t had any opportunity to deliver a letter, especially being stuck here at my post.If you ever find yourself in Stormwind, would you mind stopping by The Silver Shield in the Old Town of Stormwind? My brother Bryan is the one that runs the place, and it would mean the world to me if you could run him this letter.",
    ["O"] = "Deliver Wallace\'s Letter to Bryan Cross in Stormwind City.",
    ["T"] = "Delivery to Cross",
  },
  [40417] = {
    ["D"] = "While you are still here, could I ask of you a favor? I desire to send my brother something that perhaps can assist him. As much as he down plays his work in Theramore, I do know from stories I have heard that the swamp is crawling with all manner of orc and dragon.I had a fireheated shield made some time ago, and haven\'t had the chance to sell it yet, I would much rather that it gets to him out there, then to sit in my shop and collect dust, aside, there is no finer gift I can give.Take this shield to him out in Dustwallow Marsh, it would mean quite a lot to me.",
    ["O"] = "Deliver Bryan\'s Fireheated Shield to Captain Wallace Cross in Dustwallow Marsh.",
    ["T"] = "Delivery to Wallace",
  },
  [40418] = {
    ["D"] = "With each passing week the roadways get more and more dangerous. Nature here is ever encroaching, always looking to gain more and more ground. If we want to keep our forward sentries supplied then the road to Northpoint must remain secured.Our biggest threat is currently the Bloodfen Raptor\'s that have been breeding to the north of us.If you could find a way to rid Northpoint of this threat, I would see to it that you were paid accordingly, I am sure Theramore could find a way to reimburse your troubles.Head to the north, and slay the Bloodfen Screechers you find there.",
    ["O"] = "Slay 14 Bloodfen Screechers for Captain Harker at Northpoint Tower in Dustwallow Marsh.",
    ["T"] = "Securing Northpoint",
  },
  [40419] = {
    ["D"] = "Soldier, we need you.A Few weeks ago I sent a small expeditionary force south, to Blasted Lands. I haven\'t gotten a word from them since. Go there, and see what happened. I ordered them to set up a camp in proximity to the Dark Portal, if it helps.",
    ["O"] = "Find the missing expedition in Blasted Lands.",
    ["T"] = "A Blasted Land",
  },
  [40420] = {
    ["D"] = "We have no presence in Blasted Lands. The Alliance, on the other hand, occupies a large fort north of our current position. They haven\'t interrupted our operations in the region.Yet.I need you to check what are they planning. There has been a lot of movement lately in a cave close to Nethergarde. See what is happening there. Try not to kill too many of them. We don\'t want an open war with the Alliance.",
    ["O"] = "Scout the cave next to Nethergarde Keep for Sorlugg in the Blasted Lands.",
    ["T"] = "Nethergarde Scouting",
  },
  [40421] = {
    ["D"] = "The Shadowsworn cultists have been giving us a hard time here. In the last two days we faced three attacks from them. They were weak, and we managed to fend them off. I fear that in the future, they will send a bigger force.We need to act quicker. Venture into the wasteland, find their strongholds, and thin their ranks. Buy us more time.",
  ...
  [40423] = {
    ["D"] = "Do you know what is the worst here? Not the heat, not the demons. Not even the alliance, sitting comfortably in their castle. It\'s the ogres. Why ogres? Because I hate them. And that’s a reason good enough.That, and of course, they are a danger to our mission.Bring me twenty ogre heads. Of any ogre, I don\'t care. I will personally write about your victory in the report.",
    ["O"] = "Bring 20 Dreadmaul Heads to Bagaroh in the Blasted Lands.",
    ["T"] = "Blasted Ogres!",
  },
  [40424] = {
    ["D"] = "Thanks to your actions, we have been able to rest for a while. I also wrote the report for Ruag. Deliver it, and remind him to send some booze too next time he thinks we need help.Blood and honor, friend. You helped us and the horde today.",
    ["O"] = "Deliver the Blasted Lands Report to Dispatch Commander Ruag in Stonard.",
    ["T"] = "Report from a Blasted Land",
  },
  [40425] = {
    ["D"] = "Long has it been rumored that the mystical ninth volume of the Arcane Intricacies and Magical Phenomenon has been stashed deep within the Stormwind Vault. So long has it been gone that it has almost become legend, the secret -lost- tome.Well, it is a secret no longer, and it needs to be recovered before some vile vagrant gets their hands on something so rare.Within Stormwind Vault lays this book, it needs to be recovered so that I can complete my records of it.",
  ...
  [40426] = {
    ["D"] = "Back when the Vault first was opened, it was used to house the most dangerous prisoners, to contain magical entities and the insane alike, we used Runic Constructs to patrol the hallways!These Runic Constructs have fallen corrupt from the intense magic within the Vault, and need to be destroyed, their powerful bracers are what keep them intact, and they need to be recovered! I have plans to test what exactly went wrong with these bracers.You can find them within the Stormwind Vault, slay them, and bring me a pair of Shackles, I will make sure you are rewarded for the task.",
  ...
  [40427] = {
    ["D"] = "Many years ago the wizards of Stormwind discovered a large crystal that held an intense amount of magical energy. This crystal we named Arc\'Tiras, and stashed it deep within the Stormwind Vault after many mishaps with the unstable magic it emitted.Little did we know this crystal, Arc\'Tiras had a mind of it\'s own.It has driven the guards mad, and turned the Stormwind Vault into nothing more than corridors of madness. Our magic is enough to hold the crystal at bay, for now, but it needs to be destroyed, and for good.Travel into the Stormwind Vault, put an end to this madness.",
  ...
  [40428] = {
    ["D"] = "Hey you, do you think you can help?The Garrison Armory is nothing more than a trogg infestation. A trogg infestation that claimed the lives of twelve workers. It was one of the last dangers we ever expected to face, but when they came in, they came in fast.The dead need to be avenged, and the mine needs to be cleared out for our own security.The miners and I have collected enough coin to pay for someone to do the job right, go in there and clean it out good, don\'t show them mercy.",
  ...
  [40429] = {
    ["D"] = "The Garrison Armory is a place Nethergarde has stored extra supplies for some time now, and before long there will not be anything left if the troggs trample, and destroy it all.I need you to go in there, and recover atleast ten Garrison Armory Supply Caches, that way when this mess is over, and the dead are buried, we can return to work, and still have the tools to do so.Venture inside, and see if you can recover them for me.",
  ...
  [40430] = {
    ["D"] = "Ogres, oh how I hate em! If it aint demons then it\'s ogres!The Dreadmaul came with the orcs during the First War, and they\'ve been a sore on these lands ever since they arrived. They are responsible for a lot of the dead and they need to be dealt with. We currently have a bounty on their skulls, bring me thirty of them, and I\'ll give you something worth your time $c.You can find the Dreadmaul to the west, and southwest, goodluck!",
  ...
  [40432] = {
    ["D"] = "The Garrison Armory is a disaster, many of our miners have been slain, and troggs run loose destroying our progress.If work is to ever continue there, we must do more than kill some troggs, we must cut the head off the beast, and slay their leaders.The troggs that took over the Garrison Armory go by the name \'Boulderclaw\' and are led by two big monsters named Kroshmak and Gorlush.Travel into the depths of the mine to the west, and slay their leaders, bring me one of their claws as proof.",
  ...
  [40433] = {
    ["D"] = "Nethergarde is an isolated, and rather desolate place. We rely on a large garrison to help stem the tide of a potential demonic invasion, should such an occasion ever occur.The soldiers under my command have homes and families, and morale here is paramount. I rely on my sergeants to give me a situation report on the status of those beneath me.As of current the only one I am waiting from is from Sergeant Burnside, would you do me a favor, and collect it from him? You can find him somewhere outside the gate, he is probably with his troops.",
  ...
  [40434] = {
    ["D"] = "It has come to my attention that a dark magic has been growing in power within the region. Our Analyser Wigglestip has documented an extensive amount of magic being introduced into the area.There is no doubt that the Shadowsworn would be the ones utilizing such forces. Those that gather around the Altar of Storms are to blame, and our reports only confirm that.I need someone to dispatch of the Dreadweaver\'s that spread the corruption. Who knows what plans they have in motion, but I do not intend to sit around to find out.",
    ["O"] = "Slay 8 Shadowsworn Dreadweavers for Commander Baelos at Nethergarde Keep.",
    ["T"] = "Suppressing the Dreadweavers ",
  },
  [40435] = {
    ["D"] = "The energy radiating off of the Dark Portal is sheerly astounding, and it\'s given me so many research opportunities that I do not know where to start! I was employed here as an analyst to watch the ever shifting arcane magic within the region, and its incredibly unstable, so unstable infact that it has warped the boars close to the portal itself, turning them into \'Helboar\'!I know it sounds like something straight out of fantasy!I need you to get me a Pristine Helboar Brain, to see just how much the creature has been altered by the intense energy of the Dark Portal.",
    ["O"] = "Collect a Pristine Helboar Brain for Engineer Wigglestip at Nethergarde Keep.",
    ["T"] = "Genetic Alteration Anomaly!",
  },
  [40436] = {
    ["D"] = "Hey, you there, I need your help.About a week ago on one of our patrols we ended up being attacked by a group of ogres, these ogres were fierce enough to make us retreat. During the struggle one of my Private\'s was captured by the Dreadmaul.I don\'t know where they have taken him, but I want you to find him, I can\'t risk any more of my soldiers on such a mission.If I was you I would search their camps, both to the west, and southwest, he may be in one of them.",
  ...
  [40438] = {
    ["D"] = "Why, you wouldn\'t happen to have some spare time would you?The master of this tower has been hard at work and has given me the task of gathering a report from Engineer Wigglestip. Sadly to say, I haven\'t had the opportunity to leave just yet, nor do I know how to find our gnomish friend!Do you think you could speak with Wigglestip and gather the report from him? Once you\'ve obtained it, you can bring it to Watcher Mahar Ba at the top of the tower.",
    ["O"] = "Speak with Engineer Wigglestip and gather his report, bring it to Watcher Mahar Ba.",
    ["T"] = "Fel Energy Irregularities I",
  },
  [40439] = {
    ["D"] = "Well, this news certainly reinforces my assumptions, and what I have been studying. The Blasted Land\'s has become even more unstable, the energies within the region are beginning to grow in power.I have been preparing a report that I need delivered to my superior\'s in the Kirin Tor, and I need you to deliver it at once. Communication at such a distance is impossible with the raging storms so I am relying on you. Travel to Dalaran at once, and deliver this report to Archmage Ansirem Runeweaver.",
  ...
  [40440] = {
    ["D"] = "It would appear that fel energy has indeed begun to ripple across the Blasted Lands, sending the region into a swirl of irregularities, and unstable conditions. Let us hope this is simply caused from the Dark Portal itself, and not its reactivation.It will take many more of our kin to keep everything under control.Now then, I am asking you to deliver an important letter, one that is magically sealed, breaking it, will destroy the parchment.I trust that you will do for the good of the Kirin Tor, and for the Alliance itself.Make sure this reaches Mahar Ba, so that he may begin the neccesary tests and preparations.",
  ...
  [40441] = {
    ["D"] = "The Riftwatchers and myself have much work to do in our studying now that we know what is happening. I will need you to assist and gather some items from the demons nearest to the Dark Portal.From the Felguard Sentry, and Felhounds, we will need to analyze to see if these demons are fresh from the portal, in doing so we need specific items.From the Felguard\'s, gather Felguard Cuffs, from the Felhounds, gather Felhound Claws.Once they are obtained, return them to me, at once, three of each should suffice.",
  ...
  [40442] = {
    ["D"] = "We have spent many months studying and preparing for the future, and it appears the future may be upon us sooner then we had realized.There is one I have not spoken with for a long, long time. An old friend who once studied within the Kirin Tor, lost to the ways of demonic, and dark magic.I will simply say that he owes me a favor, and I ask of you to reach him, so that he may answer my questions about the Dark Portal and the irregularities of the magic in the region.Travel to the Southwest, and venture within the Tainted Scar, find Daio the Decrepit, an old warlock who resides there, ask him if he knows anything, I would suggest bringing a friend, or recruiting mercenaries, it is a dangerous place there.",
    ["O"] = "Travel to the Tainted Scar, and speak with Daio the Decrepit.",
    ["T"] = "Fel Energy Irregularities V",
  },
  [40443] = {
    ["D"] = "Heh.. He has a question, does he?<The old, withered man lets out a crooked laugh, a wiry smirk resting upon his aged features.>I haven\'t spoken to Mahar Ba in a long, long time, if he wants information, than I need something done, favor or no favor!If you want to know the truth, than I require something from you.Within the Tainted Scar lies a secretive race of demon, the Dreadlord, I have been meaning to practice all sorts of magic and I need a singular heart. Bring me a Dreadlord Heart, and I shall tell you what I know.",
    ["O"] = "Slay a Dreadlord within The Tainted Scar, and bring his Heart to Daio the Decrepit.",
    ["T"] = "Fel Energy Irregularities VI",
  },
  [40444] = {
    ["D"] = "So, he desires to know about the Dark Portal, and the influx of fel energy? The demon\'s have been gathering for some time around the Tainted Scar, and have been using it as a safe haven close to The Dark Portal.With the increase of Fel Energy, there is no doubt that they have plans for the future. This future though, may not come for some time given what I have heard.Go to Mahar Ba, and tell him to gather the best of his kin, and to prepare himself, time ticks slowly.Now, begone, I have repaid his favor.",
    ["O"] = "Return the news to Watcher Mahar Ba at Nethergarde Keep.",
    ["T"] = "Fel Energy Irregularities VII",
  },
  [40445] = {
    ["D"] = "Hello there traveler, and welcome.There is something that I must ask of you to ensure the safety of the wyvern here at the Roost.Wyvern are creatures that roam and explore, it is not something that we can control, though sometimes the wyvern venture to far, and into the claws of Harpy.The Windfury Harpy have gotten so bold as to organize scouting groups for wayward wyvern, and already we have lost one this past month, if we are to continue and keep our training, young wyvern safe, then we must take action.Far to the north, and the north west are Windfury Sorceress and Matriarch, they are the ones that need to be removed, go there, and make certain the welfare of our wyvern.",
  ...
  [40447] = {
    ["D"] = "The Quillboar expunged us from our sacred cave and vantage points overlooking the expansive Mulgore. It is not the cave itself I am worried about, but many of the ceremonies that must be held in the next few days to help pass the dead into the realm beyond.Left behind in the Quillboar\'s rampage are tools, and charms that we will need to reclaim for the upcoming ceremonies, and I need you to get them for me.I lost the following items just to the east, A Silver Hawk\'s Feather, Ornate Spirit Beads, and the Drum of Passing.Recover them, and help the dead ease their way to the afterlife.",
  ...
  [40448] = {
    ["D"] = "It\'s been a few weeks now since we\'ve had to send Brian away to live with some cousins of mine in the city. It\'s not the safest place, but it\'s much safer then around here, especially with all of the defenders around Gallant Square.I\'ve had a lot of worries since he left, and I just want to make sure he is okay. I\'ve prepared a lot of things to send to him so he feels a bit more comfortable during his stay, do you mind running them out for me, and making sure he gets them?You can find him in Stromgarde, in Gallant Square, the part of the city that is under construction.",
    ["O"] = "Bring the \'Packed Goods for Brian\' to Brian Livingstone at Gallant Square in Arathi Highlands.",
    ["T"] = "A Mother\'s Concern",
  },
  [40449] = {
    ["D"] = "Howdy friend!We have been dealing with all sorts of problems ever since we first started settling here, from raptor, to giant spider, to ogre!Chaser has done well enough with scaring off the local wildlife but they have just gotten too aggresive as of recently, from trampling on our fields to even fighting with us. It\'s gotten so bad infact I had to send my son into Stromgarde until things calmed down.If you could clean up some of the critters, that would go much appreciated for me and my wife. About ten of those Plains Creeper\'s and ten more of the Highland Thrasher\'s should do just fine.",
  ...
  [40450] = {
    ["D"] = "Say there, you wouldn\'t happen to know anyone that knows a thing or two about engineering, would you? We picked up Chaser from Southshore about a year ago now, from a goblin merchant infact. He\'s been great, but, slowly he\'s been breaking down, or getting kinda slow.I was told that he would need a backup Gold Power Core at some point, and I think that might be what the issue is. The problem itself though is that we\'re so far out here, and I don\'t really know much about engineering to craft one, or have the resources on hand infact! If you could get one, I\'m sure Chaser would be quite happy.",
    ["O"] = "Collect a Gold Power Core for Chaser at the Livingstone Croft in Arathi Highlands",
    ["T"] = "Repowering Chaser",
  },
  [40451] = {
    ["D"] = "It has been a while since the Troll Hunter\'s of Stromgarde have had the chance to practice their trade. We have been confined defending our section of the city now for too long, under constant threat.Our main enemy is biding their time, and gathering their strength. The trolls have been at war with us for generations. My fathers, their fathers, and even their own have fought troll.We will strike at them, to show them that Stromgarde will not lay down idle. Far to the east is Witherbark Village, go there, and kill ten Witherbark Shadow Hunters.",
  ...
  [40453] = {
    ["D"] = "The ogre\'s have caused us much headache, and have taken a section of the city from us. The last thing we need is more forces coming from outside of the walls to assist those that are within.To the north just outside of the city is Boulder\'gor, a small outpost that is an ogre sanctuary. I need you to go there, and bring the fight to them, so that more do not come pouring into the city.Bring me twenty Boulderfist Truncheon\'s as proof, and Stromgarde shall reward you.",
    ["O"] = "Gather 20 Boulderfist Truncheon\'s for Sergeant Karster in Gallant Square at Stromgarde Keep.",
    ["T"] = "The Boulderfist Outpost",
  },
  [40454] = {
    ["D"] = "A few weeks ago I had a ring commissioned from Old Farwell up at the Farwell stead far to the north. Old Farwell was once a prominent, and powerful wizard of the Kirin Tor, one who is now retired.The ring is supposed to safeguard against the foul, and dark magic lingering within the city.You can find the passage way on the north western corner of the Arathi Highlands leading into the mountains where his Stead is located.",
    ["O"] = "Speak with Old Farwell at the Farwell Stead.",
    ["T"] = "Farwell Commission",
  },
  [40455] = {
    ["D"] = "Oh, Sergeant Karster sent you? Well, it\'s good getting some work from time to time, my magical abilities haven\'t been tested for a while now.<Old Farwell produces a small, ornate ring, with a glowing violet gem.>This ring should ward off any magical energies or foul tainting aura. Make sure you give my best to Sergeant Karster.",
    ["O"] = "Return the Farwell Ring to Sergeant Karster in the Gallant Square at Stromgarde Keep.",
    ["T"] = "Farwell Commission",
  },
  [40456] = {
    ["D"] = "Hey you, $r! You look like the sort of cultured individual who likes knowing what goes on in the world! Well, I\'m a trainee saleslady for the goblin owned Gadgetzan Times Newspaper! We cover only the biggest and explodiest stories around!For just a few silver you will be known as an… ally of Gadgetzan, yes! And with also the useful tips and tricks within the pages, well, just imagine all the profits you can make for such a tiny investment now!<She waggles a rolled up newspaper towards you.>",
    ["O"] = "Purchase the second edition of The Gadgetzan Times!",
    ["T"] = "Gadgetzan Times: READ ALL ABOUT IT!",
  },
  [40457] = {
    ["D"] = "Hey you, $r! You look like the sorta cultured individual who likes knowing what goes on in the world! Well, I\'m a professional saleslady for the Gadgetzan Times Newspaper! And you know us goblins, if it ain\'t worth its weight in gold, it ain\'t worth coverin\'.For just a few silver you can have your name written down as a supporter of the newspaper, and a friend to goblin business. And with the information inside, you can profit beyond your wildest dreams! All that for such a tiny investment purchase.<She smirks and holds out the newspaper towards you.>",
    ["O"] = "Purchase the second edition of The Gadgetzan Times!",
    ["T"] = "Gadgetzan Times: READ ALL ABOUT IT!",
  },
  [40458] = {
    ["D"] = "Alright $Glad:lassie;, the lookout reports just came in. Seems the ol\'brotherhood isn\'t alone outside anymore. The reports indicate that the shadowforge are setting up something at the other side of mountain, a quarry of sorts. What they\'re digging is a mystery though, as nobody goes inside never gets out alive unless they\'re with them.That\'s where you come in. Gather your friends or some mercenaries and venture into that quarry, find out what they are digging up out there. Now go!",
    ["O"] = "Find out what\'s being dug up in the Hateforge Quarry.",
    ["T"] = "Rival Presence",
  },
  [40459] = {
    ["D"] = "You want to help us out do you? Well we need to know we can trust you, after all, we have many enemies in this region, and most regions of the world, probably.You can start by gathering Thaurrisan Badges, carried by the Dark Iron in the Ruins of Thaurrisan. Gather 15 of them, and bring them to Orvak Sternrock, he will know you mean business then.",
    ["O"] = "Gather 15 Thaurissan Badges for Orvak Sternrock at the Blackrock Pass in Burning Steppes.",
    ["T"] = "Gaining Orvak\'s Trust",
  },
  [40460] = {
    ["D"] = "Not often we get someone wanting to help, especially one of your kind. That said, we aren\'t all too able to turn down a willing hand, especially given all of the others that died in our caravan.I need you to understand my point of view, and what I have gone through. Maybe you\'ll think twice before you label me as another of my kin.Speak with me, and listen to my story when you\'re ready.",
    ["O"] = "Listen to Orvak Sternrock\'s Story.",
    ["T"] = "Hearing Orvak\'s Story",
  },
  [40461] = {
    ["D"] = "Now that you understand we are on the same page, and are fighting the same enemy I would have you prove to me one last test of loyalty.Before we can begin our grand revenge, I must plan for the future.Long ago, before I held any position of power I buried a large stash of items and gold incase I ever needed to leave or escape, well that time has come.If me and my comrades are to live this adventure than I will need that stash.Travel to the entrance of the Blackrock Mountain, and search beneath the bridgeway, between the two pillars, you will find the stash there.",
  ...
  [40462] = {
    ["D"] = "The Miners Union betrayed the High Foreman, and sentenced those that were loyal to Orvak into slavery. There is no other step than justice and it must be handed out to any, and all who remain!To the east lays the Hateforge Excavation, we will begin by dealing with the Excavators who are working on a series of redoubts and defenses leading into the Quarry.Slay 10 of them, and return to me.",
  ...
  [40463] = {
    ["D"] = "Bargul BlackhammerThat vile scum has been working to get the position of High Foreman now for years, attempting every underhanded tactic that he could think of.From violence, to deceit, nothing was off the table for scum such as him.The idea of the Hateforge Quarry was an idea Bargul came up with, and sent to the senate. He ended up convincing the lot of them, and worked in tandam to get me outed from my position.Bargul Blackhammer holds my title now from a position of underhanded fraud, and I want him to hold it no longer.Within the Hateforge Quarry, Bargul Blackhammer oversee\'s the work from atop of his tower with an iron fist, kill him for all of the chaos he has caused, and recover the Senate\'s Orders from around his possessions.",
  ...
  [40464] = {
    ["D"] = "Shadowforge was once a home that I was proud of. I know the truth of what it really is now, and it is vile, and corrupt.At it\'s heart many of the decisions the Shadowforge Senator\'s make are only to further their own interests at the expense of the people who live within.I ask for a favor, one more important than anything to me.The Shadowforge Senate needs to be rooted out, they are safe, and comfortable deep within the city, make it so they feel fear.You can enter Shadowforge deep within the Blackrock Mountain, go there, and brave the Blackrock Depths to find them, and kill them.",
  ...
  [40465] = {
    ["D"] = "Hey there, I got a strange request for you if you don\'t mind helping. I used to be an Arcanasmith within Shadowforge and worked with all kinds of Golem Cores.My loyalty to ol\' Orvak got me tossed out with the rest of the miners. Whenever we get out of this here camp I want to continue my work and I\'d like a head start.Up to the north is the Ruins of Thaurrisan. The Dark Irons have War Reavers that patrol, those Reavers are powered by Golem Cores, get me three of them, so we can see what kind of power they contain.",
    ["O"] = "Gather 3 Golem Cores for Radgan Deepblaze at Blackrock Pass in Burning Steppes.",
    ["T"] = "Discovering Golem Secrets",
  },
  [40466] = {
    ["D"] = "During my time in the mountain I had met all kinds of characters within the Grim Guzzler, one of which was a rather ambitious goblin who said he could get me almost anything.A few months ago I requisitioned him for information on where to acquire a Arcane Golem Core. Last I recall, he frequents Steamwheedle Port in Tanaris, and goes by the name \'Jabbey\', aparently a lot of people know him.Travel there, and get me the Arcane Golem Core Information from him, just mention my name and he should know what you are looking for.",
  ...
  [40467] = {
    ["D"] = "This information contains all manner of suppliers, distributors and who is involved, it appears Argelmach is the one who would hold such an item.If I am to ever get my hands on an Arcane Golem Core, it would be through him, and that means I need you to get it.You can find Argelmach deep within the Blackrock Depths, he is usually seen around a team of weapons experts and Arcanasmiths.Bring me a Arcane Golem Core, and I will make it worth your while!",
  ...
  [40468] = {
    ["D"] = "Now we will strike at the heart of the Miners Union.Their main project lays just beyond the excavation, and deep within the Quarry. It is there they began their mutiny to get Orvak removed, and it is there they will feel the wrath of Morgrim Firepike.Oh, and his mercenaries, of course.Head to the Hateforge Quarry to the east, and kill twenty of them, they shall have consequences for their actions.",
  ...
  [40469] = {
    ["D"] = "Oh, how the name \'Vilegrip\' brings a burning desire for blood to my head. His name has rung deep in my mind ever since the mutiny.Slaver Vilegrip is responsible for the enslavement of all those that stood with Orvak, those who now rot deep within the Blackrock Mountain.He shall pay for his crimes, and you will bring me his head. Search for him, he should be at the Hateforge Excavation to the east. Make sure he begs and cries for the atrocities he has commited, make him suffer.",
  ...
  [40470] = {
    ["D"] = "The mysterious animation runes, I\'ve been trying to get my hands on one, but as a shop keep I aint exactly the type to go and fight mechanical monsters.I work for a certain someone who is investigating the harvest golems in Westfall. If you could recover one, I would make it worth your while!You can find one within any Harvest Golem in the region.",
  ...
  [40487] = {
    ["D"] = "<Senator Granitebeard makes quick work of writing his report, sealing it and stamping it with the seal of Ironforge.>There, I need you to take this to Ironforge, at once, and report it to King Magni Bronzebeard, it should hold all relevant information based off what I have seen, and what you have reported back to myself.Be quick, our enemies plot against us.",
    ["O"] = "Take the Hateforge Report to King Magni Bronzebeard in Ironforge.",
    ["T"] = "The Hateforge Report",
  },
  [40488] = {
    ["D"] = "<Magni would take the Hateforge Report, beginning to read it over with a calculated interest.>The Dark Iron have been our foe for quite a while now, and I will not forgive them for what they have done.It has been a while since we have discovered the efforts going on within the Burning Steppes, it was only a matter of discovering -what- was going on there.It would appear that the Twilight Hammer has taken an interest in the project, they have been spotted entering.Take my response to Senator Gravelbelt, you are dismissed.",
    ["O"] = "Bring Magni\'s Authorization to Senator Gravelbelt at Morgan\'s Vigil in Burning Steppes.",
    ["T"] = "The King\'s Response",
  },
  [40489] = {
    ["D"] = "It would appear that The Hateforge Quarry is of great concern to the King, and he has given me the authority to recruit any on behalf of the kingdom.If you are wanting to gain favor with Magni than this would be a good opportunity.I am looking for anyone to venture deep into the Hateforge Quarry and remove the presence of the Twilight Hammer within. If you are interested, I would suggest bringing fellow adventurers, a group of mercenaries, or some kind of brigade.If you end up completing the task, return to Magni himself, and he will reward you.",
  ...
  [40490] = {
    ["D"] = "There be rumors floatin\' around about somethin\' called \'Hateforge Brew\'. The Dark Iron refer to it as something with reverance, and I know they aint makin\' no ale in there.The name is a cover up for somethin\' else and we gotta find out just what that somethin\' else is, ye get me? I do know that they have Chemist\'s within the Quarry, and my bet is they are linked to this Hateforge Brew.I need you to head in there, gather me a Dark Iron Vial and some Hateforge Chemistry Documents. I bet they have them stashed away somewhere in there about what\'s going on.",
  ...
  [40491] = {
    ["D"] = "Greetings stranger, it seems some new recruits from this new Horde are arriving at last.I\'ll keep this short, we\'re not doing so well here. It\'s like everything is being held together by worg spit, and the lack of resources certainly doesn\'t help. I\'ll say it\'s about time we fixed that.Dark Iron tends to be quite scarce in the surface of the steppes, though it is carried by many. Whether it be baubles, equipment, or sitting in a creature stomach.Venture out and collect me a sizeable amount of scraps so I can keep forging equipment for our grunts to keep Karfang Hold safe.",
    ["O"] = "Scavenge 50 Dark Iron Scraps from various creatures in Burning Steppes and return to Blacksmith Torren in Karfang Hold.",
    ["T"] = "Scrap Forager",
  },
  [40492] = {
    ["D"] = "Whelping, I need your assistance.The Blood Fury itself remains untapped to its full potential, long has it been since we have followed the demons and worked in tandam with their magic to become stronger. I intend to explore what may be possible without their help. My dark magic is practiced, and ready for use, I simply need the correct regeants.This is where you come in.Within the Burning Steppes are imps of a demonic nature, no doubt remnants of the burning legion, battle them, and bring me five of their scolding hearts.",
    ["O"] = "Bring 5 Scalding Flamekin Hearts to Darkseer Geshtol at Karfang Hold in Burning Steppes.",
    ["T"] = "Fueling the Blood Fury",
  },
  [40493] = {
    ["D"] = "This region does not possess the potency that I am looking for, but I do know a place that does.Far to the southeast is the Blasted Lands. It is where I came into this world, in awe by it\'s skies and the lush swamp. All that remains now is a hellish wasteland akin to what the Outland is.It is there that demons rove the land and the energies of the Dark Portal itself fester and pulse.Go there, and kill a Felguard Sentry that watches the portal, bring me a Large Felguard Heart.",
    ["O"] = "Bring a Large Felguard Heart from the Blasted Lands to Darkseer Geshtol at Karfang Hold in Burning Steppes.",
    ["T"] = "Fueling the Blood Fury",
  },
  [40494] = {
    ["D"] = "How disgusting.You people dare call yourself the Horde, yet you know nothing about the Horde. We are the True Horde, the first and the very best.I see no thirst for battle in your eyes, I see no glory, I see nothing. You\'re nothing more than a worm living in the legend of the real Horde. You are lucky I promised Karfang to indulge fools such as you. But if you truly want to not be a simple pest in the eyes of our clan you have to prove your skill as a warrior.Use whatever trickery you believe would aid you. I challenge you to take on the Firegut Ogres, slay them and prove yourself.Now go or forever be shamed for your utter powerlessness.",
  ...
  [40495] = {
    ["D"] = "Fine, you\'ve earned yourself the right to breathe the air in Karfang Hold.But I have one last trial for you. A grudge, yes, that\'s what this is.All the Blackhands were nothing but fools, the father was a misguided mongrel who was fooled by the wretched Gul\'dan. Maim isn\'t even worth mentioning, he died a fool\'s death, nothing more deserving for his kind.And Rend? Rend is kneeling before that despicable dragon and doomed the entirety of the Blackrock Clan. But that\'s not even his worst call yet.He made a forest frog his strategist.War Master Voone?<Ok\'gog yells that name angrily.>War Master? He\'s nothing but a disgusting frog that must meet his end. Bring me his tusks and prove once and for all that the Horde led by a wretch who grew up amongst Humans has at least a quarter of the former glory of the True Horde.",
  ...
  [40496] = {
    ["D"] = "I have fought in many battles, against the Alliance, orcs, demons, ogres... Yet I never expected to face my own clan.My clan no longer. A few days ago I was patrolling the wastes on my trusty wolf, Skullshatter. I encountered Rend\'s soldiers. Before I could do anything, they attacked! I was outnumbered. I manged to escape, but they hurt my wolf. I thought it to be only a scratch, as he suffered worse many times. Unfortunately, the arrow was poisoned and he died a few hours later.I do not mourn his death. This was his purpose, after all. He joined his brothers and will now hunt among the ancestors. But I want revenge. If only I wasn\'t so severly needed here... $R, go south of here, to the Pillar of Ash and slay as many Blackrock as you can. Bring me their heads. Forty will do.",
    ["O"] = "Bring 40 Blackrock Heads to Raider Fargosh in Karfang Hold.",
    ["T"] = "Raider\'s Revenge",
  },
  [40497] = {
    ["D"] = "Good. Now, a new task awaits you. As I said, I cannot leave this place. Not until I have a new wolf. My legs are not as swift as they used to be in my youth.Steal one from the Blackrock. Here, take this cage. Find a Young Blackrock Worg, capture it, and bring it to me. You can probably find a young worg in their stables in the Pillar of Ash. I will mold it into a worthy mount in no time.",
    ["O"] = "Catch a Young Blackrock Worg and bring him back to Raider Fargosh in Karfang Hold.",
    ["T"] = "Raider\'s New Mount",
  },
  [40498] = {
    ["D"] = "Last thing to do. In the Blackrock Spire, they breed wolves. Go there, and slay the alpha. Gizrul the Slavener is his name.Hit them where it hurts. Let them know my pain.",
    ["O"] = "Slay Gizrul the Slavener in Blackrock Spire, then report to Raider Fargosh in Karfang Hold.",
    ["T"] = "Raider\'s Raid",
  },
  [40499] = {
    ["D"] = "Greetings, recruit of the new horde. I suppose you\'re here to aid? Then I got the task for you. To the west of the hold you can find the deadly venomtip and deathlash scorpids, their body might be fragile but their venom killed many aspiring orcs. I know how to brew an antidote to cure such ailments, but problem is that the antidote is made from the venom glands of the scorpids themselves.Go out there and collect their glands, if you survive your efforts will save many lives. If you perish trying then you\'ll be forgotten like the rest.",
  ...
  [40501] = {
    ["D"] = "You are from the New Horde, are you not? After much discussing it has been decided that we cannot remain within the Blackrock Clan, and are seeking for new refuge and alliances outside of our boundaries.On Behalf of Karfang I am tasked to make a request.This Karfang Missive must be delivered to the Warchief Thrall in Orgrimmar at once, I trust that you can carry it to him.",
    ["O"] = "Deliver the Karfang Missive to Thrall in Orgrimmar.",
    ["T"] = "Of New and Old",
  },
  [40502] = {
    ["D"] = "Another wishes to join the Horde, so be it.I do hold concerns with those from the Blackrock Clan, for their evil runs deep, corrupted to the core. We have dealt with Old Horde refugees in the past but not an entire group looking to join us.Eitrigg was once apart of the Blackrock Clan, and perhaps knows more about this \'Karfang\'. Speak with him, and figure out what he knows.",
    ["O"] = "Speak with Eitrigg to find out info about Karfang for Thrall in Orgrimmar.",
    ["T"] = "Of New and Old II",
  },
  [40503] = {
    ["D"] = "I haven\'t heard that name in some time, though I certainly remember it.Karfang fought with the Blackrock Clan during our invasion of Azeroth, and rose through the ranks quickly. From my knowledge, he was a strong warrior, though not as blood thirsty as others.The Karfang I remember was smart enough to deny suicidal orders, or challenge leadership when required, I am not surprised he has lasted this long.Karfang can be trusted, he is certainly wise enough to see the doom of the Old Horde before him.Thrall gives approval on my word take the Warchief\'s Response to Karfang Hold, we will see if he can prove his loyalties.",
    ["O"] = "Bring the Warchief\'s Response to Karfang at Karfang Hold in Burning Steppes.",
    ["T"] = "Of New and Old III",
  },
  [40504] = {
    ["D"] = "I know what it is the Warchief speaks, the Twilight Hammer has recently moved into the Hateforge Quarry, located just south of here.It is an annoyance that was eventually going to draw in more attention from our former masters, and was something we would need to deal with eventually, now I implore you to help us with it.We may have the strength to fight deep, but to stop the Twilight Hammer lurking deep within the Dark Iron clutches, requires covert strength, not brute strength.As Warleader, I ask you to remove the Twilight presence on my behalf.",
    ["O"] = "Venture into the Hateforge Quarry, and remove the Twilight Hammer presence within for Karfang in Karfang Hold.",
    ["T"] = "Of New and Old IV",
  },
  [40505] = {
    ["D"] = "We have had many join our ranks from the various battle groups dotted around the Burning Steppes, their names etched in paper marking their transfer to Karfang Hold.To protect those that joined us we will need to destroy the documents that may lead any suspicious Blackrock our way.You will find the Transfer Documents amongst the small camps around the Pillar of Ash, search high and low, and burn any you find.",
    ["O"] = "Destroy the three Transfer Documents for Karfang at Karfang Hold in Burning Steppes.",
    ["T"] = "Protecting Fresh Blood",
  },
  [40506] = {
    ["D"] = "We will need to cover all of our tracks if we want to make it out of here alive. Karfang Hold is fortified, but not fortified enough to survive such an onslaught if they get wind of what is going on.Molk is my strategist, and should know our next move, speak with him.",
    ["O"] = "Speak with Molk in Karfang Hold.",
    ["T"] = "Report to Molk",
  },
  [40507] = {
    ["D"] = "I hope you understand that we are using you for our benefit. Do not take this the wrong way, for we are not looking to con, or cheat you.We simply require assistance to achieve our goals, goals that a Blackrock Orc cannot be seen doing, lest our betrayal be discovered.We need to destroy all traces of Karfang Hold, the records of its construction and garrison lay within the Blackrock Stronghold to the West. Gather these documents and return them to me so that I can make sure they are removed properly.Be careful, it is a well defended location.",
  ...
  [40508] = {
    ["D"] = "Raz\'gol Deadtusk, the name makes me regret what is to come.He was one of the first I told of my plot to depart from the Old Horde, a dearest friend from the days on Outland. He was too stubborn to accept, his loyalties rigid, and hard.He will not be coming with us, and we both know what must be done.It hurts me to ask it, but Raz\'gol Deadtusk must be slain, should he find out that I went through with my idea his loyalties to me will be pitted against the Blackrock Clan, and I cannot trust him to hold to his word.You will find him atop of the large spire in the Pillar of Ash, he looks down upon the region with an iron glare, slay him, and bring his blade back to me as proof of your deed.$N , do not make him suffer.",
  ...
  [40509] = {
    ["D"] = "There is one crack left that can break everything apart. His name is Zigris, Quartermaster for the Bloodaxe Legion deep within the Blackrock Spire.Upon setting out we borrowed all manner of tools and supplies to begin construction of Karfang Hold, these materials will eventually need to be collected. It will only be a matter of time until he will press to look for them. I am asking of you to slay Quartermaster Zigris, without him, there will be none who can figure out our motives.You will find him within the Blackrock Mountain, at Blackrock Spire\'s lower portions.",
    ["O"] = "Slay Quartermaster Zigris deep in the Blackrock Spire for Karfang at Karfang Hold in Burning Steppes.",
    ["T"] = "The Final Crack",
  },
  [40510] = {
    ["D"] = "Howdy there friend! Wanna hear a little story I was told from a friend? It\'s so crazy you wouldn\'t believe it!Aparently while she was venturing through the Burning Steppes she ran across a Black Dragonflight Whelp, which, isn\'t out of the normal, given just how many there is in the region. When she ended up shooting it, no blood came out, just puffs of smoke, and whirrs of machinery! Upon inspection it was discovered to have been a mechanical creation layered with replica skin, can you believe that?!Now that sure is magnificent engineering, so magnificent it has fooled even the dragons. I\'d like to see how it was done, if you wouldn\'t mind helping. Get me six bundles of Robotic Broodling Guts from each one you find, that should be enough to figure things out.",
  ...
  [40513] = {
    ["D"] = "Baaaaa! You must help me!The wizard in the house turned me into this form while I was out travelling.Baaaaa! Baaa!You got to do something, he\'s residing just inside the farmhouse, kill him, and bring his Azureborn Ring to me so I can be released from this torture!Baaaaaa!<The sheep looks at you with pleading eyes.>",
    ["O"] = "Gather the Azureborn Ring from Kalman Azureborn in Durotar for Lashog.",
    ["T"] = "Polymorph Enslavement!",
  },
  [40514] = {
    ["D"] = "Warm greetings friend.I am Meldralis, a diplomat. I have been sent from the Farstrider Lodge to thank our forever friends, the dwarves, for their hospitality. We are preparing a gift for King Magni and his daughter, Princess Moira.Alas, that is for Nel\'doriel to explain. He will probably need your aid as well! My task is to give this pamphlet to Illyanah in Stormwind City. The Humans of Stormwind were kind enough to offer us a small place in the Dwarven District, we have called it Little Silvermoon.Your kindness and help are highly appreciated, friend. May the Eternal Sun guide your steps.",
    ["O"] = "Take Meldralis\'s Pamphlet to Illyanah Dawnstar in Little Silvermoon, Stormwind.",
    ["T"] = "Thalassian Diplomacy",
  },
  [40515] = {
    ["D"] = "I just can\'t seem to get it to work!I\'ve managed to fix it once as we took it from Silvermoon to Farstrider Lodge. And it worked on the journey here, but I simply can\'t understand what\'s wrong with it! It might\'ve been damaged.Arcane Golems aren\'t an easy thing to build or repair. If only my master would still be alive. Wait, that\'s it! I remember Thalestien, my master gave his notes to a friend of his in Gnomeregan. He was so enthralled by the gnomish inventors that he gave Masey Wirefuse his notes, hoping that the gnomes would at one point improve his work.See if you can find her in Tinker Town, I truly hope she survived Gnomeregan, or else I\'m doomed.",
    ["O"] = "Speak to Masey Wirefuse in Tinker Town, Ironforge.",
    ["T"] = "It broke...",
  },
  [40516] = {
    ["D"] = "A student of Thalestien? How exciting!Thalestien was not exactly like the rest of the High Elves, he really enjoyed tinkering with gizmos and scraps as much as we did! But his craft also used a hefty amount of the Arcane, which in truth was a very smart choice. It\'s no less to tell that people like him were a true inspiration to Engineering today.The Arcane Golems were the product of high ingeniosity, but I\'m afraid Thalestien\'s notes are lost. The last time I had them I was in a small house North West of Brewnall Village, you could try there. Just be aware that Leper Gnomes might guard the area. If you were to get those notes, I believe a new age for Engineering could begin! Working with the High Elves from this aspect would be very exciting.",
    ["O"] = "Find Thalestien\'s notes North West of Brewnall Village for Masey Wirefuse in Ironforge.",
    ["T"] = "Thalestien\'s Notes",
  },
  [40517] = {
    ["D"] = "I’d love to take a peek through those again, I was sure they were lost!Thalestien was such an awe-inspiring engineer. So many exciting stories about people and their crafts.Have you ever heard of Brymidaine Zecker?A trickster dwarf, that is what he was! Many believed he was the greatest dwarven mage of all time, but rumors say that his magic was no magic at all.But the benefit of Engineering and Technology! Look at me babbling, Nel\'doriel surely awaits these notes.Oh well, do tell Nor’diel I’ll visit soon, maybe even help with his Golem!",
    ["O"] = "Return to Nel\'doriel in the Mystic Ward, with Thalestien\'s notes.",
    ["T"] = "Back to Nel\'doriel",
  },
  [40518] = {
    ["D"] = "My trip to Stormwind has been a failure, and truth be told, I don\'t really have the courage to return just yet.I was ambushed by a group of troggs heading to Ironforge, and I just so happened to drop the most important item on me, The Ramolus Gem.The Trogg that happened to take it was enfused with the latent arcane power of the gem, and now has some ability with magic... Or so I heard.<Ansela pouts.>Can you recover it for me by chance? The Trogg named Grash can be found deep in the Gol\'Bolar Quarry.",
    ["O"] = "Recover the Ramolus Gem for Ansela Dawnshield in Ironforge.",
    ["T"] = "The Ramolus Gem",
  },
  [40519] = {
    ["D"] = "<The trolls ghostly visage speaks in a broken, howling tone that is hard to understand fully.> I... be lost... Forever wandering across.. the desert to try.. and find a way out.But it doesn\'t feel like... there be a way out.Go to Zul\'Farrak... the place where my body is... and find the Ancient Troll Remains... of myself locked away...Free me mon, from this... eternal torture...",
    ["O"] = "Venture in Zul\'Farrak, and find the Ancient Troll Remains, return them to Hansu Go\'sha who wanders around the Southmoon Ruins in Tanaris.",
    ["T"] = "Drifting Across the Sand",
  },
  [40520] = {
    ["D"] = "Ever since we left Zul\'Farrak, hunger and thirst be constant companions for us. Da greedy goblins of Gadgetzan control da Wastes and dey do not see us any different than our Sandfury brethrens.Mon, our village needs ya help. We are starving here. I plead, venture into the desert and find some meat. Meat of da roc, while not tasty, is nutritious enough to keep ya alive. And while ya be out there, gather some hyena skins as well. Hingozu make ya armor for da effort.",
    ["O"] = "Bring 12 Roc Meat and 8 Hyeana Skins to Hingozu at Sandmoon Village in Tanaris.",
    ["T"] = "Da Unforgiving Lands",
  },
  [40521] = {
    ["D"] = "You. You can help me, us. The ogres of Dunemaul be driving us away from our ancient temples. I will not tolerate them defilin\' our sacred gods and their symbols.Their foul warlock and mages tarnish the idols of our gods. Venture sounth, where the Dunemaul reside and slay them. Retrieve three Loa Charms from and bring them to me. We shall unleash their wrath upon dem!",
    ["O"] = "Bring 3 Ancient Loa Charms to Seer Maz\'ek in Sandmoon Village.",
    ["T"] = "Desert Voodoo",
  },
  [40522] = {
    ["D"] = "Our tribe... Da SandfuryWe lost everything. Zul\'Farrak, once a shining jewel of this desert, be ruled by lunatics. Few of us, who be seeing the imminent fall, left the city and settled here. As ya see, there be only a handful. Not enough to stop da so called Chief Sandscalp and his minions.Da name of the Sandfury Trolls has to be redeemed first. Among people around us, dey need to see that we changed.We be in need of a diplomat, a representative. You be da one to fulfill da role. Show dem in Gadgetzan dat da Sandfury are not all crazed bloodrinkers.",
    ["O"] = "Find a person in Gadgetzan willing to help Sandmoon Village.",
    ["T"] = "Sandfury Redemption I",
  },
  [40523] = {
    ["D"] = "Tell your troll friends that I can - convince - the guards here to let them in for… let\'s say... five hundred gold.Each.Sorry fella, just can\'t risk the business!",
    ["O"] = "Deliver the message to Seer Maz\'ek at Sandmoon Village in Tanaris.",
    ["T"] = "Sandfury Redemption II",
  },
  [40524] = {
    ["D"] = "If dere is one who could see our struggle, it be Vol\'jin of da Darkspear. Like no otha he be understanding how is it to be outcast and lose da homeland.My kind be not welcome in Horde lands, but maybe ya be able to show our new ways.Travel to Orgrimmar, and speak to Vol\'jin. Tell him what be happening in Zul\'Farrak and offer our assistance.",
  ...
  [40526] = {
    ["D"] = "It pains me much, but my brethren be beyond saving. They do not see the corruption of our tribe. I tried everything. Dat why we had to run. They wont be listening. We got to stop dem.Outside of Zul\'Farrak proper, many Sandfury Trolls scour the desert, attacking trade caravans and assaulting water towers. I can\'t be risking their influence spreading further, mon.Thin their ranks.",
  ...
  [40527] = {
    ["D"] = "It has to be done. Ukorz Sandscalp and his foul right-hand man Ruuzlu have to be stopped.Venture into our ancient city of Zul\'Farrak. Kill Ukorz and Ruuzlu and come back to me.There will not be celebration, or a feast. This is just what needs to happen. In time, de lands of Zul\'Farrak will heal.",
  ...
  [40528] = {
    ["D"] = "Ya be the one who be pokin\' in our village! Ya better get yourself useful or else Ekka feed ya to da Viceclaw!Viceclaw be likin\' good, tough meat. Da turtles from da shore be his favorite. Ekka can\'t go dere, da goblins would shoot her to death! Bring Viceclaw da meat from dem, and as a reward he will spare you!<Ekka laughs maniacally>Good Viceclaw, good.",
    ["O"] = "Bring 10 chunks of Turtle Meat to Ekka at Sandmoon Village in Tanaris.",
    ["T"] = "Meat for Viceclaw!",
  },
  [40529] = {
    ["D"] = "Dear Farad,We made a mistake. You need to stop distributing the golems. Our plan will not work.I know you are still angry at me for what I did to you, it was an accident, I swear! But you have to listen, please. I cannot stop the golems from killing people. The spell does not work! Oh, how stupid I was.Please, Farad, stop this nonsense with the Stonemasons Guild and come back. We will figure out how to fix them together, like the old times. Please.I await you in our old workshop in Moonbrook. Where everything started. Our friendship, our plans, our failure.Your good friend, Maltimor Gartside.",
    ["O"] = "Confront Maltimor about the letter.",
    ["T"] = "Letter from Maltimor",
  },
  [40530] = {
    ["D"] = "I have been awaiting your arrival now for some time. I have heard tales your deeds from the very spirits themselves, and it is time to prove your worth as an Orc.It is time for your next challenge, and to prove your worth to the very spirits themselves. If you think you are worthy for such a task, seek out Margok Hatewind at Camp Mojache, he will be your guide.",
    ["O"] = "Travel to Camp Mojache and speak with Margok Hatewind.",
    ["T"] = "The Way Of The Spiritwolf I",
  },
  [40531] = {
    ["D"] = "You have begun to find potency within your use of the elements, though now comes a different matter entirely. Within Feralas is an Ancient Wolf Spirit, one of whom can bestow great power upon the orc shaman\'s capable enough to prove their worth.If you wish to prove yourself you must first gather a Pristine Wolf Tooth from the Longtooth wolves in the region. Be patient, it may be hard to come across. When you have found one, bring it to me, and you can continue on this journey.",
    ["O"] = "Hunt Wolves in Feralas to obtain a Pristine Wolf Tooth for Margok Hatewind.",
    ["T"] = "The Way Of The Spiritwolf II",
  },
  [40532] = {
    ["D"] = "It is said long ago, a large and magical wolf dominated these forests, and hunted with great power, only succumbing to a fatal wound near a large waterfall. It is here that you will take a powder I have grounded from the pristine tooth you brought me, to pour over this site. This ritual will be neccesary to gain the blessing of the Ancient Wolf Spirit.To the south east of Camp Mojache is a large waterfall, find a way up, and there you will find the Wolf Spirit, do as I have instructed, and it will be willing to speak with you.",
  ...
  [40549] = {
    ["D"] = "So, $N, the footprints were definitely quillboar hooves. I followed them well into the Barrens, thinking they would lead me to the Razorfen Kraul. I was wrong. The raiding party actually stopped just outside of it, which makes your job easier.Venturing into the Kraul... The mere thought makes me shudder.Back to the topic. The camp is north of the Kraul, close to the road. You should have no trouble finding it. Try to sneak in, or kill them all. Doesn\'t matter to me. What is important - find some evidence, maybe some items that could\'ve been taken from the inn.",
    ["O"] = "Investigate the quillboar camp north of Razorfen Kraul for any evidence.",
  ...
  [40551] = {
    ["D"] = "While I am busy translating this, you help me. Easy.I need something from Stranglethorn Vale. I know, it\'s far, but fortunately, we have a beautiful ship that will take you straight to Booty Bay! Wonderful, isn\'t it?I heard about some mining operations being done in the northern region, close to some lake or something. By no other than our competitor, Venture Company. I need you to go there and, ehm, borrow some stuff from them.Bring me 10 samples of ‘the thing\' they are excavating. I heard it\'s some blue crystals. I think you will be able to find them on their dead bodies. But you didn\'t hear that from me.",
    ["O"] = "Bring 10 Strange Blue Shards from the Venture Company in Stranglethorn Vale for Sputtervalve in Ratchet.",
    ["T"] = "A Strangle Favor",
  },
  [40552] = {
    ["D"] = "<Sputtervale focuses on the tablet.>Their writing is not exactly like ours. They just draw some pictures, and you have to interpret it on your own. There are some clues that help you with grasping the meaning but...You probably aren\'t interested in quillboar lore, yeah.So, what I get from this: a band of quillboars wants to attack an inn. They go there with a raiding party, but they find the inn already burned to the ground. Then some angry pictures. I guess they wanted violence.So, yeah. This is what I got from this, pal.",
    ["O"] = "Report back to Falgran on the border with Barrens.",
    ["T"] = "Back to Falgran",
  },
  [40553] = {
    ["D"] = "Go and report our findings to Captain Vimes. I will stay here for some time, to watch over the inn. I got some reports that the Horde is sniffing around.It can\'t mean anything good.",
    ["O"] = "Report back to Captain Garran Vimes in Theramore.",
    ["T"] = "Suspicious No More",
  },
  [40554] = {
    ["D"] = "I had a talk with one of our scouts. He is, well, responsible for spying on Camp Taurajo, deep in the barrens. And he is certain, and I believe him, that no Taurajo tauren ever wielded this shield.I tell you about this, because if it was really of Tauren craftsmanship, then the owner of the shield  must\'ve lived in the swamp for some time.I sent our infiltrators to check upon the Brackenwall Village, the horde outpost here for any sign of Taurens. While they are on their mission, I have a request. Gather intel from our watchtowers in the marsh. Maybe our soldiers remember something remarkable.",
    ["O"] = "Gather information from the nearby watchtowers and return to Captain Garran Vimes in Thermore.",
    ["T"] = "The Shield\'s Owner",
  },
  [40555] = {
    ["D"] = "These Grimtotem have been under our constant observation since they moved into Dustwallow. They are a nasty bunch, but I assure you, if it was them, we would already know. However, if this tauren the scouts spoke of really existed, we could ask about him in Brackenwall Village.In theory.Tensions with the Horde are high, and I don\'t want my men to see us negotiate with them. I had way too many deserters in recent months. You could try to find his grave. The tauren mummify their dead, but since he was the only one here, I doubt the ogres knew about it. Just search for a graveyard, or something like this close to Brackenwall. I doubt you will find anything, but it is the only lead we have.And let\'s hope Lieutenant Caldwell returns soon with some information about Reethe.",
    ["O"] = "Find the grave of a tauren warrior close to Brackenwall Village.",
    ["T"] = "The Search for the Grave",
  },
  [40556] = {
    ["D"] = "Who dug up the grave? Why? Did they take the shield from it?More questions, still no answers. You should report back to Captain Garran Vimes.",
    ["O"] = "Go back to Captain Garran Vimes at Theramore Keep with your findings.",
    ["T"] = "Another Mystery to Solve",
  },
  [40557] = {
    ["D"] = "Lieutenant Caldwell still hasn\'t returned from his mission to find Paval Reethe. I fear the worst. But, alas, we can only wait.When it comes to our investigation. Well, another dead end.However, Falgran reported that the horde has been sniffing around the inn. Please, assist him with this matter. He is where you met him before.",
    ["O"] = "Meet with Falgran Hastil on the road between Shady Rest Inn and the Lost Point in Dustwallow Marsh.",
    ["T"] = "The Troubles Ahead",
  },
  [40558] = {
    ["D"] = "Already we have established contact with the Horde Diplomat named Kagoro.$N Please do remain calm, and try not to provoke them. I know it may be difficult, given our history, but they are much like you and me.Just perhaps a bit more green",
  ...
  [40559] = {
    ["D"] = "So the shield really belonged to the tauren from Brackenwall. Good work.On the other hand, the reported killing of Paval Reethe by our soldiers is troubling. Deeply troubling. I cannot just trust the Horde on this. My role, as a captain, is not only to order, but also to serve.I\'m worried that Lieutenant Caldwell only acted in his self defence. But, if the orc was really speaking the truth, you may find some evidence in Caldwell\'s belongings. You can find his quarters downstairs. He was sent there with a soldier named Hallan, check hers too.I will prepare the report for lady Jaina.",
    ["O"] = "Check the belongings of Caldwell and Hallan downstairs, then report to Captain Vimes.",
    ["T"] = "The Betrayal from Within",
  },
  [40560] = {
    ["D"] = "So it is true. My soldiers, whomst I thought as most loyal, were actually deserters. I wonder how many more hide in our midst.But for now, let\'s gather the information. Caldwell and Hallan were deserters. They killed Paval Reethe, when he was questioned by the Horde. Did they do it just to spite the Horde, or... He knew something...Once again, our findings lead us to the deserters in the swamp. Well, I doubt that we could make them talk. They hate us, maybe even more than they hate the Horde. Any mindless attack on their abode will not provide us with answers.We need to turn to magic. Forbidden magic. If we had something that belonged to Paval Reethe, we could commune with his spirit. It is a dangerous practice, many would even consider it unethical.The ends justify the means. And fortunately, we have his badge. Since he passed recently with unfinished business, his spirit may still be in Azeroth.Go to the Mage Tower here and explain the situation to Magus Halister.",
    ["O"] = "Speak with Magus Halister at the tower of Theramore Isle in Dustwallow Marsh.",
    ["T"] = "The Betrayal from Within",
  },
  [40561] = {
    ["D"] = "Very well. If it is Captain Vimes wish... who am I to say no. But, if we are to make the ritual as safe as possible to the spirit, and to us, I will need some rare ingredients. Your best bet would be buying them in Dalaran, if, well, it still existed.I have heard rumors that Kirin Tor is trying to rebuild the magical city, so if you don\'t mind traveling... Maybe they have some ingredients needed. The rest can be found in these swamps, if you have a keen eye.I need 1 Arcane Resonator from Dalaran, 3 Moonstones and 10 Swamp Ooze Ichors. I heard reports of ooze abominations in the south.",
  ...
  [40562] = {
    ["D"] = "I shall need your help during the ritual. Perhaps we may learn more from the spirit realm.Let\'s begin.",
  ...
  [40563] = {
    ["D"] = "Go to Falgran and Kagoro, explain the situation to them, and..Apologize for us blaming them. We need to make this right, and show our good will.Perhaps they will forgive us.",
    ["O"] = "Report back to Falgran Hastil on the road between Shady Rest Inn and the Lost Point.",
    ["T"] = "To Meet Again",
  },
  [40564] = {
    ["D"] = "Here we are again, for another meeting with the Horde.Kagoro has explained some things to me, but we are ready for our meeting.",
  ...
  [40565] = {
    ["D"] = "It does appear that the Deserter\'s are behind the burning of the inn. If there is ever to be justice, we must stop them from continually dragging more and more of our most loyal into their ranks.There shall be no quarter, they are wanted and we shall dole out justice, for all of the lives lost. For the deceit caused.Directly to the west of Theramore, to the north eastern edge of the Quagmire is the Deserter\'s Hideout, it is there that they gain their strength. Find Sellick Voss, the new leader of the camp, slay him, and bring his medallion to me as proof of the deed.",
  ...
  [40566] = {
    ["D"] = "Excuse me, $c!<The lady seems to force a smile, but her eyes betray a deep fury.>You look the gallant sort, the sort to help a poor damsel, yes? I find myself in need of some rather... odd substances. They may even be dangerous to acquire, but looking at you – I think you can certainly handle it. I will even pay some decent coin for your troubles!I need some poison. But not just any poison. There are spiders in a cave somewhere East of here, that have a very painful bite, even causing brief paralysis. If you could collect for me a few vials of their venom, I would be eternally grateful! Surely you aren\'t afraid of a few little arachnids, no?And what do you mean, why? Are you truly asking a lady her personal business?",
    ["O"] = "Acquire five Leech Stalker Venom samples for Rose Dolohov.",
    ["T"] = "Sleep Paralysis",
  },
  [40567] = {
    ["D"] = "Oh, I can\'t do this.<She sighs loudly and massages her eyes.>My fiancé is dog-tired all the time, disappears randomly during the night, and recently I found long black hair on his clothes.I just can\'t figure out how he could do this to me! But I must be certain. Please, $C, can you go look into this for me? Before I do anything rash. I can\'t even bear to speak to him, never mind go back to our old bedroom. Just find out his damned side of things, and tell me what lies he speaks. Any extra evidence you can find would be good too, I suppose.<She screws her face up tightly.> He\'s probably avoiding me and pretending to be useful, chopping wood by the lumber mill. Bert Mano is his name.",
    ["O"] = "Speak to Bert Mano in Hawk\'s Vigil, and see where your investigation leads.",
    ["T"] = "Sleepwalking at Day",
  },
  [40568] = {
    ["D"] = "Okay, okay, I know it looks bad. But Bert has been suffering with sleep paralysis of a very interesting kind, you see. The poor soul has something, and I have my suspicions what, reaching out to him during his dreams. I was skeptical too, until I witnessed it myself while observing him slumber.I am sure it is a demon! The peasants have countless stories of this sort of thing, but it\'s the first time I\'ve gotten irrefutable evidence of it happening! Regardless, my studies must be put on hold, if his marriage and, if you are correct, his life may be in danger.This demon must be either expelled or brought into the physical plane, then killed. Unfortunately, I have very little idea how to do so directly.  But I know who does. I made contact with a shady fellow in Stormwind. He conducts his business from a cabal hidden away in the basement of a tavern there. I do not know which one unfortunately. His name is Gakin the Darkbinder.Please, hurry, $C. Bert isn\'t a perfect man, but he doesn\'t deserve this.",
    ["O"] = "Find Gakin the Darkbinder in the basement of a tavern at Stormwind City.",
    ["T"] = "Daydreaming at Night",
  },
  [40569] = {
    ["D"] = "Okay, $R  your first task for me.What, you thought I would do this for free? No, no no! Oh by fel no. In any normal circumstance I would have you killed for stumbling down here, but it just so happens, I need some materials myself, and some of these will also be required to solve your. Predicament.A connection to the void will be required, plus some sort of tonic that elicits lucid dreaming to bring forth this night-demon of yours, and banish it. My colleagues have whispered about a certain location that may just do the trick!<He smirks wickedly.>  Fire Scar Shrine. Name ring a bell? I doubt it. You can find it in Ashenvale, south west of Astranaar. There are foul beasts dwelling there, dog-like, ravenous and demonic. I need you to go there, kill them, and bring me their hearts. I will need one for you, but I never, ever work for free. Make it ten.",
  ...
  [40571] = {
    ["D"] = "This is it. If you have any friends who can work discreetly, I suggest you contact them now.The energy will be strongest either around Bert himself or where he sleeps. Hold out the pendant and see if it reacts. Hopefully, this will give you the opportunity to confront this demon and put an end to the torment.You should probably take some evidence of its existence once you kill it, too, you know. So he can prove his situation and resolve the troubles with his fiance.",
    ["O"] = "Find a way to summon the demon, slay it, and take its head to Bert Mano.",
    ["T"] = "Strange Bedfellows",
  },
  [40572] = {
    ["D"] = "Kagoro had just left to investigate the hoofprints. He should be scouting the road to the Southern Barrens. A scout like no other, that orc, for many days has he tried to be worthy of a surname. His actions will one day speak, and when that day comes he will earn his honor. I hold high respect for Kagoro, $R, but I believe he will be in need of your help if you were willing to offer it.",
    ["O"] = "Find Kagoro on the road to the Barrens in Dustwallow Marsh.",
    ["T"] = "Aid Kagoro",
  },
  [40573] = {
    ["D"] = "Krog\'s suspicions were founded, he was right to believe the quilboar may have had something to do with the burning of the inn.Before you arrived, so did I. I followed a track, or should I say smell towards a pack of quilboar, they donned the colour of war and were headed towards the Razorfen Kraul, their main den.Luckily for us, they have stopped in their trails close to it, conveniently near the road.Your task will be to extract information from them, if any. Although I highly trust my tracking skills, I find my brute force lacking. Judge me if you must, but see the deed done.",
  ...
  [40574] = {
    ["D"] = "I\'m afraid I can\'t make anything out of these symbols, we must find someone who knows this type of speech and who would be willing to aid us.<Kagoro ponders for a moment.>I hear the Tauren of Camp Taurajo recently captured a quilboar, perhaps he\'s willing to hold a conversation. Nothing to lose after all, he\'s a prisoner, force him if he\'s not willing.",
    ["O"] = "Speak with the Quilboar Mangletooth in Camp Taurajo for more information.",
    ["T"] = "Someone With A Pig\'s Tongue",
  },
  [40575] = {
    ["D"] = "You need Mangletooth to translate you a <snort.> tablet?Mangletooth will do so for a special treat!<snort.>Mangletooth craves for basilisk eyes, down in Thousand Needles you will find <snort.> Saltstone Basilisks, at Shimmering Flats!Bring about <snort.> 20 of them and Mangletooth translates, favor for a <snort.> favor!",
    ["O"] = "Brink 20 Saltstone Eyes from basilisks in the Shimmering Flat to Mangletooth.",
    ["T"] = "Willing to Serve",
  },
  [40576] = {
    ["D"] = "<Snorts happily.>A feast! A feast for Mangletooth! Now about that <snort.> tablet. It was meant to <snort.> reach the leader of the Kraul as report that the quilboar did indeed <snort.> wish to attack the inn but when they reached it, it was already <snort.> burnt!Not sure which <snort.> inn they are talking about <snort.>, but seems like you do.Mangletooth happy to <snort.> help, the Tauren are really nice to Mangletooth.Even this cage is <snort.> now open, but I choose to <snort.> stay.",
    ["O"] = "Report back to Kagoro.",
    ["T"] = "A Glutton\'s Honesty",
  },
  [40577] = {
    ["D"] = "I\'ll keep looking around the ruins, meanwhile you should go back to Krog, and inform him of our findings.There\'s simply nothing more we can do here $N. As little as it may mean, you have my appreciation for the help, Lok\'tar.",
    ["O"] = "Bring news to Krog at Brackenwall Village in Dustwallow Marsh.",
    ["T"] = "Behind the Hoofprints",
  },
  [40578] = {
    ["D"] = "No matter how many times I may look at it, $R, I simply can\'t recall to whom I\'ve sold or for whom I\'ve forged this.The sole thing I can say is it was meant for a Tauren to bear. The size, the grip, it feels natural in the hands of a Tauren. You have my sincere apologies but this is all I can offer.Tell Krog to take good care of his armor, farewell.",
    ["O"] = "Tell Krog of your findings in Dustwallow Marsh.",
    ["T"] = "Dragging It Back To Brackenwall",
  },
  [40579] = {
    ["D"] = "I remember Do\'gol speaking of a friend of his, a Tauren to be more precise. He said the Tauren befriended the ogres during the siege of Theramore, quite always mentioning how much of an unstoppable shield he was.I wonder, Do\'gol, as many ogres, may be a bit slow, if we were to jog up his memory about this Tauren perhaps we can find out if the Tauren itself was the shield or that he carried a shield.I have this feeling $N.",
    ["O"] = "Ask Do\'gol in Brackenwall Village about the Tauren.",
    ["T"] = "Memory of An Ogre",
  },
  [40580] = {
    ["D"] = "Tauren friend? What Tauren friend.Found anything about shield yet? Wait.<Do\'gol is trying very hard to think for a second.>Tauren, shield, large shield. Wattapo!Yes, yes. Tauren friend name was Wattapo, we call him the Wall. Great warrior with big shield! He died, his shield buried with him. Grave next to the rest, you can find him there.",
    ["O"] = "Find Wattapo\'s Grave near Brackenwall Village in Dustwallow Marsh.",
    ["T"] = "Mighty Wattapo, the Wall",
  },
  [40581] = {
    ["D"] = "You\'re saying this Tauren was supposed to be buried with his shield and there was no actual shield? I knew I had a weird feeling about this. This could only mean one thing and one thing only, someone came to rob our graveyard, for something that would incriminate the Horde if placed in the burned inn.But who, and why? Give me a second to go through all of this.",
    ["O"] = "Reassure Krog at Brackenwall Village by giving him a pat on the shoulder.",
    ["T"] = "Mysterious Shield No More",
  },
  [40582] = {
    ["D"] = "I\'m more than certain this was meant to brew turmoil between us and Theramore, however I am not sure why. While you were out trying to figure out the shield part of the mystery, Kagoro has kept company with a scout from Theramore.I\'ll send you to meet with them, so Kagoro can share what information we gathered. For all that we know we\'re all simply trying to get to the bottom of this, without any more bloodshed between the factions.If they sniffed around the inn, they probably know what killed their soldiers in self defence, when we were questioning Reethe. Or at the least, they are wondering what happened to them. We need to explain the situation, it is important.<Krog Grunts.Ah, one more thing. Our goblin allies at Mudsprocket have sent me a message, they believe that the Black Dragonflight could have something to do with the burning of the inn. It makes sense, to be fair, we will check this later.",
  ...
  [40584] = {
    ["D"] = "Such leaves do not grow on plants $c , but on Dryads. Dryads are the children of Cenarius, the one who is said to have originally taught us the way of druidism.They are kind, gentle, and nurturing under normal circumstances but will become fierce and deadly if their forests or the wild are in danger. Why would a Dryad be here? This is a fresh specimen that was removed from the Dryad very recently so she cannot have gone far.Please scout the area where you found this leaf and do your best to locate this Dryad.",
  ...
  [40588] = {
    ["D"] = "Thank you so much $N! I should properly explain why I came. A long time ago, my great grandfather taught the Tauren people the ways of Druidism. These teachings have since been lost but have recently been rediscovered.My Grandfather Remulos even helped the Tauren rejoin the Cenarion Circle. In spite of that though, many Tauren know very little about my people, and we in turn know little of them.I\'ve come here to live in Mulgore so we can learn about each other. Kaylee is my friend and a druid student. I will help her recover then join you, please return to whoever sent you and inform them that we\'re coming!",
    ["O"] = "Return to Gennia Runetotem at Bloodhoof Village in Mulgore.",
    ["T"] = "The Story of a Dryad",
  },
  [40589] = {
    ["D"] = "We sent out a crew weeks ago to begin doing some studies over the ruins down south and they haven\'t showed up yet, not even a peep.The desert is a dangerous place so now rumor is going around they may have met some terrible fate. It is possible I suppose!What is really important is what we sent out with them, you see, when we trust someone, we usually give them some valueable gear, something worth a lot of coin, you dig?I need you to go out there and find that crew, or more importantly, get the Turbo-Scan Filtronomitor from whatever is left!They should have been down near Southmoon Ruins, check around there.",
  ...
  [40590] = {
    ["D"] = "The desert, such a unique place, I\'ve heard rumors of people perishing from the harsh and brutal sands, the extreme heat, and the lack of water. It kind of reminds me of where I come from aye?In such a place only the most brutal creatures can survive, one of which has spent its entire life within the sun.The Glasshide Gazer has a distinctive golden scale that my benefactor wants to get ahold of.You can find them down in the south roaming the vast desert, collect me twelve of these scales and I will make sure you get paid well.",
    ["O"] = "Collect 12 Golden Glasshide Scales for Gelweg Darkbrow at Steamwheedle Port in Tanaris.",
    ["T"] = "Golden Glasshide Scales",
  },
  [40591] = {
    ["D"] = "Hey, look I appreciate all you did for me with those scales, my higher ups at Shadowfor - Err, back out in the Eastern Kingdoms are going to be very pleased, and that pleases me!But I just have one more favor to ask for you.Down to south you\'ll find a place called Southbreak Shore, it might be tricky, just a bit southeast of the Caverns of Time.All along that coast are large Coast Striders, massive giants that roam the coast and call it home. Well you see, I need an eyeball from one of them, and I really don\'t think they\'ll give it to you, infact they probably will hate you for being there!So, you go and gather a friend or two, get me an eyeball, and we finish our dealings, aye?",
    ["O"] = "Gather a Sea Giant Eyeball for Gelwig Darkbrow at Steamwheedle Port in Tanaris.",
    ["T"] = "Favor for Gelweg",
  },
  [40592] = {
    ["D"] = "This desert holds many secrets and magical properties, much of which is buried deep within the sand. Leaking emanations have begun to stir up the ground into swirling elementals of sand and wind!At least, that is what I am here to look into anyway!To get concrete proof I\'d like you to find one of the many Gusting Vortex\'s that roam all across Tanaris, kill them, and collect a single collection of Harmonized Sand.I warn you, Harmonized Sand is rare, and valueable, many brave travelers have died in search of it.Not all of the Gusting Vortex elementals will be within a harmonized state, so don\'t give up, and keep looking until you find it!",
    ["O"] = "Slay Gusting Vortex, and find a single Harmonized Sand for Ginlo Taxxo at Steamwheedle Port in Tanaris.",
    ["T"] = "Gusting Vortex\'s",
  },
  [40593] = {
    ["D"] = "Upon opening the chest you discover several old, and worn out items, various church tomes and writings with a small out of place letter resting at the top, it looks aged, and written in a shrewn handwritting which reads :<Carver, we have done as you asked and have forced the old man out, David was a bit rough and injured him. We made sure to -really- send a message, and he won\'t be coming back. We even got the key and locked the doors tight if anyone came back, they will soon understand it is their time to leave as well.>You should bring this information to a higher authority.",
    ["O"] = "Bring the Abandoned Letter to Gryan Stoutmantle at Sentinel Hill in Westfall.",
    ["T"] = "The Old Church of Westfall",
  },
  [40594] = {
    ["D"] = "You found this at the Westfall Church?It has been a long time since I have heard anything about that place, another abandoned relic of a potentially bright past. It is a shame what happened there, but it is a story that is much like the rest of the region.The western side of Westfall was the first to be removed, and there are not many who remain who can give us information, many of those farmers were either murdered, or disappeared into secrecy.There is someone that I can think of, Baros Alexston, he made something of himself after everything went down, and became an Architect in Stormwind City, you can find him in Cathedral Square if you don\'t mind looking into this matter, maybe he can give us some details about who ran the church, or even what happened to it.",
    ["O"] = "Speak with Baros Alexston in Stormwind.",
    ["T"] = "The Old Church of Westfall II",
  },
  [40595] = {
    ["D"] = "Oh, so you speak of that old church, out in Westfall? It has been a long time since I have been there, an incredibly long time. I must say that I do not believe I will be much of a help. Most of what I can remember is the sun beating down on me as I walked there and back.<Baros Alexston lets out a small laugh at the memory.>The one who ran it was an old fellow though, always was quite nice, and cheerful. He raised many spirits of the downtrodden farmers back then and helped out where he could.Such a shame that such a thing could happen to an honorable man. If you\'re looking for information, your best bet would probably be the Cathedral here in the city, find Bishop Farthing, he might have an idea.",
    ["O"] = "Speak with Bishop Farthing at the Cathedral of Light in Stormwind.",
    ["T"] = "The Old Church of Westfall III",
  },
  [40596] = {
    ["D"] = "A priest from Westfall huh? Well that is certainly familiar, there was only one church there, and I recall him having had all sorts of trouble, from brigands to thugs who threatened to end his life. The light can be testing at times, but no one should go through something like that.He spent some time here in the Cathedral of Light before he moved on to Northshire Abbey, he helps out around there from time to time, he goes by the name Brother Neals.",
    ["O"] = "Speak with Brother Neals at the Northshire Abbey in Elwynn Forest.",
    ["T"] = "The Old Church of Westfall IV",
  },
  [40597] = {
    ["D"] = "So, you\'re here about the Old Church in Westfall huh? Well its been a while since anyone has asked about such a thing, the Cathedral inquired what happened, but nothing ended up coming of it.The crooks got away with what they did, and so I decided I would just retire to some peaceful corner, only to hear that they are now here in Northshire as well.<Brother Neals lets out a soft sigh.>I\'ll go over what happened when you\'re ready, it might be a bit.",
    ["O"] = "Listen to Brother Neals recounting of his time in Westfall.",
    ["T"] = "The Old Church of Westfall V",
  },
  [40598] = {
    ["D"] = "Now that you\'ve heard my story you can understand what has happened. If anyone is responsible for shutting down the church and the murder of the Easton Family, my suspicions lay toward Carver Molsen. He inherited that farmstead and was always greedy for more, even going so far as to join the Defias.Hopefully my information is relevant for you, perhaps you can bring it to Gryan Stoutmantle, he is in charge of the People\'s Militia there.",
    ["O"] = "Bring your findings to Gryan Stoutmantle at Sentinel Hill in Westfall.",
    ["T"] = "The Old Church of Westfall VI",
  },
  [40599] = {
    ["D"] = "Carver Molsen.This is a familiar name, he leads various gangs and crews of thugs in the region. If the rumors and word from Brother Neals is correct, then he is no doubt in possession of the missing deeds for both the Molsen and Easton plots.There is an insider within Stormwind named Larry Ryder, he has given us some information on the Defias, perhaps he knows information on how to find this \'Carver Molsen\'.You can find him in Stormwind, usually skulking about the Pig and Whistle in Old Town.",
    ["O"] = "Find Larry Ryder, usually found at the Pig and Whistle in Stormwind.",
    ["T"] = "The Old Church of Westfall VII",
  },
  [40600] = {
    ["D"] = "Oh, I know who you\'re looking for, rowdy type, wants more than he has.You know what I\'m talking about.If you want information then I\'m going to need help, you do a favor for me, I do a favor for you, understood? I have a few contacts that are looking for a somewhat rare poison that comes from Greater Tarantula Venom. You can find it from those Greater Tarantulas out in Redridge Mountains.Go there, get me seven, and come back, easy right? So don\'t take that long, I don\'t like waiting.",
    ["O"] = "Bring 7 Greater Taratula Venom to Larry Ryder in the Pig and Whistle in Stormwind.",
    ["T"] = "The Old Church of Westfall VIII",
  },
  [40601] = {
    ["D"] = "So, who was this about, Marven Horsen? Larsen Wormen?<Larry lets a crass smirk rest on his face.>Carver Molsen, he certainly is a character, hangs around that old farmstead, goes by the name \'The Dead Arce\' these days, used to be called the Easton Fields.You got what you needed, now go on, and tell who you need to.",
    ["O"] = "Bring the location of Carver Molsen to Gryan Stoutmantle at Sentinel Hill in Westfall.",
    ["T"] = "The Old Church of Westfall IX",
  },
  [40602] = {
    ["D"] = "It is time for justice to be dealt. For the murder of the Easton family, and the disruption of peace in Westfall, Carver Molsen shall not be spared any mercy in these lands.Bring some good news to the remaining people of Westfall, and travel to the Dead Acre, just to the south east. Kill him, and recover the Deed of Easton Fields , the Deed of Molsen Farm, and the Westfall Church Key.With him gone, there may yet be hope for a future in these lands.",
    ["O"] = "Travel to the Dead Arce, and kill Carver Molsen, recover the Deed to Easton Fields, the Deed to Molsen Farm and the Westfall Church for Gryan Stoutmantle at Sentinel Hill in Westfall.",
    ["T"] = "The Old Church of Westfall X",
  },
  [40603] = {
    ["D"] = "There is one last thing I ask of you in regards to the matter of the Old Westfall Church. Brother Neals is responsible for much of the information we have discovered, I have prepared a letter to be sent to him.I have also included the Westfall Church Key, when this land is restored to order, I would think of one no better to return it to working order.Head to Northshire Abbey, and bring it to him with my letter.",
  ...
  [40605] = {
    ["D"] = "The Redbrand Digsite was a location of both mining and archelogy, many of their records and achievements are recorded in a book named the Redbrand Archive.I was primarily sent here to recover that book, and return it to Torwyn Redbrand back in Ironforge. If you could do me a favor, and gather that for me, it would mean a lot while I remain and clean up this mess. It should be located within the main building of the digsite, gather it, and bring it to Torwyn, you can find him at the Mystic Ward near the Redbrand Estate.",
    ["O"] = "Gather the Redbrand Archive and return it to Torwyn Redbrand in Ironforge.",
    ["T"] = "The Redbrand Archive",
  },
  [40606] = {
    ["D"] = "You again?! I\'ll forgive your bar tab if you do me a favor. What do you mean, you don\'t have an open tab?I suppose I might be mistaken, all of you $c types look the same to me.Look, the Witherbarks have developed a secret ritual that produces alchemical products with powerful properties, or so the tale goes. I\'ve got to get ahold of it - these are vital secrets that could change the whole situation around here! Nobody around here seems to know any details, but perhaps the Elves down by their waterfall have an idea - ask for Lieren\'s sister, she\'s usually clever about these sorts of things. Oh, and don\'t mention this, but would you mind getting this taken care of before the holiday party?",
    ["O"] = "Ask Loania at the Quel\'Danil Lodge in the Hinterlands for further directions.",
    ["T"] = "Lost Secrets of the Witherbark",
  },
  [40607] = {
    ["D"] = "The Witherbark are descended from our oldest enemies, the Amani Empire, but have since lost even the veneer of civilization. I don\'t even want hazard what sort of dark practices happen when they cook their ritual secrets in those boiling cauldrons of theirs, but supposedly those concoctions are careful and deliberate. A quaff of their brew serves as anesthetic for their cruel and barbaric rituals; the victim is rendered indistinguishable from a blind drunk for hours, and remembers little afterwards. If you want a copy of this dark formula, you\'ll have to snatch them from the Witherbark Callers of Shadra\'Alor.Do be careful, will you? You don\'t seem the type to drink poison deliberately.",
    ["O"] = "Bring a Witherbark Tablet back to Truk Wildbeard at Aerie Peak in the Hinterlands.",
    ["T"] = "Ritual Secrets of the Witherbark",
  },
  [40608] = {
    ["D"] = "Weeks it took to fertilize, and toil that ground, and make useable soil, all ruined by a flock of buzzards that swooped down, and ravaged the place for some fresh feed.Bah, dang dumb buzzards!There may still be some of the crop harvest left, lucky for us I had just finished bundling it all before those bastards came down and sent me running. Head down the hill toward the farm, kill some to make the rest think twice about freeloading there too long, and gather up 4 bundles of crop harvest, would ye?",
    ["O"] = "Travel to the farm at Bael Hardul beneath the town, slay 7 Plateau Fleshrippers, and gather 4 Bundled Crop Harvest for Segwar Ironback in Stonetalon Mountains.",
    ["T"] = "Salvaging the Crops",
  },
  [40609] = {
    ["D"] = "Hah! Who is this puny $r? You dare speak to Warug?I spit on your words! You come back after you show strength and allegiance. Kill Gelkis until you are soaked with their blood. Only then will you speak to Warug.",
  ...
  [40610] = {
    ["D"] = "You want me to sing your name to the tribe? Then excite me. Fight against the scariest creatures of Mashan\'she.Best fights are with multiple enemies! To the death! Seek the Bonepaw of the north. They hunt in packs. They rip apart their foes. They pull organs out of bellies and fight over your scraps when you fall.<She swishes her tail and paces with her hooves in excitement while  thinking about it.>",
    ["O"] = "Slay 8 Starving Bonepaws to prove yourself to Jochi at Magram Village in Desolace.",
    ["T"] = "Fighting the Pack",
  },
  [40611] = {
    ["D"] = "There is something else that excites me. Fighting when the enemy is so much larger than you! Hah! The satisfaction when they fall!If you do as I ask, then seek the giant lizards to the north. You can see some from Magram Village even! They will leave you a charred corpse trampled underfoot.",
  ...
  [40613] = {
    ["D"] = "There was a time when we would do anything for power. Shamans, dark arts, rituals and sacrifices. But when we rejected the protections of Theradras, we also rejected many weak magics!<She growls deeply.>We are Magram! We are strong! We do not need tricks, we do not need mothering! We smash what we can smash and burn what we cannot. See the burning forests north! Puny elven lands are proof!We cast out those who would not drop dark arts. But they threaten us with risen dead thanks to our foolish mercy at not killing our own. Find our outcast sisters nearby. Show them no mercy, for we never should have to them.",
    ["O"] = "Slay 4 Outcast Necromancers for Jochi at Magram Village in Desolace.",
    ["T"] = "The Forbidden Arts",
  },
  [40614] = {
    ["D"] = "$N, it is good you are here this day. Come, sit, listen.When we returned from the northern mountain forests, we were glorious, high spirits, sharing stories of our kills! But many of us did not make it back to village. Something vengeful sought us out...We named the beast Almaudrak. He is a bringer of death. He circles the dark skies still. Rarely do I tell anyone of Almaudrak. Many think he is legend. Whoever seeks him out is never seen again. But I know his lair. It is far to the north, near the path to the mountain forests, near ruined elven tower.If you wish to be a true name among us. Find and kill Almaudrak.",
    ["O"] = "Find Almaudrak, slay him and return his heart to Jochi at Magram Village in Desolace.",
    ["T"] = "Almaudrak",
  },
  [40615] = {
    ["D"] = "There is but one more thing in these lands I dare not tell of the tribes, $N.Magram would never claim to be scared of anything! We are strong! We are the rightful conquerors of Mashan\'she! But... even we do not war with demons to the west. Foul magic, fire, death and decay.<She tenses her hands into fists for a long moment.>There is something I have seen there. Giant, green fire, pure anger and destruction. I do not believe anything could bring it down. I respect you already, $N, and you are liked among us. If you wish to become legend... find and kill Baelfyr.",
    ["O"] = "Find Baelfyr in Mannoroc Coven, kill it and bring evidence to Jochi at Magram Village in Desolace.",
    ["T"] = "Fear Incarnate",
  },
  [40616] = {
    ["D"] = "You are a hero among our tribe. When we crush our enemies underhoof, you will be at our side, yes?<She lets out another loud war cry, and for a moment, something approaching a smile appears on her savage face.>Go! Speak to true Khan! He has heard of your victories. It is time to join us, $N.",
    ["O"] = "Speak to Khan Jera and follow his instructions.",
    ["T"] = "One of Us",
  },
  [40617] = {
    ["D"] = "The Maraudine are the strongest in the region, and could pose a more significant threat if their leadership ever had the desire to spread influence.They hold our most sacred site, Maraudon as home, for this alone, they should be wiped off the map.If you truly wish to become an ally of the Magram, then you will need to prove yourself. Gather ten Maraudine Bracers, and bring them to me as proof of your loyalty.",
  ...
  [40618] = {
    ["D"] = "Desolace is filled with the weak, those that should be culled so the strong can rise to dominate. I speak of the lesser tribes that hide in our mighty shadow, those that tremble in fear of our wrath.The lesser tribes of the Gelkis and Kolkar need to be raided, and reminded of their place, and you will enact our fury.Travel to the Kolkar Village to the north, cut down their battle lords. To the west, head to Gelkis Village, slaughter their stampers, earthcallers, and windchasers.Make sure they learn their place in the natural order.",
  ...
  [40619] = {
    ["D"] = "If anything has been learned from our state of warfare it is that food is more important then even the most deadliest of weapons. Without energy, one cannot fight, and it is from this constant need for food in such a desolate landscape that we have been held back from our true aims.I desire you to remedy this situation.Across Desolace you can find the mighty kodo, their meat is thick, and heavy. It makes for the perfect meal of a warrior.Ride out, and collect seven Heavy Kodo Meat for the Magram.",
    ["O"] = "Collect 7 Heavy Kodo Meat for Warcaller Dekshar at Magram Village in Desolace.",
    ["T"] = "The War for Food",
  },
  [40620] = {
    ["D"] = "You are not Gelkis. You are not even centaur at all. Leave now!We have no reason to speak. Little will prove your friendship or worth to me. Except perhaps the conquering of the Magram, hah!I am wise enough to know you would never wage war on our behalf, and you are not even strong enough to do so anyway.",
    ["O"] = "Slay Magram Tribe centaur to prove yourself to Uthek the Wise at Gelkis Village in Desolace.",
    ["T"] = "Picking a Side",
  },
  [40621] = {
    ["D"] = "Perhaps there is more to you than meets the eye, $r. You have shown yourself willing to be an enemy of the Magram, but that does not make you a friend of the Gelkis.But, you may be in time. That is not for me to decide. In the tents nearby, seek out the oldest among us. He has even more stories to his name than I do. His name is Yesu\'gei.",
    ["O"] = "Find and speak with Yesu\'gei.",
    ["T"] = "Meeting an Elder Centaur",
  },
  [40622] = {
    ["D"] = "You may think that a death is simply a death, $r. But that would be a foolish thought, a foolish thought indeed. To die in glorious combat, received back into the earth, this is a good death.Hmm, I remember friends, good Gelkis, falling down as they trotted, poisoned by stings from Scoropashi. I have seen those laid to rest, picked apart by giant carrion birds. This is disgraceful, and I will not have it happen to any more of my tribe.Prove yourself useful. Go out and kill as many of these creatures to the north as you can find.",
    ["O"] = "Slay 8 Scorpashi Snappers and 8 Dread Swoops for Yesu\'gei at Gelkis Village in Desolace.",
    ["T"] = "Sympathy for the Dead",
  },
  [40623] = {
    ["D"] = "It is a mistake to ignore nature. We, Gelkis, can learn a lot from a troubling breeze, a red sky, a lightning air.Hmm. Recently the land has been scoured, even the rocks themselves, by roving air elementals. I cannot tell why they are so agitated! Ignoring their presence is a danger to us, and also ignoring omens of things to come.Disperse any that you see, $r, and bring me their cores. We may give these to our shamans, and we may learn from them. We will bolster our magic directly with the elements!",
    ["O"] = "Slay the wayward elementals and bring 8 Airy Cores to Yesu\'gei at Gelkis Village in Desolace.",
    ["T"] = "Troubling Winds",
  },
  [40624] = {
    ["D"] = "You have done well so far, but there are bigger predators yet that must be felled. To the north there are the remains of mighty kodo. Majestic creatures, and in death they nourish the earth with their bodies. However, they have made the carrion birds greedy, and they attack weakened centaur too.Go. Kill the venomous creatures you find, and any carrion birds that may threaten Gelkis Village. You will earn my respect if you do this.",
    ["O"] = "Slay 8 Scorpashi Lashers and 8 Dread Flyers for Yesu\'gei at Gelkis Village in Desolace.",
    ["T"] = "Protecting the Weak",
  },
  [40625] = {
    ["D"] = "Hmm. One day you may walk among us as an esteemed visitor, $r. You should be thankful some already respect your actions.When we think you have helped us enough, I will speak to you further. There are some matters that I will not discuss with an outsider, nor with many in the tribe proper.<He seems to find it difficult to stop talking, mumbling quietly to himself for a long time after.>",
  ...
  [40629] = {
    ["D"] = "I may be respected for my age, $N, but I cannot offer the proper thanks you deserve. Khan Shaka, our leader, wishes to meet with you directly now. He never meets with outsiders so this must be important.He is communing with the earthen spirits within the cave at the centre of our village. Do not delay. And, $N? I am glad you came and listened to this old centaur.<He retires to his tent with a loud sigh, old bones creaking the entire way.>",
    ["O"] = "Speak to Khan Shaka deep within the cave of Bolgan\'s Hole, and follow his instructions.",
    ["T"] = "An Honorary Gelkis",
  },
  [40630] = {
    ["D"] = "There was a time when the Maraudine were picked from the most loyal of the tribes, gathered to honor and protect our ancestors at a place of great worship.Such times are gone, lost to the drifting winds, spat upon, and dishonored.The Maraudine are now just a glorified tribe who have claimed the Valley of Spears as their own, they do not respect Maraudon as a holy place as it once was. We are not allowed to visit the tombs of ancestors, or pay respect to the fallen.They are our enemy, and they must be destroyed. Travel to the Valley of Spears to the north, and slay them, bring me 10 of their bracers as proof.",
  ...
  [40631] = {
    ["D"] = "We Gelkis are unlike many of the other tribes, our connection with the elements is something that we value most.During our past we damaged such a reputation, and hope to look forward to the future, and repair the tarnish we have caused.All around the region are swirling vortexes of wind and air, from them I would have you gather 12 Elemental Air, these are vital for our kind\'s commune with the elements.Return to me when you have recovered them.",
    ["O"] = "Gather 12 Elemental Air, then return to Warleader Temukar at Gelkis Village in Desolace.",
    ["T"] = "In Commune With Wind",
  },
  [40632] = {
    ["D"] = "Long has it been since the Magram and Gelkis fought, warred for territory. We have been on the defensive for far too long, fighting back raiding parties that thrusted into our lands, and killed our kin.It is about time we did our best to fight them back, and cull their ranks to end this bloodthirsty aggression.I would have you fight on our behalf, to rid us of our enemies so that we may find a higher calling.Magram Village is located to the east, travel there, and slay them.",
    ["O"] = "Slay 6 Magram Scouts, 6 Magram Outriders, 6 Magram Stormers and 6 Magram Windchasers for Warleader Temukar at Gelkis Village in Desolace.",
  ...
  [40634] = {
    ["D"] = "THIS. WAS. NOT. IN. MY. CONTRACT.Un-freakin\'-believable!I had to crawl through the savannah and this dusty red rock to get here and find out there\'s nothing to work with?!Klazfit welcomed me with: \"Deal with it, kid. You got a job to do kid.\" Son of a leper gnome!Don\'t tell him I said that. This is fine, it\'s okay, everything\'s fine. This is -NOT- fine!  Listen up chum, you gotta do something. Blacksand Oil Fields, lots of spare parts laying about, the Venture Co. classic. Bring me as many as you can carry and you\'ll get paid handsomely.",
    ["O"] = "Bring 30 Spare Parts to Technician Steelbolt at Powder Town in Stonetalon Mountains",
    ["T"] = "To Fix A Shredder or Two",
  },
  [40635] = {
    ["D"] = "Hey, how you doing chum?I\'m really positive you\'re here for work but I smell an amateur when I see one. My gut tells me you\'re more brawn than brain and I got the perfect deal for you, friend.So listen up.Rumors say the good ol\' gnome city got boomed with green, and it wasn\'t even us goblins, can you imagine that? Idiots called us suicidal but they gone and done that. Calling themselves leper gnomes now, they were always a leper if you ask me.What\'s even funnier is that they\'re now employed by the Venture Co.! Undermine ain\'t what it used to be, sounds like.Long story short, go show those idiots who the superior green is and bring me back those coils. Hear that? Coils. C-O-I-L-S.",
  ...
  [40636] = {
    ["D"] = "I\'m the law around here bub. Dis the law and you dis me, dis me and I have my boys turn you into gunpowder for our bomb, got it?Good.Since you\'re already here, I got a business proposition for you. You get to smack some lizards, peace still stands, everybody wins eh?Now listen, leaving the pure comedy aside, we got some real issues with the basilisks around here. Why? Well because they can fit a goblin in their mouth bub, that\'s why.All you gotta do is go out there and kill some of them! Just some, gotta leave something for my boys too, right.Simple bread to earn, simple!",
  ...
  [40637] = {
    ["D"] = "Great job with them lizards bub! Left enough for my boys to have fun too. Eh, to be honest, some got eaten. But they had fun! Right? Don\'t look at me like that kid, I\'m a great boss! Do you think I got this job because I rubbed someone the good way?Oof, can\'t take back those words. Still! New job handpicked just for you my uh very capable comrade, yes, comrade.The very explosive nature of the Venture Co. seems to have woken up some very very angry earth elementals or something. Salrog was spouting some orcish spiritual nonsense.You go deal with them and I pay you, best deal you\'ll get in Powder Town! That is if the town is still standing when you return.Blasted Venture Co., it was clearly them, right? Not the tests we\'ve been performing with the bombs, right?",
    ["O"] = "Kill 7 Rumbling Earth Elementals and return to Security Officer Mort Tozzlefume at Powder Town in Stonetalon Mountains.",
    ["T"] = "Earth Rumble",
  },
  [40638] = {
    ["D"] = "Busy day in the port, kid, always is. Since the day our big boss, the Warchief, had given us his blessing to make our home in this dusty place.No complaints here, o\'course. We\'re just trying to get by and earn our keep after all.Speaking of which, I\'ve sent an expedition to the Stonetalon Mountains. Our horned friends, the Tauren, told us of a place where we could freely toy with our engineering.My most trusted man, Nazz, has been given the task to overview the construction of the BIGGEST bomb to ever exist.This is one of the two things we can provide to the Horde. The other being the best economics in KalimdorReport to Nazz in Powder Town, close to the Charred Vale. This is all for the good of the Horde!",
    ["O"] = "Report to Nazz at Powder Town in Stonetalon Mountains.",
    ["T"] = "Blasting Stonetalon!",
  },
  [40639] = {
    ["D"] = "Heya kid, ready to do some actual work?You\'ll be under my guidance, if I were you, I\'d worry about how large my pockets are because I am about to fill them if you\'re doing a good enough job.Backstory time. Notice from yours truly, most of the time the things I am about to say require a tax per sentence for the listener but since you came from Nert himself I am willing to eh, oversee it.Anyway, where was I, ah yes. I used to be a big shot in Undermine back in my day, there was nobody, and I mean nobody I wouldn\'t cheat, lie, kill or steal from for my own goals!<Nash rubs his hands and giggles quietly to himself as your skin begins to crawl.>Naw, don\'t worry kid, those days are behind me. I was saying, I and the Venture Co. got history and especially with this idiot they\'ve sent to oversee the oil fields.Go beat some of these idiots up and see if you can find any info on them.",
  ...
  [40640] = {
    ["D"] = "<Nazz reads the documents you brought him.>Hoo boy, the Undermine at its finest.I remember those days. There is nothing worse than the Goblin nature, $N. The ones above will always work the other lot to death. And the other lot? They\'re trying to be the whip bearers rather than being whipped. Nothing worse, ain\'t NOTHING, NOTHING WORSE.This is why the Union is a much better deal, most of us live equally, more or less. The Goblin nature applies here too, but in different ways and measures. Anyway, I got a plan. I need you to do what you do best, go out there, kill stuff, and bring the stuff back for money. Easy. Easy. All across Stonetalon, they go by the name \'Raging Cliff Stormer\' a huge lizard that shoots lightning. I need their scale for a shrink ray. Pretty much the electricity is what I need, the rest I am gonna ask some of our most \"prestigious\" engineers to make. Five of them will be enough!",
    ["O"] = "Bring 5 Electric Scales back to Nazz at Powder Town in Stonetalon Mountains.",
    ["T"] = "Nazz\'s Got A Plan",
  },
  [40641] = {
    ["D"] = "All right, shrink ray is done.You\'re probably wondering why we need a damn shrink ray to kill that doofus Higgle, right? Well, we don\'t. Call this a pet project of mine. You\'re gonna go back into those fields, find the B-33 Shredder and beat it around a couple of times. Once the pilot is dead, it should automatically begin shrinking, just pick it up!Do. NOT. DAMAGE. ITJust wanted to make clear, after you beat it up real good, you\'ll use the shrink ray, pocket it up, and come back to me. While you cause this commotion, I have a friend of mine finding the location of their boss.",
  ...
  [40642] = {
    ["D"] = "Right. While you were gone a friend of mine discovered the location of Higgle. And before you say it, yes, he\'s at the top of the stupid building. I had a hunch too, don\'t be a smartass about it.Higgle reminds me of our dark past bub, his stupid bossing around should end here. But, I know I am sending you on a pure suicide mission, you don\'t have to do it if you don\'t want to do it. But after all you\'ve done, I am more than sure you will.Kid, I\'m proud I got an employee such as you. Stay on your toes, during your many, many trips to the oil fields they should be very alert right now. Humor this old Goblin, after Higgle\'s blood is spilled spare any who mean no harm, perhaps some of them will see reason and simply leave or seek a home in the union.Whatever your choice might be, do this one last job for me.",
  ...
  [40643] = {
    ["D"] = "KABOOM!Oh, sorry to startle you bub. What\'s up? Here to see the BOMB, right. Man, I tell you, this puppy got the power of the sun in it! For real, that\'s what Nash said and Nash is always saying the truth! Speaking of true things. One of the bruisers said there\'s a kobold among the Venture Co and he\'s their Overseer. Can you imagine that? A kobold, the Overseer.<Blammo laughs hysterically>I need to see this with my own eyes, but I can\'t leave the bomb! Say, won\'t you go kill that guy if he\'s real and bring me his candle?",
    ["O"] = "Bring Vermintooth\'s Candle back to Fusemaster Blammo at Powder Town in Stonetalon Mountains.",
    ["T"] = "A Rat Among Them",
  },
  [40644] = {
    ["D"] = "Not sure what these guys are planning to do here but they\'re missing a great thing.Oil. Funny isn\'t it? The Venture Co. are here for oil and they are clearly salvaging it. Someone should tell them that they\'re also salvaging it for us.Someone, someone who will be paid handsomely if $Ghe:she; won\'t ask any dumb questions should go and thank them for it while also grabbing what actually is owned by Powder Town.Got all that or do I gotta draw it for you?I need 6 barrels.",
    ["O"] = "Bring 6 Barrels of Blacksand Oil back to Head Technician Klazfit at Powder Town in Stonetalon Mountains.",
    ["T"] = "Siphoning Oil",
  },
  [40645] = {
    ["D"] = "Huh?What do you want, ugly? Want a piece of Gig, EH?Come here! Why you little, don\'t dodge!<Gig falls on his face.>Huh? Where in the blazes am I, and who are you? More importantly, got anything to drink? Ah, screw you then pal. Can\'t a goblin catch a break every now and then? I got some great important news for the law in this town if I were to be offered a cold one.",
    ["O"] = "Bring Cheap Beer to Gig in Powder Town.",
    ["T"] = "Favouring the Drunk",
  },
  [40646] = {
    ["D"] = "<hic> ... listen up kid, I hear stuff. A lot of stuff <hic>, people ignore ol\' Gig because he\'s an alc- alco- because he drinks too much! But I drink and I know stuff, get it? Anyway, I was outside the inn yesterday drinking and I heard one of them two boys talking about sabotaging the bomb and blow us all up!It\'s the golden honest truth my friend, go tell Mort, he should do something about <hic> it!<Gig falls on his face.>Oy, what you looking at bub, you want a piece of the champ?",
    ["O"] = "Speak with Security Office Mort Tozzlefume in Powder Town about Gig Xevno\'s suspicions.",
    ["T"] = "Least Paranoid Goblin",
  },
  [40647] = {
    ["D"] = "Shadow welcomes you, $N. My name is Artemus and I\'ve traveled long and far from Hillsbrad Foothills to do business with the Goblins of Powder Town. They are very unique to call them so. Madmen that would do anything for their goals and even for someone of my condition, this is very exciting!I used to study herbology in Dalaran when I was younger, regretfully I was nowhere near my home when the plague struck and there we have it. I won\'t bore you with a soapy story of how I came to be undead and how much I hate myself or whatever others say. I\'m quite happy with my condition, I finally have the time to experience and learn everything I want to.I have traveled all this way to continue my studies, more specifically in decay. The local ancients in the Charred Vale have become withered, and tortured.Bring me one of their Decaying Roots, it shall prove useful.",
    ["O"] = "Gather the Decaying Roots for Artemus Halloway at Powder Town in Stonetalon Mountains.",
    ["T"] = "Knowledge on Withering",
  },
  [40648] = {
    ["D"] = "<The small whelpling flutters his wings and tries to escape as you approach.>No! No hurt!<It pauses and looks up with wide eyes.>No ogre. No dark dwarf. You good? You help? Yes? Please! Up ramp. Family, brood family. Mind control! Tyrant. Cave. Teleport, crystal, cave! Jewel control. Jewel mind control, jewel mind control!<It hops up and down in a panic.>Kill! Get jewel! Asza reward. Asza reward!",
  ...
  [40650] = {
    ["D"] = "Have you seen a chicken with its head cut off, $r? It runs around, aimless, panicking, before finally dropping dead. When you head to Angor Fortress, to the north east, strike deep into it. Go for the one who organises them, and the rest who survive will be just as aimless as the beheaded bird.Barlgruf is his name. He will not be alone, nor will he be accommodating, so strike first and strike hard. Return to me when he lies in a puddle of his own blood.",
    ["O"] = "Slay Captain Barlgruf in Angor Fortress for Warlord Goretooth at Kargath in the Badlands.",
    ["T"] = "The Shadowforge Captain",
  },
  [40651] = {
    ["D"] = "I get really tired sometimes of working on rocks, you know? And then, something comes along that really blows your socks off! Quite literally sometimes when it comes to engineering, but...<He coughs awkwardly and wipes the sweat from his brow.>Listen! The dwarves in Angor Fortress? They have begun automating their golem protectors recently. I don\'t know exactly how they do it! I witnessed one zapping the chest of the big statue and it came to life right there and then! Can you believe it?I need that zap-o-matic thermojigger, or whatever it is! Find it, please, and bring me a few of their hearts to play with while you\'re at it, yes?",
    ["O"] = "Acquire the Golem Heart Starter and three Life-Forged Hearts from Angor Fortress for Lucien.",
    ["T"] = "A Heart of Stone",
  },
  [40652] = {
    ["D"] = "Ah, a moment of your time please, $n?Yes, yes, I know who you are. I was planning on discussing this issue with Senator Redstone, since he appears to have a passing interest in the goings on in the Badlands. But since you have fortuitously come to me, perhaps you will listen to my request.My brother is part of an expeditionary party down there, you see. A prospector, but he has his mind set on ridiculous fairy tales and is chasing legends. He has lost sight of what is important! There is much wealth and knowledge to be gained from scratching the surface of the earth, never mind delving into its depths.Seek out the digsites in the northern part of the Badlands. Beware, I think the Dark Iron Dwarves are excavating there and are unlikely to enjoy onlookers. Come back when you have a nice collection of artefacts.Oh, and $n? If you can\'t pick them up from the ground, feel free to take them directly from their hands.",
    ["O"] = "Gather 8 dusty relics from the Angor Digsite in the Badlands for Senator Ryedol in Ironforge.",
    ["T"] = "Eyes on the Prize",
  },
  [40653] = {
    ["D"] = "<He massages his temples and looks awfully exasperated.>Frankly, I was not sure I had to spell it out so clearly. I want the best of the relics here. The real findings from the digsites. Not old pieces of pottery and... whatever these are. Go back to that digsite. Find their leader, for he will surely preside over the more prestigious treasures. Take, steal, whatever you have to do, to bring back something actually worthwhile to me.Just do be careful, I hear the lead archaeologist there is a rather powerful spellcaster. I am sure that is no trouble for one of your stature though, correct $n?",
  ...
  [40654] = {
    ["D"] = "The coin is much larger than any coin you have seen before, and quite a bit heavier. It appears to have someone\'s head engraved in the surface, but is too covered in muck and dust to be made out clearly.Rubbing some dust off the surface, the material seems to get shinier and shinier. Is this gold?",
    ["O"] = "Show the coin to someone in Ironforge who knows about these types of relics.",
    ["T"] = "Glittering like Gold",
  },
  [40655] = {
    ["D"] = "I am sure it goes without saying, I have no great love for little young creatures. I have nothing but contempt for humans, for example, and their little pets.<He sneers beneath his mask.>But I have recently been made aware of an encampment in Lethlor Ravine, and the skinned corpses of countless whelplings thrown into the sun to rot. The Dark Iron Dwarves once again. Now, why would anyone set up a guarded camp to slaughter whelplings and drakes, if not to harvest something important? I do not particularly care what they hope to achieve, but if we strike now before they are more fortified, we will cut off this venture at the knees.Find this base of operations, and slay the dwarves you find within.",
  ...
  [40656] = {
    ["D"] = "Perhaps I should apologise for not being as informed as I would have liked. Had I known how established this camp already was, I would have tasked an assassination of their leader.Actually, perhaps you are ardent for blood and glory. Head back into that camp, find their leader, and kill him. Not a complicated task, but one that may be more dangerous than before. He will surely be prepared for this, given your previous efforts.",
    ["O"] = "Slay Kegdesh Foulmantle in Scalebane Ridge for Lexlort at Kargath in the Badlands.",
    ["T"] = "Bane of Scalebane",
  },
  [40657] = {
    ["D"] = "<He throws up his hand to halt your approach.>That is close enough. And speak quietly, lest you irk us with your prattle of adventure and questing...Actually, I do have a request. Scalebane Ridge, heard of it? No? Lethlor Ravine, then? No? The Badlands? You are a truly a dense one...I need you to find the encampment known as Scalebane Ridge. It is a new base of operations for the Dark Iron Dwarves in that area, and their hunting of the whelplings in the area gives me a very bad feeling about what they could be used for. In any case, better safe than sorry. Head over there, and slaughter their hunters.",
  ...
  [40661] = {
    ["D"] = "Oh, it has been a long, long time since I have been in the city of Stormwind, what seems like a life in itself!Around three years ago I traveled to this city with the fleet on other business and met a rather charming, and mysterious woman named \'Charys Yserian\'. Never since has a woman left such an enchanting impression upon me, and I feel as though I am squandering my time stuck here on the coast with menial jobs unable to see her.I ask of you to help, mainlander, it will be a few days until I get some free time, and I would like to make an impression... If she can remember me.Travel to the florist Bernard Gump, he runs a shop called \'Fragrant Flowers\' in the canals between Old Town and Trade District, buy a Red Rose and deliver it to Charys, word has it she runs a shop in the Mage Quarter now.",
    ["O"] = "Buy a rose on behalf of Sailor Borus and deliver it to Charys Yserian in Stormwind City.",
    ["T"] = "A Sailors Love",
  },
  [40662] = {
    ["D"] = "Who would suspect a Kul Tiran Sailor to show so much affection? Those that many call crass, blunt, and overly loud at that.He has surpised me, in a rather nice way, to be remembered after such a long time really is a compliment.Here, I prepared a letter to him, and -just- for him, do not think to pry it open, my magic will know if you do.<She gives a wicked stare, and lets out a laugh to ease her pretend tension.>Take it to the Sailor, and let him know his actions are appreciated.",
    ["O"] = "Bring Charys\' Response to Sailor Borus at the Kul Tiran Embassy in Stormwind Harbor.",
    ["T"] = "Charys\' Response",
  },
  [40663] = {
    ["D"] = "All this time stationed around and yet we hardly have any ale to tide over the boredom.Say mainlander, you must have freedom to walk the streets of the city without a job looming over your head, how about a favor? We are currently busy with tasks during the day but we could use some loosening up during the night if you catch my drift.Head into the city, it should be ripe with ale, find me 3 Flask\'s of Port, that should do quite well.",
    ["O"] = "Find 3 Flask\'s of Port for Salir Valia at the Kul Tiran Embassy at Stormwind Harbor.",
    ["T"] = "Embassy Blues",
  },
  [40664] = {
    ["D"] = "We live in harmony here with nature, to let our gryphon\'s grow strong and roam wild.I have seen to watching our borders and have noticed the stunning growth of the Silvermane population. The wolves have become more and more aggresive as their territory expands and now they are at our doorstep more often than ever before.We will need to cull their numbers, lest they begin to strike at us or kill our roaming gryphon. You can find the Silvermane wolves all across the Hinterlands, bring me fourteen of their pelts as proof.",
    ["O"] = "Bring 14 Silvermane Pelts to Claira Kindfeather at Aerie Peak in The Hinterlands.",
    ["T"] = "Protecting Aerie Peak",
  },
  [40665] = {
    ["D"] = "The war is at our doorstep $C!The arrogant Kul Tiran think us weak, and it is up to all the brave sons and daughters of the Horde to teach them otherwise!The second wave of their fleet has landed just off our shores and poses a threat to our well being. The Warchief has called all able bodied in the area to assist.On the southern edge of the Echo Isles their scouts and commandos can be found, probing and plotting for their next move. Slay them in the name of the Horde, and return to me!",
    ["O"] = "Slay 7 Expedition Scouts, and 7 Expedition Commandos for War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "The Second Wave",
  },
  [40666] = {
    ["D"] = "The Fleet of Kul Tiras has landed just south of Echo Isles and is beginning to press inward into Durotar.We had received intelligence in the past of such a relief force to Tiragarde, but we have underestimated their gaul.All wars are fought on supplies, and there is no doubt they are stretched thin so far from their home land.Search their camps and gather Bundles of Expedition Supply, they may be forced to leave before ever setting foot near Orgrimmar.",
    ["O"] = "Gather 6 Bundles of Expedition Supplies for War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "Expedition Supplies",
  },
  [40667] = {
    ["D"] = "You there!You seem like a worthy soul. I have been advised to gather all who seem able, and willing to report to the Warchief directly.He once led the assault against the Kul Tiran scum during the Battle of Theramore in the founding of Durotar. It is his wishes to assess the situation and give orders to those more competent enough to handle the coming invasion. Bring this commendation, and he will know I sent you.",
    ["O"] = "Speak with Thrall in Orgrimmar about the coming Kul Tiran threat.",
    ["T"] = "The Warchief\'s Orders",
  },
  [40668] = {
    ["D"] = "It has been a long time since we did battle with the Kul Tiran\'s in such a manner. Tiragarde never really posed such a major threat, but the news coming to my hall is worrying.Lieutenant Alverold is the one who leads their Expedition Fleet, and it is he I wish to direct my attention. In the past, Admiral Proudmoore was not willing to discuss in terms of diplomacy, and I do not think his loyal Lieutenant will either.My concern is not with these foreigners, but with the Alliance, for I do not know their standing with Kul Tiras, the last I heard an embassy opened in Stormwind. The last thing we want is an all out war between our factions.I must know more before I directly engage and I would trust you to speak with an agent in Ratchet that goes by the name \'Mally O\'Flor\', he is a human.",
  ...
  [40669] = {
    ["D"] = "So, Thrall sent you huh?Interesting, I was sent here to replace another, but I never expected to be contacted, the last two before me were never spoken too in regard to anything.I work for an organization that has ties deep with Stormwind and has it\'s eyes all over the world, so to say.The information I have, but I need a favor from you and your kin beforehand, I am here for another purpose, one I need completed in short time, but do not fret, it is within the region.In the Barrens can be found a very specific type of raptor, Sunscale, some of our agents have been looking to gather vials of their blood, three in total for archival and research purposes.Gather me those vials, and the information is yours.",
    ["O"] = "Gather 3 Vials of Sunscale Blood for Mally O\'Flor at Ratchet in the Barrens for the information Thrall seeks.",
    ["T"] = "A Favor for Mally",
  },
  [40670] = {
    ["D"] = "I have stashed away the Vials, and am ready to speak, should you be prepared to listen.When you are ready, speak with me, and I will tell you what it is I know.",
  ...
  [40671] = {
    ["D"] = "We have gathered all the information we need to proceed with full authority.As much as I was concerned, I should have known better of the Alliance then to attempt such an action.Though, it is always useful to be prepared, and look at all the options before charging into something head first as our orcish kin did when they first endulged in the blood of demon.I will send you to War Crier Dar\'nakk with my full authority, report to him for further instruction.",
    ["O"] = "Report back to War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "Cleared to Engage",
  },
  [40672] = {
    ["D"] = "The island of Anchor\'s Edge is where the majority of their force is located, it is there we will begin our assault. You can find it just south of the Echo Isles in south eastern Durotar.They are heavily entrenched and well supplied, it will take grit determination to overcome them, and I think you may have just what it takes.Strike hard, and fast young one, cut down their soldiers, sailors and priests, they are the backbone of the Expedition Fleet.",
    ["O"] = "Slay 8 Expedition Sailors, 6 Expedition Priests, and 10 Expedition Soldiers for War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "Anchor\'s End",
  },
  [40673] = {
    ["D"] = "If we wish to truly dismantle the Expedition Fleet, then we must decapitate their leadership.The core of their effort lies entirely within their officers, leaders, and those that rally the mob of incoherent rabble. Our report suggests that there are many officers in their ranks from the extensive campaigning they have done.Travel to Anchor\'s Edge just south of the Echo Isles in south eastern Durotar. When you arrive, slay ten Expedition Officers, Aquamancer Shaleborn, and Deckmaster Darkhollow.",
    ["O"] = "Slay 10 Expedition Officers, Aquamancer Shaleborn, and Deckmaster Darkhollow for War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "Cutting Ranks",
  },
  [40674] = {
    ["D"] = "Lieutenant Alverold is the one who commands the Expedition Fleet, it is he that we must slay in order to bring glory to the Horde.Nestled deep within Anchor\'s Edge the worm is no doubt hiding in the most fortified spot, find it, and hunt him down, bring his head as proof of the deed.<War Crier Dar\'nakk smirks.>I hear he has traveled long with a paladin named Danuvis, kill him as well, let none survive.",
    ["O"] = "Slay Lieutenant Alverold, and Paladin Danuvis to end the incursion of the Expedition Fleet for War Crier Dar\'nakk at Razor Hill in Durotar.",
    ["T"] = "Lieutenant Alverold",
  },
  [40675] = {
    ["D"] = "Your actions are beyond praise, no amount of words can describe the glory you have brought to the Horde.It is on such monumentous occasions that heroes arise, and today you have gained notoriety enough to gain that title, but do not let it get to your head!Thrall has requested your presence in note of such deeds, speak with him, and be rewarded for your actions this day.",
    ["O"] = "Speak with Thrall in Orgrimmar, and claim your reward.",
    ["T"] = "A Heroes Reward",
  },
  [40676] = {
    ["D"] = "Greetings! You\'re a long way from home! Are you looking for me?I\'m Selendra. I\'m desperately trying to right the wrongs of the past here in Mashan\'she! You do know that is this place\'s name, yes? Not Desolace, no! That\'s a horrible name for it, just because the life has been sucked out and... never mind.Look, there are signs of life, I\'m sure of it. I just need someone to help prove it, convince the world that this land is still worth saving, for the flora and fauna that can still survive!I would like to see how far the life-leeching has gone. Theradras may have stripped life from the land, but what about the seas?  The Kal\'dorei ruins of Ethel Rethor are mostly underwater now. But there used to be beautiful blooms of Alor\'el, the lovers\' leaf, which grew there. They can survive underwater though, $r! This is known! Please, search the sunken depths and bring me back some of those flowers as proof, if they still exist.",
    ["O"] = "Search the sunken elven ruins of Ethel Rethor for any living flowers to return to Selendra.",
    ["T"] = "Drowned Love",
  },
  [40677] = {
    ["D"] = "I have one more test to prove my theory, and redirect some attention here from the Cenarion Circle!If the loss of life did not reach far out to sea, perhaps it did not reach far into the mountains either?There is a beautiful bloom native to here, Mashan\'she Silversage. It grows high up, but where there is a sea breeze too. I would start on the northwestern shore, $r. Search whichever hills and mountains you can climb, and try to find some of those blooms! It matters so much to me, I would be eternally grateful.",
    ["O"] = "Seek out Mashan\'she Silversage for Selendra.",
    ["T"] = "Lofty Heights",
  },
  [40678] = {
    ["D"] = "Why do you think I fish, mon? It\'s a lot calmer and less dangerous than fighting... that\'s for sure.  Now, recently I\'ve been getting my fishing rods stolen by Drysnaps, huge they are! And they can rip an arm off if you\'re not careful...This isn\'t what I need in my mornings, mon. If you be killin\' them for me, you\'d be doing myself and the village a big service.",
  ...
  [40680] = {
    ["D"] = "Many alpha Mosshide run many smaller groups, these groups fight eachother, and cause problem-problem.These Mosshide leader must be killed so that Gowlfang can rule! You can find alpha Mosshide to the west near place called Saltspray Glen, go there, track alpha, kill Alpha! After, only one alpha left, Gowlfang!",
    ["O"] = "Track down and slay 4 Mosshide Alphas for Gowlfang near the Greenbelt in Wetlands.",
    ["T"] = "The One Alpha",
  },
  [40681] = {
    ["D"] = "Cursed Sagepaw, he was one who exiled me, sent me away, let me rot in small goblin town called Sparkwater, now I come back, and I get last laugh-laugh!<Gowlfang cackles wickedly and begins to snarl.>You find Sagepaw, you kill-kill him, kill-kill Sagepaw good!When Sagepaw dead, no one stand between me and lead-lead Mosshide, me become strong!You find Sagepaw south, near big waterfall, go and kill-kill!",
    ["O"] = "Find cursed Sagepaw and kill-kill him for Gowlfang near the Greenbelt in Wetlands.",
    ["T"] = "Cursed Sagepaw!",
  },
  [40682] = {
    ["D"] = "My job keep gnolls safe, I defend, I fight, and I watch-watch!Long ago raptor almost made Mosshide extinct, now raptor growing in number, many raptor nearby, could be end of Mosshide tribe if not careful, Dagdag can not fight against that. Raptor Ridge is where they breed-breed, they are strong there, but maybe you stronger?Travel east to Raptor Ridge, and fight Razormaw raptors, bring me Razormaw Talon as proof you kill-kill to keep us safe, yes?",
    ["O"] = "Gather 11 Razormaw Talons for Dagdag Mossbelt near the Greenbelt in Wetlands.",
    ["T"] = "Raptor Ridge",
  },
  [40683] = {
    ["D"] = "Always problem-problem for Mosshide, first with Raptor, now with dragon!Every day-day more and more dragon whelps roam the country side, so many that it is hard to properly walk the land without worrying about dragon fire!Bogpaw need valueable herb-herb, and many of my good spots are now crowded with dragon!Go kill whelp-whelp for Bogpaw, let Bogpaw get good spot again.You find dragon whelp to southeast, now go-go!",
    ["O"] = "Slay 7 Lost Whelps and 5 Crimson Whelps for Bogpaw Truthsay near the Greenbelt in Wetlands.",
    ["T"] = "Dragonkin Annoyance!",
  },
  [40684] = {
    ["D"] = "Hello $r, Have you heard? A Pandaren, one of the most reclusive races, has been seen in Ratchet.The merchants say he is celebrating a festival native to his homeland. If you have some free time perhaps you could go and see this Pandaren and what this festival is about.",
    ["O"] = "Track down this Pandaren in Ratchet and see what the fuss is about.",
    ["T"] = "A Pandaren Brewmaster",
  },
  [40685] = {
    ["D"] = "Lok\'tar $r! Have you heard the news? Chen Stormstout has returned to Kalimdor! Chen Stormstout was integral in the founding and defense of Orgrimmar alongside the likes of Rokhan, Cairne, and Rexxar!Many are journeying to Ratchet to meet him, perhaps you would be interested as well, rumor is that he is looking for something and may reward whoever assists him.",
    ["O"] = "Travel to Ratchet and meet Chen Stormstout.",
    ["T"] = "The Return of Stormstout",
  },
  [40686] = {
    ["D"] = "I have come to visit my good friend Drohn, to celebrate the festivities of the Brew festival from my homeland, and to create a new brew.Drohn has gathered some exotic ingredients that would make for a very interesting and potent brew. Mayhap you would be interested in assisting me too, yes? I would share my newest surprise brew with you in return.Acquire the following for me, a pinch of Magic Dust, Fourteen Hops, and some Goldthorn Tea. The ingredients can be found around the world so you may have the travel to exotic locations and markets.",
  ...
  [40687] = {
    ["D"] = "Theramore was founded by many from the nation of Kul Tiras, our leader Jaina even hails from there. Our stance of cautious neutrality with the Horde has cause problems for many of the veterans. These soldiers once saw brothers and sisters die in combat, or had families pass in war.More and more of our kin stray from Theramore with each day. Either deserting outright, or being exiled for overly aggressive and divisive actions in attempts to lead us to conflict.While I hold respect for those that served, I do not tolerate disloyalty. The Deserter\'s have begun to go too far, wearing our tabards, uniforms, and lurking within the swamp.They must be dealt with, before they bring all out war to us. The Hideout is located directly to the west of Theramore within the Quagmire, head there and remove their presence.",
  ...
  [40688] = {
    ["D"] = "Weeks ago a patrol of our sentries were attacked by Tauren of the Blackhorn Tribe nearby, it was unwarranted and somewhat unexpected. Of those attacked two were killed and others severely injured, the threat of the Blackhorn have only made us be ever more wary in our actions in Dustwallow.The leader of the Blackhorn is named Targos Hatewind, a vile a cruel warrior who does not even seek affilation with the Horde.It is him that must be stopped, you can find him at Blackhorn Village to the north west at the northern edge of Dustwallow Marsh.Go there, kill his kin, and collect his head.",
  ...
  [40689] = {
    ["D"] = "We have received reports of Alliance beginning to have larger and larger numbers of deserters in the region, this pleases me greatly.Their command structure may not be as strong as we once believed, but do not think this is all good news, for these deserter\'s are only leaving to persue even more conflict with us here at Brackenwall.Already a few of their rabble have probed our area and our defenses, and it won\'t be long until they unravel whatever plans they are drawing up. Let us bloody their nose, and strike first.The Deserter\'s Hideout can be found to the south east of here, find it, and destroy them.",
    ["O"] = "Find the Deserter\'s Hideout and slay 9 Deserter Turncoat\'s, and 9 Deserter Exile\'s for Nazeer Bloodpike at Brackenwall Village in Dustwallow Marsh.",
    ["T"] = "Theramore Deserter\'s",
  },
  [40690] = {
    ["D"] = "The Grimtotem in the region are a spineless, and traitorous bunch. They once spoke with us in talks of unity, and now ambushed and killed a friend of mine in combat within the Quagmire.They must pay for their insolence, and disrespect. They are led by a craven named Targos Hatewind, it is he that I want dead.Head northeast to Blackhorn Village, and bring ruin to them, they are enemies of the Horde.",
  ...
  [40691] = {
    ["D"] = "Stonetalon.The name brings anger to my core, this is the place my brother died in his fight during the Third War.While I served in Ironforge he sought glory in these lands, but he did not find what he sought. His tale deserves to be heard, when you are ready, speak with me, and I will recount it.",
    ["O"] = "Listen to the story of Grumnir Battlebeard\'s brother.",
    ["T"] = "A Journey for Vengeance",
  },
  [40692] = {
    ["D"] = "My family\'s history is stained, our heirlooms lost in time, and our axe in the hands of an orc who slayed my kin.There is no greater fall for a dwarf, and I must right the wrongs.I have had some luck in tracking this \'Scartusk\', for he is one of the Warsong, lingering in the forest of Ashenvale just beyond the Talondeep Path to the north. Just past Talondeep Path, head westward, to the Ruins of Stardust, it is there he resides, scouting for the enemy. Bring my family\'s axe to me, and honor my brother.",
  ...
  [40693] = {
    ["D"] = "Have you heard the tale of the Ornate Windshear Gemstone?!It really is a wonder of prospectin\' I tell you what! It is told by rumor that those Venture Co. hooligans up and dug some rare crystal deep beneath Stonetalon, one that glimmered a deep, and shiny red.You see, I aint out here to see the sights, no, BAH! This place be more ugly than Westfall, and trust me, I been there.If I want a chance to get out of this hell hole, it lies in that Windshear Gemstone, and I want my hands on it. What say you make your way down to the Windshear Mine down in the Crag and do ol\' Flinthammer a favor huh?I\'ll give ye somethin in return, how about that to spice up a deal?",
  ...
  [40694] = {
    ["D"] = "My beauty, trapped in a sea of vultures.I am a brave dwarf, but if I ever want to fly again, I can\'t go risking my life now, can I?You look like someone who knows a thing or two about slaying vultures, and Sputtervalve Conductors. The eyes of Harlek can spot talent when he see\'s it!My flying machine is down below, I was doing some repairs before me and farmer Segwar were attacked you see? Sadly I left behind the Sputtervalve Conductor, a rather valuable part that I was trying to get fixed to do some scouting in the perimeter.I need you to go down to the flight pad, and go get the part for me, do that, and I\'ll give you a nice drink of ale, good?",
  ...
  [40695] = {
    ["D"] = "Bah, dangnabbit!I don\'t have anything to fix this, I suppose I need to find someone who know\'s a thing or two about marveled engineering on such a delicate part...<Harlek Vaultshield lets out a chuckle.>Oh, that\'s right, I do know! Tansi Sparkfuse is in town... Somewhere, no doubt working on something, find her and see if she can fix the Sputtervalve, would ye?",
    ["O"] = "Speak with Engineer Tansi Sparkfuse at Bael Hardul in Stonetalon Mountains.",
    ["T"] = "The Sputtervalve Fix",
  },
  [40696] = {
    ["D"] = "<Tansi Sparkfuse blinks at the Sputtervalve Conductor.>Well, that wasn\'t too hard, all it required was a few wires and some tubing.Harlek is going to have to owe me for all of these favors I am doing for him.Take it to him, he should be pleased.",
  ...
  [40697] = {
    ["D"] = "Our new neighbors certainly are quite an interesting bunch. The dwarves here at Bael Hardul have been quite gracious in their hosting.I am Maloran, a delegate on behalf of Stonetalon Peak, sent to make sure that the natural order is not disturbed. I will admit I held caution when I first arrived, but thus far, Whitepeak has been fairly respectable.This has left me to pursue my real purposes. Beneath us to the west the Venture Co. has laid unmarked terror to the fabric of nature, and I wish to see if the local Deepmoss have been affected.Travel to the west, and gather me a Pristine Deepmoss Brain, I will use it for study.",
  ...
  [40698] = {
    ["D"] = "<A look of displeasure marks Maloran\'s features>It would appear my research has proven me correct, whilst the Deepmoss population is in a state of increased aggressiveness, there is something more, lingering just beneath it all.I sense corruption of a magical sort, and this finding has left me with more questions than answers.A friend of mine named Faldan Moonshatter has taken it of himself to study the corruption of furbolg in Ashenvale, perhaps he may have some answers as to how such a thing could have happened.You can find Faldan within Astranaar, at the heart of Ashenvale itself.",
  ...
  [40699] = {
    ["D"] = "Why hello there!What, shocked to see a gnome so far west? Well, you should be, there isn\'t many of my kind so far from home.Or well, what used to be home.Either way, I\'m looking to conduct experiments now that I have some time and space to myself, the first of which requires some flammable, and quite dangerous materials!Far to the west is a place called The Charred Vale, it is there that roving flame elementals can be found, from them I\'d like to acquire something called a \'Flickering Flame\'. Get it for me, and I\'ll make sure you\'re compensated.",
  ...
  [40700] = {
    ["D"] = "Perched above Bael Hardul is the dreaded Bramblethorn Pass, occupied by Quilboar and their haunted kin.The wayward spirits have cause us all sorts of trouble, and have had us on high alert since we arrived. We could use someone to disperse the spirits to let our limited Mountaineers a chance to rest.You can find them just to the south west, up the slope, head up there, and deal with them for us.",
  ...
  [40701] = {
    ["D"] = "When the dwarves first arrived in Stonetalon and had built Bael Hardul a mighty Quilboar ruled over Bramblethorn Pass, he was named Gorras Thorncrusher and was quite a formidible enemy.After many battles with the Quilboar, Gorras was slain, though his indomitable spirit remains, perched overtop of Bramblethorn Pass, still occupying his throne. His hatred for our kind is unmatched, and it is only a matter of time until his soul comes for vengeance, we must put an end to such evil.Travel again to Bramblethorn Pass, and find Gorras Thorncrusher, destroy him once and for all.",
  ...
  [40702] = {
    ["D"] = "My name is Whitepeak, I lead this group of would-be explorers here to Bael Hardul after hearing stories that it still stood. To my surprise it was, workable. There was a lot of clean up, but now that the work is done, it will be a good base of operations.There is, however a hitch.The last thing I expected was to have the Venture Co. at our doorstep, that was one detail we did not hear, and now that we are set up they keep moving more, and more people into Windshear Crag. If we ever want to have a chance to explore, do so without constant protection we will need to remove this threat.Down the hill is Windshear Crag, it is there that the Venture Co. operate, head down, and remove their threat, on my behalf.",
  ...
  [40703] = {
    ["D"] = "...I fade, in and out of existence, my spirit is drawn to this world by foul powers, with my kin having much worse of a fate in Westhaven.During the Third War, Kul Tiras waged war against the Horde, it was the orcish kin who came here, and left this place in ruin. We settled again after this conflict, only for an orcish warlock to bring havoc in his wake..He goes by the name Bar\'thog, his foul, and horrific magic having raised the dead, leaving those who once lived here to shamble and fight on his behalf.End this curse, and free us from suffering.",
  ...
  [40705] = {
    ["D"] = "We\'re way off schedule, and now we\'re missing supplies.One wrong turn and everything turns belly up! Hey wait a second, you look like you can handle a few Quilboar. We almost walked directly into the dreaded Bramblethorn Pass, luckily for me I realized it when the stinking pigs came running at us! I turned everything around, and big Hork here scared them off, not before they took a bunch of supplies from our wagons though...If I am to keep my job I need those supplies back, maybe you can help me out.Head to the north west of here, into Bramblethorn Pass down the road, and gather eight Stolen Crates.",
    ["O"] = "Gather 8 Stolen Crates from Bramblethorn Pass for Gizzin Wildbucket in Stonetalon Mountains.",
    ["T"] = "Back on Track",
  },
  [40706] = {
    ["D"] = "The devastation caused by the Venture Co. knows no end, each day we hear more and more news of sheer horror. The balance of nature is a delicate matter, one that must be handled with caution.The Venture Co. cares little about nature, or anything but greed, their actions are directly responsible for much of the suffering of the land, and most recently, I have heard of their most terrible operation yet.To the South west, just north of the Charred Vale is a new passage way into the mountains, this passage leads to the Blacksand Oil Fields.The land there is ripped apart, and it is dominated by a large oil platform.Find a way to cease this operation, for the good of all.",
    ["O"] = "Put an end to the operations at the Blacksand Oil Fields for Silmaron at Stonetalon Peak in Stonetalon Mountains.",
    ["T"] = "An Affront to Nature",
  },
  [40707] = {
    ["D"] = "The Venture Company have long been enemies of us druids.They care little for the world around them, and only work for greed. If we are to ever put an end to them then we must match their brutality.There is too much at stake for us to stand idle, and for this reason, I ask you to collect Blacksand Badges, given to employees working at the Oil Fields.You can find this misbegotten place just northwest of the Charred Vale, through a passage way in the mountains.Go there, and put an end to this madness.",
  ...
  [40708] = {
    ["D"] = "Greetings $r, I am Archmage Talyvanah representing Dalaran. As you may be aware, our city suffered much in the third war.Dalaran is currently still rebuilding but there are reagents we need from the outside world.Nexus Crystals in particular are essential for high level enchants. If you can get me a sample, you will earn a lot of favor with my nation.",
  ...
  [40712] = {
    ["D"] = "Well met, you that wanders the lands of my ancestors. As the last keeper of this temple, I welcome you to the temple of Zeth.Behold the flame of kings, stranger. Gaze into it, perhaps it will tell you of the future as it told me of this day, for I was one of the few to keep their sanity only to wait for this day to come. Understand me, stranger, I do not know your name, and even with sight beyond sight before me stands exactly what you see when you look at me. A ghostly figure with no shape whatsoever, and yet, the fire spoke so many moons ago. Be it fates hand or simple coincidence, you were sent to aid me, and you will do so, either by the kindness of your heart or simple curiosity.The curse of Zetharia still haunts Corthan, as we speak the spirits are getting ready to strike you, as they do not see you for who you are but a memory of an enemy which has passed a long time ago. If we are to continue our discussion you must make sure to dismiss them.",
    ["O"] = "Slay 7 Ancient Warriors for the Forgotten Keeper at the Ruins of Zeth in Badlands.",
    ["T"] = "In Your Own Defense",
  },
  [40713] = {
    ["D"] = "This land was once ruled by many kings, each strong enough to contest, and dominate the landscape with a fist of iron, and strength eternal.To understand what it is I speak, I ask of you to travel to the lost city of Corthan.To the west, search within the mountains, it is there you will find what is left of what once was. At the very top, amongst the temple, you will find a gong, take this mallet, and ring it to begin the cycle of our end.I trust you will do what is right.",
  ...
  [40715] = {
    ["D"] = "To break the curse, Zetharia must meet her end. Although I feel remorse for sending you to end my own daughter, we must be freed and rid of this curse....Yet I have no idea where she could be, but I know who will. Buried under these red rocks lays the tomb where our last king yet remains. I pray he has kept his sanity, and that he will know of her location.March south wanderer, and look for something that I assume will to the naked eye look like a crypt today, it is there you will see the last stand of Corthan.",
    ["O"] = "Find the Marauder-King Corthan.",
    ["T"] = "The Last Corthan",
  },
  [40716] = {
    ["D"] = "I am Corthan, last of my name, Marauder-King of a fallen kingdom.During our last stand, my Keeper told me that even if we are to suffer the curse of undeath a day will come when one from future generations may stumble across us. I suppose he filled your mind with the promise of destiny and fate, but to my eyes, I only see this as a greater coincidence in the grand scheme of all things.You do not strike me as a hero of legend or some great adventurer, and I am not particularly sure why you\'d go to such lengths to aid us. Not that I am against it, and surely I am grateful. I suppose the seed of curiosity was planted and you truly wish to meet Zetharia, the one who could cause all this.No matter how this turns out, you will be the last living being to ever lay eyes upon me. There is a book within this room, it contains our history. I wish for you to take it, and place it somewhere to be remembered.",
    ["O"] = "Collect The History of Corthan from the crypt where Corthan rests.",
    ["T"] = "A King\'s Plea",
  },
  [40717] = {
    ["D"] = "I feel pride. The fire that had settled before has once again been fueled. It\'s time for my last order. $N, I command you to find Zetharia and this nightmare. As a last gift to my people, the Lord of the Living Flame has granted me the way to find her.Far to the south west in these lands and atop the rocks, she lingers, forever searching for new souls to torture. Make sure you succeed, if not she will probably torment your soul for generations, as she did to me and my people.",
    ["O"] = "Kill Zetharia for Marauder-King Corthan and put an end to the Curse of Zetharia.",
    ["T"] = "Undoing the Curse",
  },
  [40718] = {
    ["D"] = "I\'ll do the talking since you don\'t really seem to feel like it. Listen $N, we don\'t want a conflict with Theramore, that would mean we spit on our Warchief\'s honor.While we\'re talking, remind yourself of one thing, it is not friendship, but respect we hold for them.",
  ...
  [40720] = {
    ["D"] = "So.. It would appear our sound reasoning was proven incorrect.This is sometimes quite common for goblin engineering, as much as we hate to admit it. Either way, maybe this helped clear up some things for the investigation.If I was a gambling goblin, I surely would have placed a wager on those dang dragons. It is a good thing I am not foolish enough to gamble!Bring this information to Kagoro, surely he has use for it!",
    ["O"] = "Bring the information to Kagoro near Shady Rest Inn at Dustwallow Marsh.",
    ["T"] = "Conclusive Evidence",
  },
  [40721] = {
    ["D"] = "Theramore, and Falgran have once again requested a meeting. He has returned with new evidence, where we have met a dead end.Hopefully Falgran found out more than we did, because truthfully we still got nothing.",
    ["O"] = "Assist Kagoro with the meeting.",
    ["T"] = "Tedious Diplomacy Once More",
  },
  [40722] = {
    ["D"] = "Sellick Voss.I have not heard of the human, but his actions reek of dishonor, and cowardice. He hides deep within an encampment, hidden in the swamp.<Kagoro grunts his disapproval.>We must make ourselves useful, to show our might within Dustwallow Marsh. If we have an opportunity to kill Sellick Voss, and bring peace between Horde, and Alliance, we shall.Gather what friends, or mercenaries are available, and scour the swamp, find Sellick Voss, and bring his Medallion to Krog at Brackenwall Village.",
    ["O"] = "Find, and slay Sellick Voss, bring the Medallion of Voss to Krog at Brackenwall Village as proof.",
    ["T"] = "Justice for Dustwallow",
  },
  [40723] = {
    ["D"] = "We have done our part within these swamps, and now we should make things right with the Alliance. Take this Medallion to Falgran Hastil, the scout who was meeting with Kagoro.He can bring this token back to their leaders, and let them know of our assistance.",
    ["O"] = "Bring the Medallion of Voss to Falgran Hastil on the road between the Shady Rest Inn, and Brackenwall Village.",
    ["T"] = "Honoring Treaties",
  },
  [40724] = {
    ["D"] = "The Highvale Gorillas have terrorized Tel Co. , attacking our property and sending us all the way back to this here Basecamp. They used to be in the surrounding forests, attacking our walls and fortifications, but as of recently, they returned farther north.I know they are plotting something.You look tough kid, maybe you can deal with these banana eating savages. You can find them up north near the Highvale Rise, and around the Derelict Camp, travel there, and get me 12 Highvale Paws from the Gorillas there.",
    ["O"] = "Gather 12 Highvale Paws from the Highvale Gorillas on Tel\'abim for Sneel Fizzwack at Tel Co. Basecamp.",
    ["T"] = "The Ape Bounty",
  },
  [40725] = {
    ["D"] = "Ever since our operations have slowed more and more murlocs have gathered to the beaches. These murlocs are posing a direct threat to the Basecamp, and making it harder to venture out.If we ever want to establish work once again they will need to be dealt with, and dealt with seriously!Look around the beaches and you will find their hovels packed together all around the island. Find those grubby murlocs, and gather twenty of their claws, return them to me, and I\'ll make sure you\'re paid bub.Easy yeah?",
    ["O"] = "Collect 20 Spitefin Claws from murlocs around Tel\'abim for Sneel Fizzwack at Tel Co. Basecamp.",
    ["T"] = "The Spitefin Bounty",
  },
  [40726] = {
    ["D"] = "Blasted valve, each and every day we are having more leaks from the main water pump, if Tel Co. Basecamp is to last, it needs a supply of fresh water, regardless of what Telraz or Nokrot say.Many of our backup parts were located far to the north of the island at Bixxle\'s Storehouse, but there has been -very- little traffic between us and them since, well, everything fell apart.I need you to head there, just follow the road all the way north, and rummage around for the \'Backup Seal-Valve\', Bixxle should have plenty, just look around for a crate labeled with the name, and return it to me, simple yea?",
  ...
  [40727] = {
    ["D"] = "It\'s getting difficult to maintain repairs on much of the machinery, especially with all of the chaos recently.I am experienced, but I am lacking a lot of my tools bub, you know how hard it is to work with a spanner when you really need a Spin-wrench?Just to the north of here is a place called \'The Derelict Camp\', well at one point it wasn\'t so derelict, we had many operations there, wood cutting, banana collecting, and much more. It is there I lost my toolbox with all my gizmos and I want it back.You can find the camp on the western edge of the island, follow the road up north, and you\'ll find it.",
    ["O"] = "Travel to the Derelict Camp and recover Wazlon\'s Tools for Wazlon Headiron at Tel Co. Basecamp in Tel\'abim.",
    ["T"] = "Derelict Supplies",
  },
  [40728] = {
    ["D"] = "I didn\'t think you had it in you, you certainly aint no ogre, but you did survive, and bring me those paws as proof.If we want to -really- deal with the problem, we need to fight it at the source. All of the apes come from Highvale Rise, the giant mountain at the center of Tel\'abim. It is there you will find the biggest, and strongest of their packs.Travel there, and slay fourteen Elder Highvale Gorillas, that should put a dent in their aggression, and maybe even save some wise goblin minds.",
    ["O"] = "Slay 14 Elder Highvale Gorillas around Highvale Rise on Tel\'abim for Sneel Fizzwack at Tel Co. Basecamp.",
    ["T"] = "Highvale Rise",
  },
  [40729] = {
    ["D"] = "My research has only just begun and already there are so many possibilities it is making my head spin!What do you mean you have no idea what I am talking about? I am trying to discover the secrets of the Gargantuan Banana, rumor has it that they used to grow on Tel\'abim long ago, that was until they were all harvested.Now all that remains is myth and legend, but I will get to the bottom of it!My first hunch comes from strange banana\'s grown on the island just off the coast to the east, I haven\'t really had much luck, murlocs you see are all along the coast, and I am but one gnome, perhaps you can go there, and gather me three samples of the \'Strange Tel\'abim Banana\' that grows there.",
  ...
  [40730] = {
    ["D"] = "Those bananas from the island were warped, not like the Ripe Tel\'abim Bananas on the island here, but something deformed.It seems we must turn to a different solution, but I am running out of ideas all cooped up in this Shack alone.Why don\'t we try something, obvious. What if you procured an Elixir of Giant Growth, and we just, simply poured it over the banana, its worth a shot, right?",
    ["O"] = "Gather an Elixir of Giant Growth for Tazzo Gearfire at Tazzo\'s Shack in Tel\'abim.",
    ["T"] = "Early Testing",
  },
  [40731] = {
    ["D"] = "Well, I am stumped, All of my ideas either end up worthless, or failed. There must be something that I can...<Tazzo\'s eyes blink back to life, but soon a sigh escapes him.>There is something actually, I just remembered. A \'friend\' of mine named Leezza used to work far in the north. When we were on better terms she once told me about seeing a ridiculously large banana, too big for her to move.This has to be what we\'re looking for, but if we want this information, I know its going to cost me an arm and a leg... You could go to Tel Co. Basecamp, speak on my behalf, aside, I don\'t really got any gold, and I know she will ask.",
    ["O"] = "Find a way to buy the information of the Gargantuan Banana from Leezza Fraxtoggle at Tel Co. Basecamp. in Tel\'abim.",
    ["T"] = "A Costly Favor",
  },
  [40732] = {
    ["D"] = "Hello again mule, ready for work?I will be honest, I aint sticking around on this rock as Tel Co. burns to the ground, and to get my way out, I need materials, ones a goblin can\'t find back on Kezan. All around the jungle are these flying serpents with wings. They go by the moniker \'Venomflayer\', you see, they have a really potent Sac deep within them, and it is this Venomflayer Sac that I am looking for. Lets make it eight of them, bring me eight, and I\'ll tell you about this stupidly large banana.",
    ["O"] = "Collect 8 Venomwing Sacs for Leezza Fraxtoggle at Tel Co. Basecamp in Tel\'abim.",
    ["T"] = "Two Favors For The Price of One",
  },
  [40733] = {
    ["D"] = "I suppose you did me a few favors, and paid that gold that Tazzo owed me.Whenever you\'re ready to hear my tale, let me know, and then you can bring that to Tazzo like a good mule.",
  ...
  [40734] = {
    ["D"] = "Nestled deep within the largest of the Jagged Isles, tangled in roots and bushes, It\'s almost like we\'re finding a relic lost in time!<The gnome looks absolutely eager and excited with the information.>If that is the only Gargantuan Banana left, than I must have it. I want you to recover it, and bring it here, if I had a chance to study an actual Gargantuan, I could possibly even work to replicate it!Head north, immediately, and find that banana!",
  ...
  [40736] = {
    ["D"] = "It took me a little bit, but I was able to fully analyze our specimen. It really is a marvel of nature, full with nutrients and extremely dense.After studying and taking notes I believe I may have some ideas on how to replicate such a feat. Firstly, I will need enchanting materials, their arcane properties will be maniputed by yours truly. Secondly, I need Ripe Tel\'abim Bananas, they are scattered around the island, get me five of them.Once you have gathered everything, we can do our final testing.",
  ...
  [40737] = {
    ["D"] = "So, it appears some of these materials are not exactly cooperative with what I am trying to do, that said I think I may have figured it out!It appears that Dream Dust, with the Banana, and some arcane energy could indeed produce what it is we are looking for. All I need to do is one final test to make sure everything works properly, so stand back, and speak to me after the experiment.",
    ["O"] = "Wait for Tazzo Gearfire fo finish his experiments at Tazzo\'s Shack in Tel\'abim.",
    ["T"] = "The Final Test",
  },
  [40738] = {
    ["D"] = "I can\'t believe we were able to do it, but if there is anyone to thank aside yourself, it has to be Danonzo, he convinced me to continue my work and even vouched for me to stay here at this shack.He has been wanting to work on a unique recipe for a while now, aparently he is having trouble thinking of something, well, special.Perhaps a Gargantuan Tel\'abim Banana will help him!",
    ["O"] = "Bring a Gargantuan Tel\'abim Banana to Chef Danonzo Laxjolt in Tel\'abim.",
    ["T"] = "News for Danonzo!",
  },
  [40739] = {
    ["D"] = "So, back around to get another Gargantuan Tel\'abim Banana are you? I know, the flavor is spectacular, I couldn\'t get enough of it!All I require is three Ripe Tel\'abim Bananas, and a single Dream dust, once you provide me with that, I can make one for you, yes, it\'s that easy!",
    ["O"] = "Gather 3 Ripe Tel\'abim Bananas and 1 Dream Dust for Tazzo Gearfire at Tazzo\'s Shack in Tel\'abim.",
    ["T"] = "The Tel\'abim Banana Transmutation",
  },
  [40740] = {
    ["D"] = "I have refined my process, and even expanded my lab, the ability to create multiple Gargantuan Bananas at one time is now possible, all I need of course is the required materials to make it happen.To make five it should take fifteen Ripe Tel\'abim Bananas, as well as five Dream Dust, if you ever need this much banana, come to me, and I\'ll make your dreams come true.",
    ["O"] = "Gather 15 Ripe Tel\'abim Bananas and 5 Dream Dust for Tazzo Gearfire at Tazzo\'s Shack in Tel\'abim.",
    ["T"] = "Tel\'abim Transmutations!",
  },
  [40741] = {
    ["D"] = "If you\'re wanting to help kid, then buckle up. First things first though, I need bananas! Wheelbarrows full of them, buckets full of them, barrels full of them!We have a shipment due to Kezan in a months time, and all my workers are unable to venture into the jungle. Without those bananas, there will be no more Tel Co.Without Tel Co. there will be no more bananas seen around the world, do you see how serious this is?!Now, I know you\'re much more brave than the others, so why don\'t you go out, and get me 18 ripe bananas. That way we can at least fulfill our next shipment on time.",
    ["O"] = "Gather 18 Ripe Tel\'abim Bananas on Tel\'abim for Baron Telraz at Tel Co. Basecamp to help him make his schedule.",
    ["T"] = "Shipments on Time",
  },
  [40742] = {
    ["D"] = "If we ever want to get back to work, we need to make sure things are safe again. The apes are not my workers biggest concern, it is those snakes, do you believe that?All of my workers are more terrified from those Brushtails, rather then the massive gorillas.Goblins right?They slither in the brush and attack at dark, they need to be dealt with.Once this monkey threat is dealt with, there will still be snakes, and I hate snakes, why don\'t you deal with them for me? The Brushtail Adders and Cobras are aggresive, attacking anything in sight. Remove them, and maybe my workers will have more courage to pick bananas.",
    ["O"] = "Slay 8 Brushtail Adders, and 8 Brushtail Cobras for Baron Telraz at Tel Co. Basecamp on Tel\'abim.",
    ["T"] = "The Work Must Continue",
  },
  [40743] = {
    ["D"] = "Winter, a time to eat, and eat well! I always love to try new foods, and exchange cultural foods of my people with others. Perhaps we can make a trade yes? I would like to sample some of the foods of other races, you find some and I will offer you a special dish in return.Gather me a variety for me and my people to enjoy in feasting, and I will make sure you are well rewarded for your seasonal spirit!",
  ...
  [40745] = {
    ["D"] = "Those little, thieving, coniving Grell, they pulled the snow over my eyes this year when I was least expecting it.They stole my gift right out from beneath my nose. Though I will admit, I was a bit drunk, and awoke to find it missing, but that is here nor there.I have good suspicion that it is the Grell to the south west who are responsible. Trust me, this gift means a lot for me, and I really want to give it to someone special, do you think you could recover it from their camp for me?",
  ...
  [40747] = {
    ["D"] = "Huh, what are you doing here, I don\'t recall you being on any lists, or expecting anyone on the island here.Did Mr. Shang send you, or Dragunastrasz?I assume you must be new here, a programmer like the others no doubt, we go through them quick around here with all the bug reports.When you\'re ready to begin, speak to me, and I\'ll issue you a set of Programmer Socks.Yes they are required.",
    ["O"] = "Speak with Jamey to obtain the Programmer Socks.",
    ["T"] = "A Programmer?",
  },
  [40748] = {
    ["D"] = "What a better way to cap off the end of a long year other than drinking? Of course, the best of the best only makes the celebrations better.You heard tales of the Winter Veil Brew I made a few seasons past? Oh, it surely was magical, probably the best batch I made in my wee life.Those dastardly Dark Irons stole it, no doubt hidden away in their tavern deep within the Blackrock Depths.You recover it, and I share some of it, that sounds like a deal, yeah?",
  ...
  [40750] = {
    ["D"] = "<Aneka furrows her brow for a moment as she reads.>This is written by an exile of my people. A senshi that was afflicted by soul rot who fled the island trying to find a cure, she was filled with regret for abandoning her oath and home. It seems she was attempting a ritual to cure herself but evidently failed in doing so since you are here.Soul rot is an affliction that happens when someone is tainted by the dark Kami. Evil beings that only seek to corrupt, twist and destroy, with the ultimate aim of stealing one\'s soul. Return where you found the parchment, and seek out a totem near the dwelling, you may receive further guidance there.",
    ["O"] = "Find a totem near the abandoned house in Tel\'Abim.",
    ["T"] = "An Exile\'s Regret",
  },
  [40751] = {
    ["D"] = "<A female voice seems to penetrate through your mind.>The beast seeks to end... everything that I am. As I prepared the ritual site after years of work, one of the naga slew me, and my bones were taken. Reclaim my bones, from the slithering foe, and find someone who can help me.",
    ["O"] = "Gather the Senshi Bones from the Wave Crest Explorers, once collected, bring the bones to Aneka Konko at Ratchet.",
    ["T"] = "To heal a Soul",
  },
  [40752] = {
    ["D"] = "Now, where to begin, so many ideas, so many possibilities, why not a tried and true classic, with a twist. Banana bread is a staple to some and quite delicious, but Danonzo can put a twist on things.Enfusing the Gargantuan Tel\'Abim Banana into the bread with a dash of Heart of the Wild can calm the nerves and much a keen aftertaste that lingers upon the tongue.Gather me the ingredients, and I can prepare it at once!",
    ["O"] = "Gather a Gargantuan Tel\'Abim Banana, a Heart of the Wild and a Soothing Spices for Chef Danonzo Laxjolt at Tel Co. Basecamp in Tel\'abim.",
    ["T"] = "Danonzo\'s Tel\'Abim Surprise",
  },
  [40753] = {
    ["D"] = "My mind is flooding with ideas, so much to choose from, so much to do! I got it why don\'t we create a wonderous stew, the Gargantuan Banana itself is surely capable of producing a wonderous cream.A creamy broth served hot with fresh chunks of grilled banana overtop, now doesn\'t that sound magical!All I need is a Gargantuan Tel\'Abim Banana, a Mountain Silversage and a Soothing Spices, bring them to me, and we can get cooking kid.",
    ["O"] = "Gather a Gargantuan Tel\'Abim Banana, a Mountain Silversage and a Soothing Spices for Chef Danonzo Laxjolt at Tel Co. Basecamp in Tel\'abim.",
    ["T"] = "Danonzo\'s Tel\'Abim Delight",
  },
  [40754] = {
    ["D"] = "Oh how the other goblins of Kezan will bask in the awe of my genius once they discover all of the recipes in my mind. My idea of a cold Banana cake filled with banana cream is the next on my mind, that sure does sound delicious, does it not?Cooked at a high heat with a seperate filling added later and cooled after completion will add quite the punch of flavors, its just missing one thing... I got it!Gather me the following ingredients, and I can get to work, A Gargantuan Tel\'Abim Banana, an Essence of Air, and a Soothing Spices, once you acquire them, I can get started.",
    ["O"] = "Gather a Gargantuan Tel\'Abim Banana, a Essence of Air and a Soothing Spices for Chef Danonzo Laxjolt at Tel Co. Basecamp in Tel\'abim.",
    ["T"] = "Danonzo\'s Tel\'Abim Medley",
  },
  [40755] = {
    ["D"] = "Look, I have a favor I need to ask, and one that is really important to me. Do you know the meaning of sunk cost fallacy? Well, in my world it\'s completely true. I have spent years, and buckets of gold working on a machine that can sort bananas on being worthy to collect or not. It is able to judge ripeness, age, and all sorts of factors to determine if it is worth our time to collect.Let\'s just say, the buffoons that I sent it out with, got lost, and left it at the camp to the east of here.I don\'t have a bunch of people to waste getting ripped apart by Venomflayers to go get it themselves, so why don\'t you do it? Recover the Screwfuse 1000 and be sure to bring it back gently, it should be down the road to the east, at a small abandoned camp.",
    ["O"] = "Find and recover the Screwfuse 1000 for Bixxle Screwfuse at Bixxle\'s Storehouse on Tel\'Abim.",
    ["T"] = "Operation Screwfuse 1000",
  },
  [40756] = {
    ["D"] = "Those, absolute idiots!The entire mechanism is broken, my backup Arcane Regulator, and my Spingadge Flange are both broken. Do you know how long it took to acquire such rare parts, special ordered from Kezan!If only they were still alive, I\'d be the one to send them to whatever misbegotten afterlife they are rotting in. I have only one source for rare goods from Kezan, and I need you to speak with him. He goes by the name \'Jabbey\' an alias of sorts, he is an undercover operative from Kezan and works through various back channels, go speak with him, and let him know -Bixxle- sent you, bring him this list of items.",
    ["O"] = "Speak with Jabbey at Steamwheedle Port in Tanaris.",
    ["T"] = "Operation FIX Screwfuse 1000",
  },
  [40757] = {
    ["D"] = "<Jabbey looks at the list with an expression of disbelief, and laughs.>Haha! He thinks I am going to give out such valuable items that easy? Look kid, these things are rare, and extremely valuable, but if he needs them, and wants them, I have a favor I need completed before I even consider forking over something like that. Easy yeah?I did some business with one of those Dark Iron types, he went by the name \'Darneg Darkbeard\' lets just say I leant him a considerable amount of potent goods to sell. I haven\'t heard back at all from him, and I have confirmation that I was swindled. I need you to travel to Blackrock Depths, and into Shadowforge to recover the \'Extremely Potent Snuff\' from him. He should be somewhere in the Domicile there.",
  ...
  [40759] = {
    ["D"] = "Nice job in getting all that stuff for me, didn\'t take all too long as well, Kezan could use some individuals like you.Now, I boxed that fool Bixxle\'s goods, take them to him, and be quick about it, I\'ve had you linger around here too long, last thing I want is people to catch on about my business, got it?",
    ["O"] = "Bring Bixxle\'s Expensive Parts to Bixxle Screwfuse at Bixxle\'s Storehouse in Tel\'Abim.",
    ["T"] = "Operation Return to Screwfuse",
  },
  [40760] = {
    ["D"] = "Now that I have all the materials, I just need to put in the last bits of repairing, and for that, well I\'m going to need more materials.I hope I am not being too much of a bother, but do you mind getting me some engineering supplies? I need the following, six Thorium Bars, a Gold Power Core, some Fused Wiring, and a Thorium Widget, with all of that I should be able to fix the Screwfuse 1000.",
  ...
  [40761] = {
    ["D"] = "Hey look, you did me a real solid, and I still owe you for everything you\'ve done. You wouldn\'t be happen to be in the market for a gun would you? I don\'t just mean any gun, I mean a Dark Iron Desecrator. I have someone that owes me quite a lot of favors for help I offered to bring them to Steamwheedle for rare goods.If this is something you\'re interested in, just know it will take some work to acquire. If this has your interest, then speak with Gelweg Darkbrow, let him know I sent you, and that I am asking for the plans.",
  ...
  [40762] = {
    ["D"] = "Well, these plans are much more complicated than I first estimated, so many rare materials, most of which are not so easily available...First off, we will need to get a stock Dark Iron Rifle, they can be crafted by engineers with the know how to make one. Secondly, I need a Magma Condensor from within Blackrock Depths, you can find it near the Golem Laboratory. Thirdly, I require a Intricate Arcanite Barrel which can handle extreme heat. This can be found deep within Lower Blackrock Spire, near the Quartermaster there.Lastly, and most difficult to find, I need a Molten Fragment. This item can be acquired from Molten Destroyers in the depths of the Molten Core.To finish the construction, I will also need three Fiery Core found in Molten Core, and ten Enchanted Thorium Bars.Once your collect these goods, come to me, and I can get started.",
    ["O"] = "Collect a Dark Iron Rifle, a Magma Condensor, a Intricate Arcanite Barrel, a Molten Fragment, 3 Fiery Cores, and 10 Enchanted Thorium Bars for Bixxle Screwfuse at Bixxle\'s Storehouse in Tel\'Abim.",
    ["T"] = "The Dark Iron Desecrator",
  },
  [40763] = {
    ["D"] = "Yo $r, fancy seeing a capable adventurer out here! Interested in some work? You see, when Tel co. came here, this place was deserted. Just monkeys and bananas.But that wasn\'t the case before, you know? Thousands of years ago, this island was a mountain range on the border of nations, and there\'s sure to be riches hidden here. To begin with, my surveyors have discovered some ancient Zandalari ruins on the northern coast dating back over ten thousand years.The ruins are infested with the restless ghosts, as a muscle, go there and slay those ghosts, and bring any tablets and writing you find. I\'ll make it worth your time, promise, yeah?",
  ...
  [40764] = {
    ["D"] = "Ten thousand years ago, the Zandalari were competing against a civilization known as the Azotha. Their struggle was put at an end when the world was shattered, and oceans swallowed a large chunk of the ancestral landmass. Tel\'Abim just happens to be a region where the two clashed.The Trolls seem to have lost the skirmish referenced on this tablet, and it mentions Trolls being sacrificed to the gods at the ritual site, their riches buried. This means there could be GOLD buried under this ritual site! And we may even have found it.Head to the western-most isle of the Jagged isles and search for an obvious ritual site, when you find it, start digging!",
  ...
  [40765] = {
    ["D"] = "We lost our communication with the Derelict Camp and Bixxle\'s Storehouse a few weeks ago. Bixxle\'s Storehouse was the key to profit for our northern harvesting. If we are ever to start up again, I need to know that the place isn\'t a wreck and covered in monkeys.More importantly, Bixxle was a logistical mastermind, as much as his focus tends to drift towards engineering useless contraptions.Head far to the north, to Bixxle\'s Storehouse, follow the road, it should take you right to it, see if Bixxle is alive.",
    ["O"] = "Head to Bixxle\'s Storehouse in Northern Tel\'Abim and report to Bixxle if he is still alive.",
    ["T"] = "Finding Bixxle!",
  },
  [40766] = {
    ["D"] = "Well, here we are, still very much alive and kicking. We did have our fair share of encounters with the local wildlife.I prepared a report to Baron Telraz, bring it back to Tel Co. Basecamp, it\'ll let him know we\'re still kicking up here, whenever he brings in the big guns to clean things up.",
    ["O"] = "Bring Bixxle\'s Report to Baron Telraz at the Tel Co. Basecamp in Tel\'Abim.",
    ["T"] = "A Report From Bixxle",
  },
  [40767] = {
    ["D"] = "Hey there pal, you mind lending a hand?We got all sorts of trouble with these Venomflayers lurking in the area, hell they are already responsible for a few of our casualties. If you could do me a favor and rid the local jungle of a few of \'em, that\'d make our lives a whole lot easier.You can find them pretty much all over to the west, and south west, remove twelve of them, and return to me when you\'re done.",
    ["O"] = "Slay 12 Venomflayer Serpents for Zalwiz Hardlug at Bixxle\'s Storehouse in Tel\'Abim.",
    ["T"] = "Final Flight of the Venomflayer",
  },
  [40768] = {
    ["D"] = "Each day more and more Naga take to the shores of the surrounding islands, they are gathering and for what purpose I do not know.I would rather have them dealt with now, than in a week when there are hundreds of them. I have heard tales of just how quick they can infest an area with their presence.You can find them all around the surrounding Jagged Isles to the north, find them, and kill them, bring me twenty of their scales as proof.",
    ["O"] = "Gather 20 Wavecrest Scales for Zalwiz Hardlug at Bixxle\'s Storehouse in Tel\'Abim.",
    ["T"] = "Intercepting Wavecrest",
  },
  [40769] = {
    ["D"] = "It has been a long time since I worked on anything worthwhile, and let me tell you, I am desperate for some real work. I have been stranded here on Tel\'Abim to be nothing more than a glorified repairman now for a while.My inner blacksmith calls to me, and I want to work on something unique before I go insane. Long ago when I worked at Everlook I was fascinated with the Chillwind Chimaera, extremely powerful creatures that roamed the snowy tundras.There were rumors floating around about rare Frostwoven horns that have been growing on a few of the creatures, I\'d like to get my hands on one, and harness it into armor, think you can do that for me? You can find Chillwind Chimaera out in Winterspring, far to the north of here.",
  ...
  [40770] = {
    ["D"] = "Ebu helps protect tribe, tribe in danger! Long time monkey fight murloc, murloc always near monkey, always attack monkey. I keep us safe, and I fight murloc.Maybe you fight murloc too? Kill big murloc too, for Ebu, and friends, we thank you for help!",
  ...
  [40771] = {
    ["D"] = "Friend stolen from tribe, murlocs stole friend, you help us, yes?Friend near murloc camp, recover friend, save friend from murlocs, before too late! You do yes, you help yes? Nibu strong monkey, save Nibu, help tribe!",
    ["O"] = "Save Nibu from the murloc camps on The Jagged Isles for Ebu in Tel\'Abim.",
    ["T"] = "The Missing Friend!",
  },
  [40772] = {
    ["D"] = "Not all of us yetis are evil, there was a time when my kind stood along side the great tree and offered presents to the denizens of Azeroth. Such a time has passed, and many of the yeti now walk a darker path.To the south is their den, to which they house the evil Snowball, uttering such a name chills even me. I desire you to lessen their ranks, and to let those that celebrate do so in peace without the worry of evil undoing good.",
    ["O"] = "Slay 8 Abominable Snow Yeti for Coldhowl in Winter Veil Vale.",
    ["T"] = "The Abominable Yeti",
  },
  [40773] = {
    ["D"] = "Our scouts have confirmed new presence in the area of Felwood, foreign interlopers from a far off land, loyal to outside forces from a far away land.What they are doing here, I am unsure of, but who they are, I am certain.They are Blood Elves, loyal to their prince and the demon hunter Illidan. I am certain they are up to no good, and whatever plans they have, I would like to halt. You can find them gathered around an old statue of the betrayer near the Shatter Scar Vale just north east of Bloodvenom Falls, go there, and collect seven Blood Elf Badges.Perhaps they will get the message and return to where they came.",
  ...
  [40774] = {
    ["D"] = "The Royal Apothecary Society is always looking for new solutions to various problems, and new compounds with which to study and test upon.I have come to Felwood for such an issue, perhaps you can offer some assistance. All around the Bloodvenom Falls are oozes of a rather, noxious variety. From them I require Tainted Ooze Sludge for various research to be done back in Undercity.Collect fifteen samples for me, and I will pay you for the time, how does that sound?",
  ...
  [40775] = {
    ["D"] = "I require aid with a matter of most discretion, or rather I don\'t wish to be bothered giving answers to questions you\'d barely understand yourself.Although blessed be Elune you seem to either have lost your tongue or are an adventurer of fewer words, which is rather perfect for me.The task is quite simple. You must travel to the Bloodvenom Falls, slay the oozes around, collect their sludge and bring it back to me. Do this, speak nothing of it, ask nothing of it and you will be rewarded properly.",
  ...
  [40776] = {
    ["D"] = "My scouts report activity east of the Shatter Scar Vale, close to what few of my people are calling nowadays the Shrine of the Betrayer. A cold statue of the once magic wielder Illidan Stormrage, a name with heavy impact on our history, one who not many dear speak out loud. And yet I feel no fear of speaking the name of a being that no longer even inhabits these lands.Regardless, this is no history lesson, if you wish for one of those, I\'d advise you to find the closest lorekeeper or a library.  At the foot of this statue, a group of sin\'dorei has settled, perhaps they fled Azshara or were simply in hiding for this long. I remember the High Priestess aiding these mongrels that remind me of the reign of Azshara, yet her sympathy will no longer be the case.They seem to call themselves, the Illidari, and to me, they\'ve simply sealed their fate by foolishly admitting their connection to the Betrayer. Cull their numbers, these woods are already infected, and we need no more plague.",
  ...
  [40786] = {
    ["D"] = "The very forest itself is twisted, corrupted, all around us it festers, and lingers. The wildlife has been cursed to live such a woeful existance, teetering on the brink of madness, and rage. All the while enthralled by the great evil that poisons their hearts.I have been studying the wildlife here for some time, but I need more samples. As of recently I have discovered of a natural phenomenon taking place in Tel\'Abim, the enragement of the wildlife there has traveled even to this druids ears.I need to know more for a potential link and for that, I require hearts of the enraged basilisk, bring me five, I will make good use of the samples you bring.",
  ...
  [40787] = {
    ["D"] = "Ten long years ago, I was betrayed by close kin, a fellow Demon Hunter, one that I shared blood, and bread. He has returned to Felwood, his presence, and the presence of those he brings with him have already tainted what left there was to blemish in these lands.I have many grievances with the Demon Hunter known as Faladar Starsplinter, but most importantly is his thieving of a powerful artifact, one that is my namesake. The Darkwind Star was passed down to me from generations, holding a great power within. I need this artifact recovered from the cur, and I will require your aid to gain it.You can find Faladar Starsplinter at the Shrine of the Betrayer, located north west of Bloodvenom Falls, and south of Irontree Woods.Hunt him, and reclaim my rightful prize.",
    ["O"] = "Slay Faladar Starsplinter, and recover the Darkwind Star for Niremius Darkwind in Felwood.",
    ["T"] = "To Hunt The Hunter",
  },
  [40788] = {
    ["D"] = "Hey there, you wouldn\'t mind lending a hand would you? We conduct all sorts of research here in Everlook, and where theres research, theres coin to be earned. I had this side gig going on with a shipment from Tel\'Abim for a while now, but I haven\'t heard diddly-nothing, and I got a client that\'s been waiting around.You mind being, the third party here and clearing up this issue for me? I\'ll toss in some complimentary food or drink on the house. All I need you to do is head to Tel\'Abim far to the south of here, and find some of those Angry rock elemental types, they contain Heavy Earthen Cores, its those I need, eight of em.Make it lickity split would you?",
  ...
  [40789] = {
    ["D"] = "It has been a long, and exhausting trip, I have fought many battles, and waged many wars. I have yearned to see the Cathedral in Stormwind, I have heard tales of its rebuilding, when I heard the word I was to come here, rather than stay at the Embassy at Stormwind I will not lie to say it hurt my faith, for I fear I may not see it in the end of all this.In Kul Tiras, the light is not as much a pillar as it is in Stormwind, and Lordaeron. Places where the tradition of the faith had been long established, and founded.I would still like to pay homage to the Cathedral, and I ask you, outsider to do it for me. Bring this tome, with all of my deeds to the Cathedral of Stormwind, and let it be recorded, lest I fall on this forsaken edge of the western world.",
    ["O"] = "Bring The Deeds of Paladin Danuvis to the Cathedral in Stormwind.",
    ["T"] = "The Deeds of Paladin Danuvis",
  },
  [40790] = {
    ["D"] = "You there, RECRUIT!I don\'t see you wearing your tabard, what in- wait a second. What are you doing here $r, do you not see that we Kul Tirans are at a war?Bah, why don\'t you make yourself useful, we are going to be needing all the provisions we can account for, perhaps you can find some spare food to feed some bellies for a few extra nights.Each day we keep the Horde at bay, is another day you can sleep safe at night. How about some Kodo Meat from the beasts in the Barrens? The horde use the beasts as pack mules, fighting beasts, and breed them for food, their heavy flanks should serve well to feed a few squadrons.",
  ...
  [40791] = {
    ["D"] = "Nice work collecting that food recruit, you\'ve done good work, even if you\'re not apart of our navy. If you\'re still looking to help out around here, I do have one last thing I need.You see, as a Deckmaster, it is my job to secure, and guarentee supplies for the boat, and since we are docked here for some time, I called in a few favors that just need to be picked up.Down in Ratchet I have an order waiting for a barrel of Gunpowder, grab it for me, it should be tucked away on the left side of the bank there. Lastly, head to Theramore, it is a place that still holds many loyal allies, at the dock, there should be some docked ships, explore them, and find a crate stamped with a green anchor, bring that to me as well.",
  ...
  [40792] = {
    ["D"] = "It has been a long, and end extremely arduous trip for all of us. For many long months I have been making due but my stocks, and supplies are limited, what is worse, is my pool of magic is dwidling without a source to commune with the elements of water.If I am to reclaim my powers, and guide the fleet back to Kul Tiras once this conflict is over, I will need assistance from the elementals themselves.To the north west is a foreign land called Ashenvale, I have heard rumors of enraged, and befouled elementals of water around the Mystral Lake near the regions heart. Head there, and collect for me a Refined Aqua Core.Do not fret if this tasks takes some time, it will only come from the most pure of elementals.",
    ["O"] = "Collect a Refined Aqua Core from the water elementals of Ashenvale for Aquamancer Shaleborn at Anchor\'s Edge in the Barrens.",
    ["T"] = "The Power of Aqua",
  },
  [40793] = {
    ["D"] = "Kul Tiras is waging a war against the enemies of the Horde, there is no place for an outsider such as yourself in this conflict, but I have purpose for you outside of Anchor\'s Edge.During the Second War, Kul Tiras served, and fought hard against the orcish hordes, our main rival in this conflict were the Dragonmaw, a ruthless killing machine of vile, and disgusting Blackbloods, with only one concern in their vile minds. To kill.It was on the islands at sea that my father was slain, shipwrecked by Dragonmaw vessel, I desire revenge, and you shall give it to me.I have heard rumors from friends, and sources in Menethil Harbor of their presence still lingering in the Wetlands, head there, and bring me twenty of their heads.",
  ...
  [50005] = {
    ["D"] = "The magic is amazing, but still you will need the help of a good rogue if you want to learn how to open such difficult locks...$B$BI have an old friend who lives in the Ravenholdt Manor, hidden between the mountains in the northern part of Hillsbrad Foothills. I\'m sure he will help you with your learnings in exchange of some gold.",
    ["O"] = "Find Ol\' Biggins in the Ravenholdt Manor and pay him to help you with your learnings.",
  ...
  [50226] = {
    ["D"] = "",
    ["O"] = "",
    ["T"] = "Greatest Amount of Experience",
  },
  [50227] = {
    ["D"] = "",
    ["O"] = "",
  ...
  [50315] = {
    ["D"] = "Come, come, get your copy of the latest issue of Gadgetzan Times! Here you\'ll find out really breaking news!What? Oh, the news are … breaking!Very soon on the Shimmering Flats, which is in the Thousand Needles as you know, two most adventurous and most intelligent teams will compete in a captivating race, best known throughout the universe as THE MIRAGE RACES!",
  ...
  [50330] = {
    ["D"] = "Gremm is a warrior. Me task is protect. Winter Veil Vale is in danger.Big bad wolf is danger to the village. He attacks every few days. <Greem shows you three fingers.>You look like a hero! You can help! Find more gud warriors! Attack Snowball while he sleep! He\'s down there.",
  ...
  [55007] = {
    ["D"] = "The technicians of Sparkwater are always looking for more methods to optimize and make use of energy sources across Azeroth. We have quite a few people out on the field doing just that!I got a guy that\'s located in Azshara that I\'d like you to check on. He last was located within Valormok.Just make sure he\'s doing what I paid him to do. The last thing a goblin likes is wasted gold and wasted potential!",
    ["O"] = "Find Gazztoggle Krewpipe in the camp of Valormok in Azshara.",
    ["T"] = "Searching for New Methods",
  },
  [55008] = {
    ["D"] = "Oh, that\'s why you\'re here, yeah...I\'ve been knee deep in research and tinkering to try and find new methods of power and energy for Sparkwater.I\'ve ran into a few hiccups, mostly with Frix. He\'s been gone for a few days now and I haven\'t heard anything from him. Worst of all, I sent the guy with the only working Surveying Gear that we had!Last thing I knew was that he went south-west to the nearby elvish ruins to go take some surveys and readings around the Satyrs in the area. He\'s probably gotten himself killed, or worse, captured!Please go find him. If you indeed find his corpse, keep an eye out for the Surveying Gear I sent with him!",
  ...
  [55014] = {
    ["D"] = "Me and Frix had spent quite a bit of our time researching power sources out here in Azshara. and there is some stuff that seemed to pose quite lucrative ventures.To the south-west is more ruins, haunted and seemingly guarded by the passed ghosts of Highborne.I believe these spirits could very well be used as a source of power. You see, their essence is extremely potent. The only problem is, well, to get it from them.Head there and gather me the ghosts\' essences, and don\'t worry about being moral, they\'ll pass on to whatever fate awaits them!<Gazztoggle smirks to himself.>",
  ...
  [55015] = {
    ["D"] = "There\'s always new projects popping up, and subsequently turning up worthless!It seems this region is cursed, or I am, anyway, with my horrid luck.Frix is haunting me from the grave, but still, there are a few of our projects that I\'d like to see through.To the east lays the ancient Highborne city of Eldarath. Now you won\'t find any friendly elves, but instead twisted versions of them...Naga occupy almost the entirety of the ruins, it\'s mostly why me and Frix never bothered with pushing this project forward.Now with you around though, we can finally test it out! Go to the Ruins of Eldarath to the east. Once there, look for small shards of energy known as Eldarath Ley-Shards.",
    ["O"] = "Venture to the Ruins of Eldarath and find 5 Eldarath Ley-Shards.",
    ["T"] = "The Eldarath Project",
  },
  [55016] = {
    ["D"] = "Azshara seems hopeless, but for all that\'s failed and everything I\'ve tried out here I still have a few more things left to try.Within the region there is a species of hippogryph known as Thunderheads. They can be found all over the area but I\'m looking for the ones with the real power to get the best results!Far to the north-east near the very edges of the Azshara plateau are Thunderhead Skystormers. Now they\'re really the kingpins of the Thunderheads. Grab me 3 Skystormer Antlers, that\'s where they gotta hold their power.Bring em to me so we can test if they hold any ability for energy.",
    ["O"] = "Slay Thunderhead Skystormers for Skystormer Antlers far to the north-east of Azshara.",
    ["T"] = "The Skystormer Project",
  },
  [55017] = {
    ["D"] = "Ahh... It feels good finally having something to report. No doubt Grimzlow is pretty angry, given how long it took me to get back to him!The higher-ups in Sparkwater are going to need a report, run it up to them while I continue my work here!You\'re going to buy me some time to keep my work up, and keep getting paid!Maybe I\'ll even get a new assistant that isn\'t as bad as Frix, bless his soul.",
    ["O"] = "Take Gazztoggle\'s Report to Grimzlow.",
    ["T"] = "Report to Sparkwater!",
  },
  [55018] = {
    ["D"] = "I have one final project that I am calling The Big Energy Project, it has to do with the gathering of the Blue Dragonflight that has cropped up a while ago around the Lake Mennar to the south-east.It\'s not often that dragons get involved with much, but from what I\'ve learned, these blue dragons love their magic!If I can get my hand on some dragonkin\'s staff, just think of the possibilities!The orcs in Valormok have been talking a little about their presence and a new Lieutenant posted there. It\'s a good thing my long ears were able to hear the little details! Go find this Lieutenant and take his staff, he has to have one! Now, gather up a group of friends, or fellow adventurers, this is gonna be a big operation, not just something you can do alone.",
  ...
  [55025] = {
    ["D"] = "I\'m losing my mind down here. We\'ve been told to stay a bit under the roof for a while after the old Brightwater took a few cannonballs to the side.Been forced to stay in refuge for a few days now and I\'m going loopy! Aaah, if only there was a way to get some booze... Wait a second, you can get booze.Since we can\'t, make a trip up to The Salty Sailor and get me the following... Ahem...5 Jugs of Bourbon3 Flagons of Mead10 Flasks of Port...and 10 Cherry Grogs!",
  ...
  [55037] = {
    ["D"] = "I\'m in need of some help here. A whole damn lot of help!I was supposed to receive an order of Yeti Fur from a trusted source, but they up and went AWOL on me!Look pal, if you can help me keep my knees, and not go missing from Azeroth, that would be a huge help.To the southwest is a cave full of yeti. Damn near packed with them. Get me ten Yeti Fur. That should be more then enough to bring back to Laz. And please, be quick! We don\'t got all day here!I see you got the Yeti Fur. Let me box this up right quick to send to Laz!",
  ...
  [55050] = {
    ["D"] = "<Little Grizlik presses his knuckle to his chest.>Lok\'tar, $R! I\'m Grizlik, son of the Horde and future warrior of Orgrimmar!<The child flexes his scrawny arms, he almost seems cute.>Hey, don\'t laugh at me! Come on, I\'ve got a long way to go but the matron says if I put my mind to it, I too will have a big axe like the High Overlord, or who knows maybe shoot lightning like the Warchief!<Grizlik mimics a spell with his hands.>Pew, pew!Anyway, you seem like a boring elder, you won\'t play with me, right? Can I ask you for a favour? Please take this to Torm Ragetotem in Thunder Bluff. When he was here last time, he brought us toys and taught me how to use a wooden axe!Take Squeaks with you too, he wants to see Thunder Bluff. You can keep him, he\'s more the adventuring type anyway. I\'d be sad to keep him around forever if he wants to see the world!",
  ...
  [60010] = {
    ["D"] = "Hey, $r, down here! If you have some spare time, I could really use your help.You see, there\'s this kodo in Un\'goro Crater, their name is Dadanga. I\'ve heard that they give you a gift if you feed them bloodpetals. It sounds like this gift would have a nice surprise in it, and I love surprises!Anyways, these sprouts are found all over the crater, and I\'d love to get my hands on some. Bring me 30 bloodpetals and I\'ll pay you. I\'ll even give you something I cooked from one of my original recipes!",
    ["O"] = "You\'re pretty sure Reas wants you to bring 30 bloodpetal sprouts to her in Gadgetzan.",
    ["T"] = "Help A Gnome Out",
  },
  [60011] = {
    ["D"] = "Paladin! As protectors of the weak, we have a responsibility to cast justice upon the wicked. Countless times you will experience insurmountable foes, some ferocious and brutal while others act with cunning.One such enemy resides deep inside Elwynn Forest, at the very end of the Forest\'s Edge. The foul creature\'s name is Hogger. He surrounds himself with his gnoll underlings, acting as the alpha among them. Be careful not to get caught outnumbered.To bring justice to your adversaries, you must believe in the light to guide you. Bring along your trusted allies, venture forth and quench this evil before it does any more harm.May the light be with you!",
    ["O"] = "Defeat Hogger in Elwynn Forest\'s Edge.",
    ["T"] = "Piercing Light",
  },
  [60012] = {
    ["D"] = "Paladin! It is a great responsibility protecting the weak and cast Justice upon the wicked. There\'s a special case when you will face very powerful and too fierce enemies who rage, anger and determination might bring a downfall to either you or your company, and there is such a foe.He\'s known as Old Icebeard.To know the weaknesses of the enemies and bringing Justice you will need all prowess you can muster. Above all else you will need your faith in the Light more than ever and the Light shall grant you the strength.",
    ["O"] = "Defeat Old Icebeard west from Kharanos.",
    ["T"] = "Piercing Light",
  },
  [60013] = {
    ["D"] = "We would like to wish you all a wonderful holiday season. Thanks to all our turtles for your choosing this server and your continuous support.May the new year be one merry and bright!Happy New Year!",
    ["O"] = "Stay awesome in 2021!",
    ["T"] = "Happy New Year!",
  },
  [60020] = {
    ["D"] = "Ishnu\'alah, $C.$BNot long ago, a group of Sentinels was finally driving the Naga away from Solarsal. Unfortunately, that caught the attention of one of their champions and once she joined the fray they were quickly pushed back by her magic. Please, find and kill this Sea Witch. She can not be allowed to scour Solarsal of its arcane secrets and become stronger.The last we saw of her, she was heading towards the ruined temple located in the hill near the tallest tower.",
  ...
  [60036] = {
    ["D"] = "I\'ve heard rumors of some zealous fanatics that still reside within Stratholme. Alas, it is these kinds of fanatics that I require something from, a Righteous Orb to be exact for a new design I patterned long ago.I also need another kind of orb, a Flawless Draenethyst Sphere, I was told it has, unique properties from other designers.Problem is, I don\'t know where to get it, perhaps someone knows something about it, so ask around. For all we know it could be in some blasted land.",
  ...
  [60050] = {
    ...
    ["O"] = "Drop a coin in the Trade District Fountain in the Stormwind City for Teresa.",
    ["T"] = "Lucky Coin",
  },
  [60060] = {
  ...
  [60065] = {
    ["D"] = "Listen closely, for I have no time or strength to repeat, I\'m obviously dying here… Light … Elune, give me peace of death, I beg you…<Argent Watcher Mal\'adaris gazes on you with fierce intent.>Twenty of those horrors $R, and only one … it! Destroy\'em for all the living…<Argent Watcher Mal\'adaris points you directly to the north.>Cave … no, a tunnel… Don\'t go alone.",
  ...
  [60071] = {
    ["D"] = "Hey, $N, that was your name wasn\'t it?You probably know that we have some troll problems, so we decided to hire more adventurers such as yourself, sounds good right?Your first target will be the Witherbarks to the east of Aerie Peak, they\'re too close for comfort and they brew deadly poisons right at our doorstep! Are you up for challenge?",
  ...
  [60072] = {
    ["D"] = "Back for more, $N?There is still more to do and more rewards to claim. Your next target will be the Vilebranchs, we think they\'re preparing something big. Their chanting can be heard even from here! Go to the Altar of Zul to the southeast, and trim their numbers!",
  ...
  [60073] = {
    ["D"] = "Alright $N, we\'re chased the rats to their den. To the very southeast of the Hinterlands you\'ll find the troll city of Jintha\'alor. You\'ll encounter the very elite, practicing dark magic and foul practices.I know you\'re all powerful but I\'m not gonna lie, I don\'t think you can do this alone, bring your friends and kill EVERY. SINGLE. TROLL.Now go out there and sweep the city!",
  ...
  [60074] = {
    ["D"] = "I\'ve been making you kill trolls left and right but this time, we have an actual target for once! We got reports of their leader, Vile Priestess Hexx rallying the Vilebranch trolls for an assault on Aerie Peak! We can\'t let that happen, can we?Gather your friends and climb the city of Jintha\'alor to the very southeast and kill her and her special guards. You will be richly rewarded for you efforts.",
  ...
  [60104] = {
    ["D"] = "Greetings! You look like a brave soul. What if I told you I am on the brink of revolutionizing travel as we know it?Through some clever recombobulating of magic Runes that mages use I was able to make a device that can open a wormhole which can be used to teleport someone to a place on the other side of the world.Behold the invention that will change travel as we know it! I call it the Portable Wormhole Generator.Now the only thing left to do is to test it... That\'s where you come in.If you are willing to step into the portal created by the Generator you should end up in the other side where my partner will be waiting for you. Do this and you will be given one of the devices as a show of our gratidude.Good luck!",
  ...
  [60120] = {
    ["D"] = "Now that introductions are out of the way, you and I are kinda like partners, yeah? Here\'s the thing, more than the general supplies sent from Ratchet we had a special order those harpies took. Those feathery fiends got their claws on at least two crates of weapons and ammo meant for Orgrimmar.Worse than the harpies is the tauren merchant expecting the goods. She might use me for target practice if she finds out her order got lost in delivery a second time.$N, I gotta get those crates back!",
    ["O"] = "Find Kaja\'s Ammunition from Ammo Crates in Razorwind Canyon and return to Rezlak near Orgrimmar.",
    ["T"] = "Triggered!",
  },
  [60121] = {
    ["D"] = "You know, since there\'s another shipment coming, I might as well just wait for them here. I got a few more coins here to spare, and so far my eye for talent hasn\'t lead me wrong with you.Now I know I want to hire more $cs for later jobs, but we still have to get these weapon crates to Orgrimmar. A goblin\'s reputation is ninety percent of his business! How about it? Mind hauling this stuff the rest of the way for me?My no good cousin Kozish should have made it there hours ago. He had more cargo to deliver and is probably drinking away his paycheck at the first pub he saw by now. Check there for him in the Valley of Strength.",
    ["O"] = "Deliver Rezlak\'s Shipment to Rezlak\'s cousin Kozish in Orgrimmar.",
    ["T"] = "The Mail Must Go Through",
  },
  [60122] = {
    ["D"] = "I am not going anywhere near that Tauren!I\'m unemployed, remember? You want to see the deliver through, you take it to Kaja yourself.",
  ...
  [60131] = {
    ["D"] = "Greetings $c!Much of Orgrimmar\'s food supply comes from the sea to the east. Grunts can assist with escorting the fisherman and crabbers through the scorpids and raptors but there\'s the issue of sharks that\'s getting the better of them.Fishermen have reported aggressive sharks rising in number off the coast and attacking their boats. Go thin their number and be sure to take friends. Rid of us this menace before our food stores dwindle!",
  ...
  [60139] = {
    ["D"] = "Why in the name of Doomhammer has this plague spread the land? Scorpids!It didn\'t used to be this way, but now every time I leave Razor Hill, scorpids! In my tent, my shoes, my armor, always more scorpids! They\'re more of a nuisance to me than a real danger, but each time I get stung I have to drink a healing potion or head back to town for help. I’m sick of it!I\'m nursing my latest sting right now, but you look like you’re up to the task of a hunt. Head out and kill every scorpid you find! It\'s not like you\'ll have any issue finding them...",
  ...
  [60145] = {
    ["D"] = "We also got reports of a kobold much larger than the others, hiding deep in the Echo Ridge.Even its mere existence poses a threat to the abbey.Go down into the Echo Ridge and kill it.You will be justly rewarded.",
  ...
  [60150] = {
    ["D"] = "The quilboar activity in the Brambleblade Ravine has been increasing lately, we suspect that they\'re preparing for an attack on Camp Narache.Go to the ravine and thin their numbers, they fight without honor and deserve none.",
  ...
  [60152] = {
    ["D"] = "$N, I hear you are on your way to slay the scoundrels they call leaders of the worst crew of pirates, the Bloodsail Buccaneers.You see these fools took a new member and they in their deluded mind think he will aid them greatly.<Baron Revilgaz scoffs.>I have a man on the inside, his name is Morgan Storm, look for a fellow that won\'t shank you on sight.",
    ["O"] = "Find Morgan the Storm",
    ["T"] = "They Call Him Morgan the Storm",
  },
  [60153] = {
    ["D"] = "As a double agent, I\'ve been on their ships when they took that orc on the ship, not much of a bright idea since I saw he has no real skill in combat, but if anything he\'s the perfect pirate, liar, gambler, drunk, you name it.They named him Captain of a small fleet and they hope his combat experience would rub off the new recruits, bunch of nonsense.<Ian spits on the ground.>You\'ll find him on one of the ships, kill him, and bring his head to the Baron, I will lay low, now go before anyone sees us!",
  ...
  [60154] = {
    ...
    ["O"] = "Go to the Jasperlode Mine northeast of Goldshire and clear out the spider infestation. Return to Marshal Dughan in Goldshire.",
  ...
  [70002] = {
    ["D"] = "We have kept a close eye on your growth $N.$BYou have outwitted several demons under your command, conquered many foes, and kept a lot of allies at your side. There is very little any of us may teach you at the moment, you have gone above and beyond any of our expectations.However, there is someone that may yet have something to teach you about the ways of the warlock.$BVenture to the Blasted Lands and seek the one called Daio, there is a slight chance you might\'ve already met.",
  ...
  [70034] = {
    ["D"] = "Norvok is in no condition to be out looking for a family heirloom, but I worry that perhaps he may attempt to venture out before he is fully healed.If you could search for any trace of the spear that he had left behind, it would be greatly appreciate, no doubt by myself and Norvok.The demon\'s to the east would be your best bet in searching, go swifty!",
  ...
  [70051] = {
    ["D"] = "Psst, buddy. Come here for a second, will you?Hey, how\'s it going today? I got myself some lucrative information to share with you, so listen up. You see, there\'s these sunken ships, old Alliance boats that supposedly still got fuel left in them and ya know fuel is a valuable commodity for us goblins. They\'re just sitting there right off the coast waiting for you!Bring me whatever you manage to salvage from the shipwrecks and I\'ll be sure to make it with your while.",
  ...
  [70059] = {
    ["D"] = "Recently a vile criminal by the name of Redridgeboss has been sighted on the premises of Lakeshire; murdering local townsfolk, hunting down clueless adventurers that fall into his devious traps, and has so far evaded capture.His reign of terror upon the township of Lakeshire must be stopped!An order for this outlaw\'s elimination offers a reward much higher than any other ordinary criminal.",
  ...
  [80252] = {
    ["D"] = "Greetings, $R. Since you\'re here this means you\'ve come to help so listen up. We have a situation here... You might be aware that our buildings use arcane magic to operate.While our central crystal is the main power source, we use smaller crystals to effectively channel the arcane energy from the nexus to the outlying ley points of the structure.The downside is that these crystals break down overtime, if we had found this outpost a decade later the entire Academy could have collapsed.Fortunately, our predecessors built this site on a location with arcane crystal deposits. While the automated constructs have long since stopped working or malfunctioned, the mine remains full of intact crystals.I need you to head down there and bring me some crystals. Eight should do for now.Are you still here? Get moving.",
    ["O"] = "Gather 8 Arcane Crystals from the Silver Sun Mine in Alah\'Thalas.",
    ["T"] = "A Crystal Clear Task",
  },
  [80253] = {
    ["D"] = "Well well... So far you\'ve proven useful so perhaps I can give you a more important task than fetching crystals.My people descend from the Highborne, we were once the pinnacle of Kaldorei society, ruling a great empire… While few traces remain of that here in the Eastern Kingdoms, Kalimdor is filled to the brim with ruins, ruins that have not been looted!I need you to travel to the jungle of Feralas, once home to the city state of Eldre\'thalas. In the area just south of Eldre\'thalas there should be some ruins...I believe the locals call it the High Wilderness. Our scouts have reported that the Ogres holding the ruins have inadvertently dug up some valuable Arcane artifacts. I want you to go down there and get me those artifacts...Before those big oafs crush them with their feet! Now get going, quickly!",
    ["O"] = "Gather 4 Arcane Artifacts from the High Wilderness in Feralas.",
    ["T"] = "Relics in Feralas",
  },
  [80254] = {
    ["D"] = "Greetings, $N! I see that you have done quite a lot of work for Anu\'delen, but now the time has come for something more serious than fetching artifacts.Alah\'thalas is not far from the Scourge or the Amani, after the fall of Quel\'thalas our people can no longer keep the rampaging Forest Trolls in check.Our scouts have reported that the Troll population of Zul\'mashar in the Eastern Plaguelands is being converted to the Undead at a rapid pace.We cannot have this, Forest Trolls are bad enough, we don\'t need to deal with an Undead version.Go there, exterminate both the living and the dead, we can\'t allow those beasts to go out of control.",
  ...
  [80256] = {
    ["D"] = "I am Tanilaeh Sunkiss, Ley-technician and operator of the Portal connecting Alah\'thalas to the Stormwind Mage tower, when you need to return to Stormwind, I am the one you should speak to.This place is the Golden Dawn Institute, here we house lodgings and welcome new travelers. In front of me is the Orb of Translocation, you can use that to go down to Alah\'thalas proper.Arcanist Anu\'delen in the tower below us has requested help with a problem in the mine. There is also  innkeeper Joalar in the institute should you wish for a meal or to attune your hearthstone here.The large floating structure is known as the Citadel of the Sun. It houses the new Magistry, the headquarters of the Rangers, and the seat of the Council.Anyway I shouldn\'t keep you anymore, go speak to the Arcanist!",
  ...
  [80258] = {
    ["D"] = "Sinu a\'manore, $C.You have answered our call for aid, for which we are truly grateful.With the fall of Quel\'Thalas we, the Quel\'dorei, have been left without a home. It is here where we shall focus our wits and strengthen our will. This is the beginning of our quest for vengeance, and you shall be part of it, among others.You see, as we prepare for a war against death itself we need to have as less casualties as possible but we can only prevent so many.Where there is a battle there shall be dead and wounded. I ask of you on this day and many to come to aid us in our effort to supply our numbers with a means to mend and heal. There is a small and not so elegant flower growing in Redrige Mountains. We call it poppy. I shall not bore you with the alchemical details, you only need to know that the concoction will ease the pain of the wounded. I know it\'s a simple task  but it is not meaningless.Return to me when you have a handful of them.",
    ["O"] = "Gather ten poppies in Redridge Mountains.",
    ["T"] = "Tears of the Poppy",
  },
  [80260] = {
    ["D"] = "I have a... troubling matter to discuss with you.A child was sent from Stormwind, and she won\'t stop babbling.Quite frankly, she is interfering with my work. I was APPARENTLY the most qualified to take care of her, but I\'d appreciate it if you helped her out with her pleading because of your proclivity for being a “hero”.Yes, yes! I will pay you, too, if those are part of your terms.<Anu\'delen pinches the bridge of his nose while veins on the side of his neck flare into view.>",
    ["O"] = "Talk to Anu\'delen again if you\'re willing to alleviate his frustrations.",
    ["T"] = "Help With a Compassionate Matter",
  },
  [80261] = {
    ["D"] = "Oh, great adventurer! My name is Teslinah. Please, I need your help!My mommy and I were in the Farstrider Lodge after fleeing from all the bad stuff up north, but when we were in Stormwind, we got separated! Miss Elsharin found me and took me here because she thought my mommy would be here, too, but she\'s not! The grumpy man over there only told me to sit in a corner and be silent. You\'ll help me, right?",
  ...
  [80289] = {
    ["D"] = "Ah, there you are, $N. You have proven to be of some use in the past. I have observed that you have an uncanny knack for running errands. My ancestors were exiled from Kalimdor seven thousand years ago, but you\'re mistaken if you think they created Quel\'thalas right away.They landed in what is today known as the Tirisfal Glades. According to records left behind in Alah\'thalas, the first settlement was known as Ishnu\'danil. Naturally, this is something we consider worthy of exploring further, which is why I have sent my subordinate Thas\'alah to investigate this ancient location.However, I have not heard a word from him since, and to make matters worse, the records we found mention a curse of some kind that affected the minds of our ancestors who lived there. I need you to go there and find out what became of Thas\'alah.",
    ["O"] = "Locate Scryer Lor\'dal Thas\'alah in the western Tirisfal Glades.",
    ["T"] = "The First Settlement",
  },
  [80290] = {
    ["D"] = "With all that has been going around here, I could use help from an adventurer like you. You see, our people used magic to shape the land and create buildings like this, but this one appears to have been only partially complete and abandoned.I tried venturing inside myself but was immediately filled with dread and horror. It felt like it was consuming me, so I fled outside. But you, on the other hand, seem like someone who is not easily frightened. Before I... left. I noticed a Stone Tablet etched into the cliff.Perhaps it can provide some clue as to what might\'ve happened here. Could you be so kind as to retrieve it for me?",
  ...
  [80292] = {
    ["D"] = "Don\'t worry about me. I will not be alone here. I have my... guards with me. And you must agree that this place is too important to leave unattended.Oh, and if you could avoid mentioning the stuff about hearing voices, that would be wonderful. I don\'t want to scare the potential helpers, which Anu\'delen might send my way.",
    ["O"] = "Return to Anu\'delen in Alah\'Thalas.",
    ["T"] = "A Lone Homecoming",
  },
  [80300] = {
    ["D"] = "Hello mon! I got an offer for you. My people have begun making the journey from the old world to set up a new home here in Kalimdor.It will be far away from the forests of Lordaeron, but the threat of Hakkar\'s worshippers and the Wildhammer can no longer be fended off.We\'ve been running into some difficulties settling in and if you can spare the time, we could use your help.Find Deino in Orgrimmar, a mage trainer in the Valley of Spirits.",
    ["O"] = "Talk to the mage trainer Deino in the Valley of Spirits in Orgrimmar.",
    ["T"] = "A Tusken Affair",
  },
  [80301] = {
    ["D"] = "When we first came to this land it was important to build structures that would make this more than a temporary village, but an actual home where we can grow. The tomb was meant to be a place to honor the dead rather than being cut off from them as we were in the old world.Here there is no threat of the plague raising our loved ones, but there is something dark and strange lurking in the earth. Just before completing the tomb, our workers began going mad and mummifying themselves!I have prepared pyres that will pacify the spirits and protect future workers.",
    ["O"] = "Light 3 Spirit Pyres inside of the tomb.",
    ["T"] = "Lighting the Pyres",
  },
  [80303] = {
    ["D"] = "It\'s good to see you again, $c. Our scouts have reported increased activity from our ancient enemy in the Eastern Plaguelands.They are preparing to outfit an expedition with trinkets stolen from our people to protect them against corruption.Travel to the lodge and put an end to their expedition before they can benefit from our stolen relics.",
    ["O"] = "Venture to the Quel\'Lithen Lodge in the Eastern Plaguelands and slay 6 Quel\'Lithen Pathstriders, 6 Quel\'Lithen Woodsmen, and 6 Quel\'Lithen Rangers.",
    ["T"] = "Raiding Quel\'Lithen Lodge",
  },
  [80304] = {
    ["D"] = "Greetings mon! It never fails to be prepared, even with powerful regeneration powers like we have. We don\'t really know why, but sometimes those powers fail in the middle of battle and it pays to be prepared for the worst.There\'s a purple flower that grows around Ashenvale that some call rosemary, but I think it\'s better to call it useful. We can turn that flower into a powerful salve that empowers our regeneration for a short time, like potions but better! Grab a handful and bring them back to me.",
  ...
  [80311] = {
    ["D"] = "<Ureda glances at you with dismay.>Your skills still require some honing, and your posture betrays your arrogance. Typical of any new apprentice who bears overconfidence before his own wits. Not that it matters to me. It\'s your own problem.Any aspiring mage should have his spells ready at all times and think two steps ahead. That\'s why your lack of awareness should be compensated with at least something you could procure by yourself.There is a… “mage” who resides on the bank of Southfury River, not far from Thunder Ridge. The task you will receive from this mage might be arduous at first glance, yet it most likely will bear fruit if you put your brain into it.",
  ...
  [80320] = {
    ["D"] = "Hey $c! I\'ve got a business proposition for you. My boss sent me to track down defectors from the cartel that joined up with the Burning Blade and I\'ve found out that Fizzle isn\'t the only goblin playing with demon fire around here.Knobby Tinfault\'s hiding in Dustwind Cave on top of the Drygulch Canyon. Find him and bring me anything he\'s carrying that has so much as a strange mark on it. We need to get any info back to Gazlowe so we can find out if there\'s more to their schemes.",
  ...
  [80369] = {
    ["D"] = "Ah, I see you\'ve returned once more $N, very well I may have another task for you.Far to the south lies a coven of most feral creatures called the Owlbeasts. This place, known as Owl Wing Thicket, is also famous for being the place of growth for a very peculiar herb.Bring me about a dozen of these plants. The Owlbeasts should carry it on them as a snack.",
  ...
  [80386] = {
    ...
    ["O"] = "Bring 20 Whirring Bronze Gizmos to Vanessa Clang in Sparkwater Port.",
    ["T"] = "A Gizmo a Day...",
  },
  [80388] = {
  ...
  [80391] = {
    ["D"] = "Greetings! Your company is welcome. I am Inunquaq of Moa\'ki Harbor. I find myself in this strange land after weeks of sailing.My tale began when a Winter Tauren friend of mine known as Buniq visited my settlement in her canoe, she invited me to accompany her to the village of Taunka\'le. But as I entered the canoe, a strong icy gust blew the rope out of Buniq\'s hands. Within moments a strong current had taken me out to the open sea!Buniq had the oars so all I could do was to desperately cling to the canoe and hope for the best.Eventually the current took me here to this warm land that looks nothing like my home. Listen friend, the canoe had some provisions but I have finished them days ago. Would you please collect some meat from these shelled creatures nearby?We have similar creatures in the far north, but I am without the tools and the knowledge I need to try and approach them, as far as I can guess they are edible. If you do so, I will be forever in your debt.",
    ["O"] = "Collect 8 bunches of Crawler Meat.",
    ["T"] = "Crawling for Meat",
  },
  [80392] = {
    ["D"] = "Excuse me, may I have your attention for a second?My name is Lieren and you look like a seasoned traveler. I have a task for you if you do not mind helping me, I am quite busy with my own, I need a package taken to Quel\'Danil east of here.Just look for an Elf lodge there and take it to my sister. My sister has similar features to mine, but she is all of elvish ancestry.I\'ve attached your payment to the package, now what do you say pipsqueak, will you help me out?",
    ["O"] = "Take Lieren\'s Package to Quel\'Danil and deliver it to Loania.",
    ["T"] = "Package to Quel\'Danil",
  },
  [80393] = {
    ["D"] = "I hope it is not too much to ask for, but you look like the strong type.The people of Quel\'Danil are my family and they\'ve been at odds with the terrible Witherbark Trolls for a long time! I am asking you to reduce their numbers, I don\'t want to see any more suffering, we have all lost so much already.Shandra\'lor hosts sadistic trolls and their pet spiders, I would like you to focus on those.Once the job is done please report to my adoptive mother Voldana. She is deeper inside the lodge!",
  ...
  [80399] = {
    ["D"] = "Makasgar, my foolish apprentice, now believes he has grown beyond the need of his master and fled north along the coast with dark mojo I had plans for.Perhaps we can make a deal if you and your minions retrieve it alongside his head.Bring me what is mine and you will have what seek.",
  ...
  [80404] = {
    ["D"] = "Drazzit will expect to hear something from me soon, but I don\'t think the site is secure enough for me to leave.If you have time, would you be willing to take some of the salvaged cargo down to him at Mudsprocket?",
    ["O"] = "Take the Zeppelin Cargo to Drazzit Dripvalve at Mudsprocket.",
    ["T"] = "Delivery for Drazzit",
  },
  [80405] = {
    ["D"] = "This zeppelin was carrying six months\' worth of supplies to us at Mudsprocket! Sure, they\'ve been able to barter for some of what they need, but they won\'t hold out forever.I\'ve been sent out here to recover what I can of the cargo, but the wreckage is scattered all over the marsh in this area. I\'m sure a lot of the cargo didn\'t survive the crash, but are you willing to help me recover what we can?",
    ["O"] = "Moxie Steelgrille at Beezil\'s Wreck wants you to recover 8 pieces of Zeppelin Cargo.",
    ["T"] = "Secure the Cargo!",
  },
  [80407] = {
    ["D"] = "Hey!You\'re $N, right? I received a letter from a certain Kheyna Spinpistol. She paid me handsomely to direct you to a crashed gnomish rocket car north west of town.She said you\'ll know what to do when you find \'it\' .",
    ["O"] = "Investigate the crashed Gnomish rocket car northwest of Gadgetzan.",
    ["T"] = "A Letter From a Friend",
  },
  [80408] = {
    ["D"] = "My search for my nemesis continues, but as that search continues, so too does the work that needs to be done. I have needs of brains! I am currently researching an amazingly innovative technology, but it needs to be perfected for all races.I need more samples and I know exactly where to get them! Far south and slightly east of Gadgetzan you will find a set of Troll ruins known as the Eastmoon Ruins! There are Ogres there. Tear them apart violently! They\'re going to attack the water reserves of Tanaris and cause a lot of people to die from thirst.Water is already expensive, but if the reserves are destroyed by those brutes, the price will skyrocket and most people won\'t be able to afford water. Let\'s avoid that. Kill them all. Once you have them, take the brains to Reas and then come back to the crystal.",
  ...
  [80410] = {
    ["D"] = "Excuse me, $N. I received a peculiar message from the Cenarion Circle recently, but it wasn\'t addressed to me, it was addressed to you.<Rayne hands you a letter, as you open it, the letter only contains a few words and no signature: \"It is time. Meet me inside the inn of Andorhal on the second floor.\">",
  ...
  [80606] = {
    ["D"] = "Have you ever seen one of those mysterious individuals that garb themselves in blue with hoods and robes, and travel through the land punishing those who make things unmerry for others?Not many people have seen one, or know about them at all. For once they should be the ones to be punished!It must be them who took my gloves, for who else could be responsible to make it disappear from my hands?!I am not sure where you can find one, but should they appear, snowball them in the face for me and let them know it shall not be tolerated!",
    ["O"] = "Hit a Game Master with a Snowball!",
    ["T"] = "Revenge on Game Masters!",
  },
  [80700] = {
    ["D"] = "I\'ve been looking for you all around the city! Although I am more of an announcer than a mailman I was instructed to give this letter to you by well… I am not sure who he was.The figure\'s face was covered and his voice didn\'t seem familiar at all. He said you will understand when you read it.I am not one to pry, $N, but be more careful, I wouldn\'t let the guards know I associate myself with those kinds of people.",
    ["O"] = "Accept suspicious letter to ease Goddman\'s mind.",
    ["T"] = "A Particular Letter",
  },
  [80701] = {
    ["D"] = "Burn this after you\'ve read it.$N,I dearly hope this letter finds you in good health, I wish I could\'ve delivered the message in person but you must understand that we like to keep secrecy at hand.I am not sure if you\'re aware of what our organisation does, or who we entirely are, but we have discovered valuable information and we might need your help.In the envelope you will find a ring, keep it at hand while you come visit us, it will be the sign you\'ve accepted our mission and that the letter was burnt.Until we meet,Mathias Shaw.",
    ["O"] = "Report to the SI:7 and present the ring to Mathias Shaw.",
    ["T"] = "The Elusive SI:7",
  },
  [80702] = {
    ["D"] = "My agents have reported that a Scarlet caravan has started moving through various towns.From what we know they have already gone to Lakeshire, Darkshire, Menethil and Southshore.My only assumption is that whoever took over the Crusade after the events that transpired the Scarlet Monastery, Hearthglen and Stratholme has realised they\'ve been running short on men.I want you to go and speak to the people of Lakeshire. The locals should have at least seen something.",
    ["O"] = "Interrogate the people of Lakeshire and find out the truth. Report back to Mathias Shaw.",
    ["T"] = "Young and Foolish",
  },
  [80703] = {
    ["D"] = "Yeah bub that\'s all I know, now I don\'t say I deserve any kind of compensation for the information but it will highly be appreciated.<Kixxle holds open his palm but you refuse to pay.>Fine then, go on and follow the road to that bridge, Thandol Span or whatever, I hope those Scarlets get you for being such a prick!",
    ["O"] = "Bring Vladeus Springriver back to Menethil Harbor and report back to Captain Stoutfist.",
    ["T"] = "Thandol Span",
  },
  [80704] = {
    ["D"] = "We\'ve been trying to no avail to interrogate the young lad you brought back, $N. He simply wouldn\'t talk, me and the other guards tried to persuade him as best as we could.Considering you were there to put an end to their masquerade, I\'d assume you\'d have a better chance to draw some information out of him.Credits given where credits are due, you did a great job putting piece to piece together and finding them.Take whatever approach you\'d like, just see it done.",
    ["O"] = "Decide what to do with Vladeus.",
    ["T"] = "Are You True to Your Nature?",
  },
  [80705] = {
    ["D"] = "During your many adventures through Azeroth you have faced several perils and foes, unlike the man present before you.You are more than sure he\'s not a wicked sort and chose to approach this lightly, staying true to your nature.With a table full of choices you pick the best means of persuasion and are ready to begin.",
    ["O"] = "Use your persuasion skills to interrogate Vladeus.",
    ["T"] = "The Means of Persuading",
  },
  [80706] = {
    ["D"] = "You\'ve met many foes on your several adventures through Azeroth, for the first time something in you clicked.How many more scum do you have to beat, maim and kill so that this twisted world gets its damnable peace?The Scarlet Crusade has been a personal thorn in your sides as well, maybe it\'s time to deliver some sort of justice or is it vengeance?With a table full of tools that will aid you to obtain what you need, you are ready to embrace your demons.",
    ["O"] = "Find out everything by any means necessary.",
    ["T"] = "Seeking Justice or Vengeance?",
  },
  [80707] = {
    ["D"] = "You\'ve extracted all the information you could get for Vladeus. Deciding you\'re done with him you let him rest and think about your next actions.It seems news of Whitemane\'s death and the demonic influence over Stratholme reached the ears of Lady Abbendis, the last true leader of the Scarlet Crusade.With one of her henchmen tricking young men and women to join their cause and force them into staying she\'s trying to regain some numbers.You decide to report this to Stoutfist and ask for his opinion.",
    ["O"] = "Report to Captain Stoutfist.",
    ["T"] = "The Price for Information",
  },
  [80708] = {
    ["D"] = "My boys made preparation for the prisoner to reach Stormwind, his fate will be decided there since he’s part of their jurisdiction.You were of great help and I am sure you want to poke around this thing even further, I might have a lead for you, not sure how much it will help though.Under the Cathedral District’s Chapel there’s a priest in red robes, the intel I got from Shaw’s men says that his name is Brother Crowley and was sent by the Scarlet Crusade inside the city as an ambassador of sorts.His mission was to recruit the willing to fight in the name of the Light or whatever stupid lie these Scarlets are telling to themselves.In any case, Crowley hasn’t been that active, we are not sure if he’s the one to recruit these blokes but it’s worth a try.",
    ["O"] = "Travel to the Cathedral’s District of Stormwind and speak with Brother Crowley.",
    ["T"] = "Scarlet Aid",
  },
  [80709] = {
    ["D"] = "Abbendis must be stopped and you will be one of the thorns in her side and how better should you do it if not from the inside?While I hold no skill in the arts of the Arcane, a dear friend of mine who just like me will love to see her fall has provided me in the past with a few scrolls that could change one’s appearance.I am more than happy to offer you one if you were to tell nobody of it, let’s just say the scrolls were for something more meaningful, yet desperate times call for desperate measures.Only use this when close to Tyr’s Hand, claim to be one of the disciples of the caravan you destroyed and claim your team was slain by the ogres of Arathi.",
    ["O"] = "Travel to Tyr’s Hand and report to Mavel Brightwood.",
    ["T"] = "Donning the Red Flag",
  },
  [80710] = {
    ["D"] = "Ready for your first assignment?Your armor looks shabby and your blade dull but if you’re not able to pull up your own weight you’re not worth the trouble of the Light.Travel the Plaguelands, slay any undead in your path and bring me their brains. Their brains are essential for something the High General has planned, simply do your job and ask no questions.Go you fool, the Light waits for nobody, go on and claim your glorious purpose.",
    ["O"] = "Hunt undead all over the Plaguelands and gather their brains.",
    ["T"] = "It’s All in Their Brains",
  },
  [80711] = {
    ["D"] = "Your next errand is to simply collect a few things here and there, nothing special.You will find these while fighting Elementals and plants in some of the actual dangerous zones of the world, but I am more than sure you will succeed if you truly are chosen by the Light.Bring me Savage Fronds and Core of the Elements, fifty of each, it will be a great help in what we wish to achieve.When and if you return you will officially be a member and I will give you a map as to where to find the entrance for the secret training spot.May the Light bless your poor soul. If you return we will embrace you as a sibling, if you do not we will not mourn for you even for a second.",
    ["O"] = "Travel the world and bring back the supplies you were asked to.",
    ["T"] = "Supplies We Need",
  },
  [80720] = {
    ["D"] = "$N, is it?Lord Varimathras tasked me to seek you out, although it seems you have found me instead. I will try to make this short since I have no real clue of what he wants with you either.He merely said to look for someone named $N and that I will know it’s you when I see you.<Tyler shrugs.>I assume you know where to find him, right? He stands behind the Dark Lady, forever in her shadow since the events that transpired a few years back.A word of caution if I may. Do not take everything he says to be true, after all, loyal to the cause or not, he’s a demon.",
    ["O"] = "Report to Varimathras in Undercity.",
    ["T"] = "A Dreadful Summon",
  },
  [80721] = {
    ["D"] = "It seems many of the Forsaken have gone missing or found dead in various locations we occupy. One of my confidants has been reporting these events to me and I would like to have you investigate the concern further.Considering the troubles we currently have to face in the Plaguelands there aren\'t many hands to spare and one as yourself that seeks glory or perhaps has a foolish intent of helping would be quite fit for the job.Skipping any other formalities I need you to travel to Brill, the Sepulcher and Tarren Mill and find everything you can from the local executors about this matter.The Dark Lady doesn\'t appreciate failure and considering this has happened right under our nose I have yet to tell her of it.Don\'t misunderstand however, without any information one simply can\'t report to the other one above them.I will pay you handsomely, just get the deed done.",
  ...
  [80722] = {
    ["D"] = "The only real way to find out more is to set a trap for the Scarlet mongrels. I have tasked a Deathguard to help you with this, obviously he has no idea he will simply be a means to an end and act as bait.If you have a guilty conscience, turn around now and never speak of this again, I will find someone else to employ.Yet if you find it in yourself to realise that sacrifices must be met sometimes I will tell you where he is.Find Maverick, he will be in the Graveyard close to the Monastery, use him to bait them and gather as much intel as you can.",
    ["O"] = "Find Deathguard Maverick and set a trap for the Scarlet Crusade. Report back to Varimathras.",
    ["T"] = "To Catch a Rat...",
  },
  [80723] = {
    ["D"] = "Not much of an alchemist myself, $N, but I know someone who can help us identify what this vial contains and why it acts like this.Apothecary Zinge is down in the Apothecarium in Undercity alongside others from the Royal Apothecary, not only is she a bright mind but she also knows who’s better to be served, if you somehow understand the sayings of an ignorant fool.<Varimathras makes the quote mark with his fingers.>In any case, we really need to cut to the chase here, I will report of our findings to Sylvanas but I won’t mention the vial until we find out what’s in it, she will be furious if she finds out but I can soothe her, I’ve been doing it since the end of the Third War.Move quickly but in silence, shadows guide you.",
    ["O"] = "Take the vial to the Apothecarium and speak to Varimathras’ trusted apothecary.",
    ["T"] = "Trusted Apothecary",
  },
  [80724] = {
    ["D"] = "Well, well, well. And you said this thing simply puts undead to “sleep”, right?This isn’t like any potion like I’ve ever seen, we have something similar down south in Silverpine for the mindless worgen with Wolfsbane but seriously at least those are alive and kicking unlike us and the Scourge.<Apothecary Zinge crosses her arms for a second.>This is definitely magic in nature, there’s not much I can do about it, never fiddled with it, I can only assume it’s a concoction made out of Peacebloom and Ghost Hair Thread but it has to be enhanced with some sort of magic.I’m not sure if he will be willing to aid you but there’s a slight chance, he will definitely ask for something in return that old coot.I’ve marked your map, go in the middle of the lake and you’ll find him there. Approach him with respect and fear, $c, that’s one of the greatest magic users I have ever seen and some even believe he turned into a lich by now.",
    ["O"] = "Find Gunther Arcanus in Tirisfal Glades.",
    ["T"] = "Consulting an Expert",
  },
  [80725] = {
    ["D"] = "I sometimes miss Dalaran and think of the days when I used to be alive, being a student of the arcane arts was really meaningful to me.While I understand my condition, during the Scourge’s control over my mind my memories were the one that allowed me to break free and remain who I was.Not trying to get all soppy on you, $c, but I already know what this vial is and how it was done, but I need you to do me a favour before I tell you. Think of it as an equivalent exchange.<Gunther laughs.>You will learn of that later. Go to the former town known as Ambermill, behind the Town Hall I once buried a locket and sealed it with magic.I will give you a scroll that will erase the spell, do be careful.",
    ["O"] = "Travel behind Ambermill and dig for Gunther’s locket.",
    ["T"] = "In Gunther’s Favor",
  },
  [80726] = {
    ["D"] = "Well, as I said, a tiny little lie, because I do know how this vial came to be but not entirely how they made the thing they used for it.I am not sure you’re accustomed to Alchemy but let me put it like this briefly.A skilled alchemist at time creates something we call the Philosopher’s Stone, it’s an object that helps in transmutation which involves a little bit of magic.The issue with the stone that was used for this vial is that it definitely was infused with life magic.You’re probably asking yourself why would life magic affect undead? Undead are considered an abomination that is both alive and dead, think of them as something that breaks the balance between life and death magic.From what I can gather this Philosopher’s Stone was infused with either life force or souls itself, so it could be shadow magic too.You should return to your master or whoever told you to come seek me and have him help you get this, I will hold onto the vial until then for further examination.",
    ["O"] = "Return to Varimathras in Undercity.",
    ["T"] = "Soul and Alchemy",
  },
  [80727] = {
    ["D"] = "Time has come to report this to the Dark Lady, she will definitely not be pleased I hid this from her but maybe she will be more understanding if you were to report it, I do know it seems like I am saving my own skin but do understand this is the best way to proceed.Simply give her this scroll, everything is already written there.",
    ["O"] = "Report to Sylvanas.",
    ["T"] = "Dark Temper for a Dark Lady",
  },
  [80728] = {
    ["D"] = "The reports says you were helped by Gunther Arcanus, Bethor insisted for a long time to take him in, as he seemed to be a valuable asset to the Forsaken, although clearly he has yet to show his usefulness.If the case remains he will be able to find out what this object was and if he can muster up an antidote for this plague he will definitely prove himself.I order you to go to Tyr’s Hand, in Eastern Plaguelands, slay any kind of Scarlet fool and claim their uniform alongside their insignia, bring those back to Gunther and tell her that by order of the Dark Lady he must provide you an illusion that will let you infiltrate their ranks.If you still have doubts as to why you should help us, well, remember that everything is For the Horde.",
    ["O"] = "Travel to Tyr’s Hand and obtain a Scarlet Initiate Uniform.",
    ["T"] = "The Future Looks Grim",
  },
  [80729] = {
    ["D"] = "The illusion is ready, now it’s up to you.You will have to go to the Tyr\'s Hand and claim to be a new recruit, try to be as subtle as you may be, although considering I am giving you a Novice’s disguise you’re uh “seniors” will mostly make fun of you.In any case, seek any that are interested in talking with a newbie and find out what their plans might be.I will patiently wait here while I am taking another look at this damn vial, can’t simply understand it currently, must test it more.",
    ["O"] = "Travel to Tyr’s Hand and report to Mavel Brightwood.",
    ["T"] = "A Different Shade of Red",
  },
  [80730] = {
    ["D"] = "The SI:7 have means of communication that reach us quite fast and believe it or not they are very reliable.Sparring you any further details you should know that a dwarven caravan that was meant to reach Aerie Peak never made it out of the Wetlands.The caravan lays in ruins and you can only find the mutilated husks of what used to be dwarves.Our agents already poked around the zone but failed to find anything, they are currently trying to localize these newly recruited Scarlet zealots.I am not very sure of how much of a detective you believe yourself to be but I ask you to take a second look, maybe they missed something.If you find the recruits, keep in mind that we aren’t sure what manner of persuasion the Scarlets used to brainwash them, spare as many as you can and take them to Menethil.",
  ...
  [80736] = {
    ["D"] = "You are not the only one who came here seeking forgotten knowledge. However, just like everyone else, it will not simply be given to you. Fulfill my request and I will teach you what I know.You will need the help of a good alchemist, one whom I have taught my secrets.",
